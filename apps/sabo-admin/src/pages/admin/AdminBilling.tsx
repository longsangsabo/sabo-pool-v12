    ...
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 bg-green-600 text-var(--color-background) rounded-lg hover:bg-green-700 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-success">{formatCurrency(getTotalRevenue())}</p>
            </div>
        ...
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-warning">{formatCurrency(getPendingAmount())}</p>
            </div>
        ...
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-neutral dark:text-gray-400">Overdue</p>
              <p className="text-2xl font-bold text-error">{formatCurrency(getOverdueAmount())}</p>
            </div>
        ...
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-neutral dark:text-gray-400">Total Invoices</p>
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <p className="text-neutral dark:text-gray-400">{invoice.customer}</p>
                ...
                <div className="flex items-center justify-between text-sm text-neutral dark:text-gray-400">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="p-2 text-gray-500 hover:text-success">
                      <Download className="h-4 w-4" />
                    </button>
            ...
            {selectedInvoice ? (
              <div>
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      ...
                      <p className="text-neutral dark:text-gray-400">{selectedInvoice.description}</p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div>
                      ...
                      <p className="text-sm text-neutral dark:text-gray-400">{selectedInvoice.email}</p>
                    </div>
                    <div>
                      ...
                      {selectedInvoice.paidDate && (
                        <p className="text-sm text-success">Paid: {selectedInvoice.paidDate}</p>
                      )}
                    </div>
                  </div>

                  <div className="border border-neutral dark:border-gray-700 rounded">
                    <table className="w-full">
                      ...
                      <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr className="bg-neutral-background dark:bg-gray-700">
                ...
                <div className="flex gap-3">
                  <button className="flex-1 px-4 py-2 bg-blue-600 text-var(--color-background) rounded hover:bg-blue-700 flex items-center justify-center gap-2">
                    <Download className="h-4 w-4" />
                    Download PDF
                  </button>
                  <button className="flex-1 px-4 py-2 bg-green-600 text-var(--color-background) rounded hover:bg-green-700 flex items-center justify-center gap-2">
                    <Send className="h-4 w-4" />
                    Send Email
                  </button>
                  {selectedInvoice.status === 'pending' && (
                    <button className="px-4 py-2 bg-purple-600 text-var(--color-background) rounded hover:bg-purple-700">
                      Mark Paid
                    </button>
                  )}
                </div>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="text-sm text-neutral dark:text-gray-400 mb-4">Send payment reminders to overdue invoices</p>
        ...
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="text-sm text-neutral dark:text-gray-400 mb-4">Generate detailed billing reports</p>
        ...
        <div className="bg-var(--color-background) dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="text-sm text-neutral dark:text-gray-400 mb-4">Configure billing and invoice settings</p>
