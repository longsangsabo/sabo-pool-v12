 ...
 return (
  <Card>
   ...
   <CardContent className='space-y-4'>
     ...
     <div className='p-3 bg-neutral-50 rounded-lg'>
      <div className='flex items-center gap-2 mb-2'>
       ...
       {myAvailability.available_until && (
        <span className='text-caption-neutral flex items-center gap-1'>
      ...
      {myAvailability.location && (
       <div className='text-caption-neutral flex items-center gap-1'>
    ...
    {/* Help Text */}
    <div className='text-caption-neutral bg-primary-50 p-3 rounded-lg'>
