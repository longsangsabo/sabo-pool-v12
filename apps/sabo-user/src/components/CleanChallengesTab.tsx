...
//      const { error: notificationError } = await supabase
 ...
 const ChallengeCard = ({ challenge }: { challenge: Challenge }) => {
  ...
  return (
   <Card className="p-4 border border-neutral-200 dark:border-gray-700">
    <div className="space-y-3">
     <div className="flex justify-between items-start">
      <div className="space-y-1">
       <h4 className="font-semibold text-body-small">
       ...
       <div className="flex items-center gap-2">
        ...
        {challenge.club_confirmed && (
         <Badge variant="default" className="text-caption bg-success-500">
          Đã phê duyệt
         </Badge>
        )}
       </div>
     ...
     {challengerScore !== null && challengerScore !== undefined && 
      ...
      <div className={`text-body-small font-mono p-3 rounded-lg border-2 ${
       ...
       <div className="flex justify-between items-center">
        ...
        <span className="text-body-large font-bold mx-4">
       ...
       {challenge.status === 'completed' && (
        <div className="text-center text-caption mt-1 opacity-75">
     ...
     {challenge.club_note && (
      <div className="text-caption bg-primary-50 dark:bg-blue-950 p-2 rounded border-l-2 border-primary-200">
     ...
     {needsApproval && (
      <div className="border-t pt-3 space-y-3">
       <div className="flex items-center gap-2 text-body-small-medium text-amber-600">
 ...
 const TabSection = ({ 
  ...
  <div className="form-spacing">
   <div className="flex items-center gap-3">
    ...
    <h3 className="text-body-large-semibold">{title}</h3>
 ...
 return (
  <div className="space-y-6">
   <div className="flex items-center gap-2 mb-4">
    <h2 className="text-title font-bold">Club Challenges</h2>
    <Badge variant="outline">Total: {challenges.length}</Badge>
   </div>

   <Tabs defaultValue="pending" className="form-spacing">
