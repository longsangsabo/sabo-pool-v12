   ...
   <Card>
    <CardContent className='pt-6'>
     <div className='text-center'>
      ...
      <p className='text-body-small text-muted-foreground'>Đang tải cài đặt...</p>
     </div>
    </CardContent>
   </Card>
  );
    ...
    <CardContent>
     <div className='bg-warning-50 border border-yellow-200 rounded-lg p-4'>
      <div className='flex items-start gap-3'>
       ...
       <div>
        <h3 className='font-medium text-warning-800'>Lưu ý bảo mật</h3>
    ...
    <CardContent className='space-y-4'>
     <div className='bg-error-50 border border-error-200 rounded-lg p-4'>
      <div className='flex items-start justify-between'>
       <div>
        <h3 className='font-medium text-error-800'>
         Đăng xuất tài khoản
        </h3>
