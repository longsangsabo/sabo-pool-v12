  ...
  return (
   <Card>
    <CardContent className='text-center py-8'>
     ...
     <h3 className='text-body-large-semibold text-neutral-700 mb-2'>
      Không có câu lạc bộ
     </h3>
 ...
 return (
  <div className='space-y-6'>
   ...
   <div className='flex justify-between items-start'>
    <div>
     <h2 className='text-heading-bold'>{clubInfo.name}</h2>
     ...
     <CardContent className='pt-6'>
      <div className='flex items-center justify-between'>
       <div>
        ...
        <p className='text-heading-bold text-primary-700'>
     ...
     <CardContent className='pt-6'>
      <div className='flex items-center justify-between'>
       <div>
        ...
        <p className='text-heading-bold text-success-700'>
     ...
     <CardContent className='pt-6'>
      <div className='flex items-center justify-between'>
       <div>
        ...
        <p className='text-heading-bold text-warning-700'>
     ...
     <CardContent className='pt-6'>
      <div className='flex items-center justify-between'>
       <div>
        ...
        <p className='text-heading-bold text-info-700'>
        ...
        {members.slice(0, 5).map(member => (
         ...
         >
          ...
          <div className='text-right'>
           ...
           <p className='text-caption-neutral'>tin cậy</p>
          </div>
         </div>
        ))}
       </div>
