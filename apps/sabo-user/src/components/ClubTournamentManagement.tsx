  ...
  if (!clubId) {
   return (
    <div className='text-center py-8'>
     <Typography variant="body" >Không tìm thấy thông tin club. Vui lòng kiểm tra profile.</Typography>
    </div>
   );
  }
   ...
   <Card>
    ...
    <CardContent className='space-y-4'>
     <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
      <div>
       <Typography variant="heading" >Thông tin cơ bản</Typography>
       <div className='space-y-2'>
        ...
        <div>
         ...
         <Typography variant="body" >{tournament.description}</Typography>
        </div>
        <div>
         <span className='text-body-small text-muted-foreground'>
          Loại giải:
         </span>
         <Typography variant="body" >{tournament.tournament_type}</Typography>
        </div>
        <div>
         <span className='text-body-small text-muted-foreground'>
          Trạng thái:
         </span>
         <Typography variant="body" >{tournament.status}</Typography>
        </div>
       </div>
      </div>
      <div>
       <Typography variant="heading" >Thời gian & Tham gia</Typography>
       <div className='space-y-2'>
        <div>
         <span className='text-body-small text-muted-foreground'>
          Bắt đầu:
        ...
        <div>
         ...
         <Typography variant="body" >0/{tournament.max_participants}</Typography>
        </div>
        <div>
         <span className='text-body-small text-muted-foreground'>
          Phí tham gia:
         </span>
         <Typography variant="body" >{tournament.entry_fee.toLocaleString('vi-VN')} VNĐ</Typography>
        </div>
       </div>
      </div>
     </div>
         ...
         <div className='flex items-center justify-between'>
          <div className='flex-1'>
           ...
           <div className='text-body-small text-muted-foreground space-y-1'>
            ...
            {registration.notes && (
             <Typography variant="body" >💬 Ghi chú: {registration.notes}</Typography>
            )}
           </div>
          </div>
     ...
     <CardContent>
      <div className='space-y-4'>
       <div className='border rounded-lg p-4'>
        <Typography variant="heading" >Thông tin hiện tại</Typography>
