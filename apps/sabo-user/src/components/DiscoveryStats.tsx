 ...
 return (
  <div className='px-4 mb-4 relative z-20'>
   ...
   <div className='flex justify-center space-x-6 text-white text-body-small mb-3'>
    ...
    <div className='text-center'>
     <Badge className='bg-warning-500 text-yellow-900 font-bold px-2 py-1'>
      {userRank}
     </Badge>
     <div className='opacity-80 text-caption mt-1'>Hạng hiện tại</div>
    </div>
    <div className='text-center'>
   ...
   {currentPlayer && (
    <div className='bg-white/10 backdrop-blur-sm rounded-lg px-4 py-2 text-white'>
     <div className='flex items-center justify-between text-sm'>
      ...
      <div className='flex items-center space-x-3 text-caption opacity-80'>
