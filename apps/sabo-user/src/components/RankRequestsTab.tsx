   ...
   <div className='flex space-x-2'>
    ...
    <Dialog>
     ...
     <DialogContent>
      ...
      <div className='space-y-4'>
       <div>
        <label className='text-body-small-medium'>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='flex items-center space-x-2'>
       ...
       <div>
        <p className='text-body-small-neutral'>Tổng cộng</p>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='flex items-center space-x-2'>
       ...
       <div>
        <p className='text-body-small-neutral'>Chờ xử lý</p>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='flex items-center space-x-2'>
       ...
       <div>
        <p className='text-body-small-neutral'>Đã phê duyệt</p>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='flex items-center space-x-2'>
       ...
       <div>
        <p className='text-body-small-neutral'>Kiểm tra tại chỗ</p>
        <p className='text-heading-bold'>{stats.on_site_test}</p>
       </div>
      </div>
     </CardContent>
    </Card>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='flex items-center space-x-2'>
       ...
       <div>
        <p className='text-body-small-neutral'>Bị từ chối</p>
        <p className='text-heading-bold'>{stats.rejected}</p>
       </div>
      </div>
     </CardContent>
    </Card>
         ...
         <div className='flex items-start justify-between'>
          <div className='flex items-start space-x-4 flex-1'>
           ...
           <div className='flex-1 space-y-2'>
            ...
            <div className='flex items-center space-x-4 text-body-small-neutral'>
