   ...
   <Card>
    ...
    <CardContent>
     <div className='space-y-4'>
      ...
      <div>
       <label className='text-body-small-medium mb-2 block'>
        Chọn giải đấu:
       </label>
       <Select
      ...
      {selectedTournamentData && (
       <div className='grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted/50 rounded-lg'>
        <div className='text-center'>
         ...
         <p className='text-body-small text-muted-foreground'>Trạng thái</p>
        ...
        <div className='text-center'>
         ...
         <p className='text-body-small text-muted-foreground'>Lệ phí</p>
         <p className='font-semibold'>
