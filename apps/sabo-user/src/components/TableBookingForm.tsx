...
const TableBookingForm = ({ club }: TableBookingFormProps) => {
 ...
 return (
  <form onSubmit={handleBooking} className='space-y-4'>
   ...
   {club.hourly_rate && duration && (
    <div className='bg-primary-50 p-4 rounded-md'>
     <div className='flex justify-between items-center'>
      <span className='text-body-small-neutral'>Tổng chi phí:</span>
      <span className='text-body-large-semibold text-primary-600'>
   ...
   <p className='text-caption-neutral text-center'>
