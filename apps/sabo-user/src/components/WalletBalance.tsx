   ...
   <Card>
    ...
    <CardContent>
     <div className='text-center py-4'>
      ...
      <p className='text-body-small text-neutral-500 mt-2'>Đang tải...</p>
     </div>
    </CardContent>
   </Card>
  );
   ...
   <CardContent>
    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
     ...
     <div className='text-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg'>
      <div className='text-heading-bold text-success-700'>
       {walletData.balance}
      </div>
      <div className='text-body-small text-success-600'>Số dư hiện tại</div>
     </div>

     {/* Total Earned */}
     <div className='text-center p-4 bg-gradient-to-r from-blue-50 to-sky-50 rounded-lg'>
      <div className='text-heading-bold text-primary-700'>
       {walletData.total_earned}
      </div>
      <div className='text-body-small text-primary-600'>Tổng đã kiếm</div>
     </div>

     {/* Total Spent */}
     <div className='text-center p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg'>
      <div className='text-heading-bold text-warning-700'>
       {walletData.total_spent}
      </div>
      <div className='text-body-small text-warning-600'>Tổng đã chi</div>
     </div>
    </div>
