   ...
   <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
    <Card>
     <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
      <CardTitle className='text-body-small-medium'>Tổng trận đấu</CardTitle>
    ...
    <Card>
     <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
      <CardTitle className='text-body-small-medium'>Tỷ lệ thắng</CardTitle>
    ...
    <Card>
     <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
      <CardTitle className='text-body-small-medium'>Tổng thu nhập</CardTitle>
    ...
    <Card>
     <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
      <CardTitle className='text-body-small-medium'>Hạng hiện tại</CardTitle>
    ...
    <CardContent>
     <div className='flex items-center justify-between'>
      ...
      <div className='text-right'>
       <div className='text-body-small-neutral'>Kỷ lục cá nhân</div>
