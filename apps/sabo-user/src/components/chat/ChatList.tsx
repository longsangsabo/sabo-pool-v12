...
import { Search, MoreVertical, Edit, Users, Filter, Plus } from 'lucide-react';
...
export const ChatList: React.FC<ChatListProps> = ({
 ...
 const filteredConversations = conversations
  .filter(conversation => {
   const matchesSearch =
    conversation.participants.some(user =>
  ...
  <div className='h-full flex flex-col'>
   ...
   <div className='p-4 border-b'>
    <div className='flex items-center justify-between mb-4'>
     <h2 className='text-title font-bold'>Tin nhắn</h2>
     <div className='flex items-center gap-2'>
      <Button variant='outline' onClick={onCreateNewChat}>
    ...
    {filteredConversations.length > 0 ? (
     <div className='space-y-1'>
      {filteredConversations.map(conversation => (
       <Card
        key={conversation.id}
        className='cursor-pointer hover:bg-neutral-50 transition-colors border-0 rounded-none border-b'
         ...
         <div className='flex items-center gap-3'>
          ...
          <div className='flex-1 min-w-0'>
           ...
           <div className='flex items-center justify-between'>
            <p className='text-body-small-neutral truncate flex-1'>
