    ...
    <Card>
     <CardContent className='pt-6'>
      <div className='text-center'>
       ...
       <p className='text-heading-bold'>{stats.thisWeek}</p>
       <p className='text-body-small text-muted-foreground'>Tuần này</p>
      </div>
     </CardContent>
    </Card>
    <Card>
     <CardContent className='pt-6'>
      <div className='text-center'>
       ...
       <p className='text-heading-bold'>{stats.completed}</p>
       <p className='text-body-small text-muted-foreground'>Đã hoàn thành</p>
      </div>
     </CardContent>
    </Card>
   </div>
