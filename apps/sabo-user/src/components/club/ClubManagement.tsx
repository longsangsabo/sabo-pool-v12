    ...
    <CardContent>
     {!clubs || clubs.length === 0 ? (
      <div className='text-center p-8 text-muted-foreground'>
       ...
       <Typography variant="body" >Bạn chưa có câu lạc bộ nào</Typography>
      ...
      <Tabs defaultValue='info' className='w-full'>
       ...
       <TabsContent value='stats' className='space-y-6'>
        {clubStats && clubStats.length > 0 ? (
         ...
         <div className='text-center p-8 text-muted-foreground'>
          ...
          <Typography variant="body" >Chưa có dữ liệu thống kê</Typography>
         </div>
        )}
       </TabsContent>
       ...
       <TabsContent value='members' className='space-y-6'>
        <div className='text-center p-8 text-muted-foreground'>
         ...
         <Typography variant="body" >Quản lý thành viên sẽ có trong phiên bản tiếp theo</Typography>
        </div>
       </TabsContent>
      </Tabs>
     </CardContent>
