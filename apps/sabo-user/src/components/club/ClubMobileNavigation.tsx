       ...
       <div className='relative'>
        ...
        {item.path === '/club-management' &&
         ...
         notificationCount > 0 && (
          <Badge
           variant='destructive'
           className='absolute -top-1 -right-1 w-4 h-4 text-caption p-0 flex items-center justify-center animate-bounce'
          >
     ...
     <DropdownMenu>
      <DropdownMenuTrigger asChild>
       ...
       >
        ...
        <span className='text-caption mt-1.5 font-medium text-muted-foreground'>
         Thêm
        </span>
       </Button>
      </DropdownMenuTrigger>
      ...
      >
       {Object.entries(groupedSecondaryItems).map(
        ([groupKey, items]) => (
         <div key={groupKey}>
          <DropdownMenuLabel className='text-caption font-bold text-primary/80 py-2'>
