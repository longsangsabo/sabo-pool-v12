  ...
  return (
    <Card className={className}>
      ...
      <CardContent className="space-y-4">
        ...
        {lastClaimResult && (
          <Alert className={lastClaimResult.success ? 'border-green-200 bg-green-50' : 'border-red-200 bg-red-50'}>
            <div className="flex items-start gap-2">
              ...
              <AlertDescription className={lastClaimResult.success ? 'text-green-800' : 'text-red-800'}>
