     ...
     <div className='text-center space-y-4'>
      <div className='relative inline-block'>
       <Avatar className='w-20 h-20 sabo-tech-avatar'>
        ...
        />
        <AvatarFallback className='text-heading-semibold bg-primary/20'>
      ...
      <div className='space-y-2'>
       {profile?.bio && (
        <p className='text-body-small text-muted-foreground max-w-xs mx-auto'>
         {profile.bio}
        </p>
       )}
      </div>
     ...
     <div className='relative'>
      <Avatar className='w-20 h-20 sabo-tech-avatar border-4 border-background shadow-lg'>
       <AvatarImage
        ...
        className='object-cover'
       />
       <AvatarFallback className='text-title bg-primary/20'>
        {(profile?.display_name || profile?.full_name || 'U')
         .charAt(0)
         .toUpperCase()}
       </AvatarFallback>
