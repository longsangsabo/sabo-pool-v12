 ...
 return (
  <div className='space-y-6'>
   ...
   <div className='flex items-center justify-between'>
    <div>
     <h2 className='text-heading-bold'>Hệ thống Hạng SPA</h2>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='text-center'>
       ...
       <p className='text-body-small text-muted-foreground'>Tổng trận đấu</p>
      </div>
     </CardContent>
    </Card>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='text-center'>
       ...
       <p className='text-body-small text-muted-foreground'>Trận thắng</p>
      </div>
     </CardContent>
    </Card>
    ...
    <Card>
     <CardContent className='p-4'>
      <div className='text-center'>
       ...
       <p className='text-body-small text-muted-foreground'>Tỷ lệ thắng</p>
      </div>
     </CardContent>
    </Card>
   </div>
        ...
        >
         <div className='flex items-center gap-4'>
          <div className='flex items-center gap-2'>
           {history.old_rank && (
            <RankBadge rank={history.old_rank} />
           )}
           <span className='text-muted-foreground'>→</span>
           {history.new_rank && (
            <RankBadge rank={history.new_rank} />
           )}
          </div>
          <div>
