   ...
   <CardContent className='p-4'>
    ...
    <div className='flex items-center justify-between mb-3'>
     <div className='flex items-center gap-2'>
      <Badge variant='outline' className='px-2 py-1 text-caption-medium'>
       Trận {match.match_number}
      </Badge>
      {match.bracket_type && (
       <Badge
        variant='outline'
        className={`px-2 py-1 text-caption-medium ${bracketInfo.color} ${bracketInfo.bgColor} ${bracketInfo.borderColor}`}
       >
        {bracketInfo.icon}
    ...
    <div className='space-y-2'>
     ...
     >
      ...
      {canInputScore && (
       <div className='mt-2 flex items-center gap-2'>
        <span className='text-caption-medium text-primary-700'>
         Tỷ số:
        </span>
        <input
         type='number'
     ...
     <div className='flex items-center justify-center'>
      <div className='bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-caption-medium'>
       VS
      </div>
     </div>
     ...
     >
      ...
      {canInputScore && (
       <div className='mt-2 flex items-center gap-2'>
        <span className='text-caption-medium text-info-700'>
         Tỷ số:
        </span>
        <input
         type='number'
