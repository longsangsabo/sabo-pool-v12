  ...
  <AlertDialog>
   <AlertDialogTrigger asChild>
    <Button
     ...
     className='text-warning-600 border-orange-600 hover:bg-warning-50 hover:text-warning-700 bg-warning-50'
     disabled={loading}
    >
     {loading ? (
   ...
   <AlertDialogContent>
    <AlertDialogHeader>
     ...
     <AlertDialogDescription className='space-y-3'>
      ...
      <div className='bg-warning-50 p-3 rounded-md border border-orange-200'>
       <div className='flex items-start gap-2'>
        <span className='text-warning-600 font-medium'>⚠️</span>
