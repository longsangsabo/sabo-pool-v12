...
export const MatchStatusDebugInfo: React.FC<MatchStatusDebugInfoProps> = ({
 ...
 return (
  <div className='mt-2 p-2 bg-neutral-50 rounded border text-caption space-y-1'>
   ...
   <div className='flex items-center gap-2'>
    ...
    <span
     className={statusInfo.hasPlayers ? 'text-success-600' : 'text-error-600'}
    >
   ...
   <div className='flex items-center gap-2'>
    ...
    <span
     className={
      statusInfo.playersAreDifferent ? 'text-success-600' : 'text-error-600'
     }
    >
   ...
   <div className='flex items-center gap-2'>
    ...
    <span
     className={
      !statusInfo.hasWinner ? 'text-success-600' : 'text-warning-600'
     }
    >
