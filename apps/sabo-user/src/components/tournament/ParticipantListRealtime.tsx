   ...
   <CardHeader>
    <CardTitle className='flex items-center justify-between'>
     <div className='flex items-center gap-2'>
      <Users className='h-5 w-5' />
      Danh sách tham gia
      <span className='text-body-small font-normal text-neutral-500'>
   ...
   <CardContent>
    {participants.length === 0 ? (
     <div className='text-center py-8'>
      ...
      <p className='text-neutral-500'>Chưa có người tham gia</p>
       ...
       {displayedParticipants.map((participant, index) => (
        ...
        >
         ...
         <div className='flex-1 ml-3'>
          ...
          <div className='text-body-small text-neutral-500 flex items-center gap-3'>
      ...
      <div className='mt-4 p-3 bg-neutral-50 rounded-lg'>
       <div className='flex items-center justify-between text-sm'>
        <div className='flex items-center gap-2'>
         ...
         <span className='text-neutral-600'>Cập nhật trực tiếp</span>
        </div>
