  ...
  <AlertDialog>
   <AlertDialogTrigger asChild>
    <Button
     ...
     className='bg-warning-50 hover:bg-warning-100 text-warning-700 border-orange-200'
   ...
   <AlertDialogContent>
    <AlertDialogHeader>
     ...
     <AlertDialogDescription className='space-y-2'>
      ...
      <p className='text-body-small text-muted-foreground'>Chức năng này sẽ:</p>
      <ul className='text-body-small text-muted-foreground list-disc pl-5 space-y-1'>
