...
//     const { data: profilesData, error: profilesError } = await supabase
  ...
  return (
   <div className="form-spacing">
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
     {/* Winners Bracket */}
     <div>
      <h4 className="font-semibold mb-3 text-success-600 dark:text-green-400 bg-success-50 dark:bg-green-900/20 p-2 rounded-lg border border-success-200 dark:border-green-700">🏆 Winners Bracket</h4>
     ...
     {/* Losers Bracket A */}
     <div>
      <h4 className="font-semibold mb-3 text-warning-600 dark:text-orange-400 bg-warning-50 dark:bg-orange-900/20 p-2 rounded-lg border border-orange-200 dark:border-orange-700">⬇️ Losers A</h4>
      <div className="space-y-2">
     ...
     {/* Losers Bracket B */}
     <div>
      <h4 className="font-semibold mb-3 text-error-600 dark:text-red-400 bg-error-50 dark:bg-red-900/20 p-2 rounded-lg border border-error-200 dark:border-red-700">⬇️ Losers B</h4>
      <div className="space-y-2">
     ...
     {/* Group Final */}
     <div>
      <h4 className="font-semibold mb-3 text-info-600 dark:text-purple-400 bg-info-50 dark:bg-purple-900/20 p-2 rounded-lg border border-purple-200 dark:border-purple-700">👑 Group Final</h4>
      <div className="space-y-2">
  ...
  return (
   <div className="form-spacing">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
     <div>
      <h4 className="font-semibold mb-3 text-primary-600 dark:text-blue-400 bg-primary-50 dark:bg-blue-900/20 p-3 rounded-lg border border-primary-200 dark:border-blue-700">🥊 Semifinals</h4>
      <div className="space-y-2">
 ...
 if (error) {
  return (
   <Card>
    <CardContent className="card-spacing">
     <div className="text-error-600">Error loading bracket: {error}</div>
    </CardContent>
   </Card>
  );
 }
  ...
  <div className="space-y-4 relative">
   ...
   <Card>
    <CardHeader>
     ...
     <div className="flex gap-4 text-body-small text-muted-foreground">
   ...
   <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
    ...
    <TabsContent value="progress" className="form-spacing">
    ...
    <TabsContent value="crossBracket" className="form-spacing">
     <Card className="border-purple-200 dark:border-purple-700">
      <CardHeader className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20">
       <CardTitle className="text-body-large text-purple-800 dark:text-purple-200">Cross-Bracket Finals</CardTitle>
    ...
    <TabsContent value="fix" className="form-spacing">
     <SABO32ManualFix 
      tournamentId={tournamentId} 
