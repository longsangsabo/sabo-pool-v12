   ...
   <DialogContent className='max-w-md'>
    ...
    <div className='space-y-4'>
     ...
     <div className='bg-primary-50 p-4 rounded-lg'>
      ...
      <div className='space-y-1 text-body-small text-primary-800'>
     ...
     <div className='bg-warning-50 p-4 rounded-lg border border-warning'>
      ...
      <div className='text-body-small text-warning-800 space-y-2'>
     ...
     {/* Terms */}
     <div className='text-caption text-neutral-600 bg-neutral-50 p-3 rounded'>
