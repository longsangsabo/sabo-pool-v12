    ...
    <CardContent>
     ...
     <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-6'>
      <div className='text-center p-3 bg-muted/50 rounded-lg'>
       <p className='text-body-small text-muted-foreground'>Tổng số bàn</p>
       <p className='text-heading-bold'>{tables.length}</p>
      </div>
      <div className='text-center p-3 bg-success-50 rounded-lg'>
       <p className='text-body-small text-muted-foreground'>Bàn trống</p>
       <p className='text-heading-bold text-success-600'>
        {tables.filter(t => t.status === 'available').length}
       </p>
      </div>
      <div className='text-center p-3 bg-error-50 rounded-lg'>
       <p className='text-body-small text-muted-foreground'>Đang sử dụng</p>
       <p className='text-heading-bold text-error-600'>
        {tables.filter(t => t.status === 'occupied').length}
       </p>
      </div>
      <div className='text-center p-3 bg-warning-50 rounded-lg'>
       <p className='text-body-small text-muted-foreground'>Bảo trì</p>
