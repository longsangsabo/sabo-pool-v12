   ...
   <Card>
    <CardHeader>
     <CardTitle className='flex items-center justify-between'>
      ...
      <Button variant='outline' onClick={fetchMatchStatus}>
     ...
     <div className='space-y-4'>
      ...
      <div className='grid grid-cols-4 gap-4 text-center'>
       <div>
        ...
        <div className='text-caption text-muted-foreground'>Hoàn thành</div>
       </div>
       <div>
        <div className='text-heading-bold text-warning-600'>
         {totalMatches - completedMatches}
        </div>
        <div className='text-caption text-muted-foreground'>Còn lại</div>
       </div>
       <div>
