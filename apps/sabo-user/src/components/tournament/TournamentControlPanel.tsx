    ...
    <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
     <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
      ...
      <div>
       ...
       <div className='text-caption text-muted-foreground'>Matches Done</div>
      </div>
     </div>
     ...
     <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
      ...
      <div>
       ...
       <div className='text-caption text-muted-foreground'>Ready to Play</div>
      </div>
     </div>
     ...
     <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
      ...
      <div>
       ...
       <div className='text-caption text-muted-foreground'>Need Players</div>
      </div>
     </div>
    ...
    {needsRecovery && (
     <div className='p-3 bg-warning-50 dark:bg-orange-900/20 rounded-lg border border-orange-200'>
      <div className='flex items-start gap-2'>
       ...
       <div>
        <div className='text-body-small-medium text-orange-800 dark:text-orange-200'>
