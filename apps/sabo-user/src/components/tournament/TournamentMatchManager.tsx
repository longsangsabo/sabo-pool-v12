     ...
     <div className='grid grid-cols-2 md:grid-cols-5 gap-4'>
      ...
      <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
       ...
       <div>
        ...
        <div className='text-caption text-muted-foreground'>Ready</div>
       </div>
      </div>
      ...
      <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
       ...
       <div>
        ...
        <div className='text-caption text-muted-foreground'>Live</div>
       </div>
      </div>
     </div>
    </CardContent>
    ...
    <CardContent className='p-4'>
     <div className='flex flex-wrap items-center gap-4'>
      ...
      <div className='flex items-center gap-2'>
       ...
       <span className='text-body-small-medium'>Round:</span>
       <Tabs
      ...
      {/* Status Filter */}
      <div className='flex items-center gap-2'>
       <span className='text-body-small-medium'>Status:</span>
