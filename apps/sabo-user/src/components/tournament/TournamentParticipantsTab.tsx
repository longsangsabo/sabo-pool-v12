    ...
    <CardContent>
     <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
      <div className='text-center'>
       <div className='text-heading-bold text-primary'>
        {confirmedRegistrations.length}
       </div>
       <div className='text-body-small text-muted-foreground'>Đã xác nhận</div>
      </div>
      <div className='text-center'>
       <div className='text-heading-bold text-warning-600'>
        {pendingRegistrations.length}
       </div>
       <div className='text-body-small text-muted-foreground'>Chờ xác nhận</div>
      </div>
      <div className='text-center'>
       <div className='text-heading-bold text-primary-600'>
        {waitlistRegistrations.length}
       </div>
       <div className='text-body-small text-muted-foreground'>Danh sách chờ</div>
      </div>
      <div className='text-center'>
       <div className='text-heading-bold text-muted-foreground'>
        {maxParticipants - confirmedRegistrations.length}
       </div>
       <div className='text-body-small text-muted-foreground'>Còn lại</div>
      </div>
     </div>
     ...
     <CardContent>
      <div className='space-y-3'>
       {confirmedRegistrations.map((registration, index) => (
        <div
         key={registration.id}
         className='flex items-center space-x-3 p-3 border rounded-lg hover:bg-neutral-50 transition-colors'
        >
         <div className='flex items-center gap-3'>
          <div className='text-body-small-medium text-muted-foreground w-8'>
           #{index + 1}
          </div>
