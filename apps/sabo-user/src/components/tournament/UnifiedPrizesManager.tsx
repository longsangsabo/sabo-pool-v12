          ...
          <div className="flex items-center justify-between text-sm">
            <div className="flex items-center gap-4">
              <span className="text-muted-foreground">
                Tổng giải thưởng: <span className="font-semibold text-green-600">{formatCurrency(totalPrizePool)}</span>
              </span>
              <span className="text-muted-foreground">
            ...
            <CardContent className="pt-4 pb-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <Badge variant="secondary" className="font-mono text-sm px-3 py-1 bg-white/70">
                    #{prize.position}
                  </Badge>
                  <div>
                    ...
                    {prize.items && prize.items.length > 0 && (
                      <div className="flex items-center gap-1 mt-1 text-sm">
                        ...
                        <span className="text-gray-700">{prize.items.join(', ')}</span>
                      </div>
                    )}
                  </div>
                </div>
                ...
                {isEditable && (
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="bg-white/50 hover:bg-red-50 hover:text-red-600"
                    >
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-medium">Tóm tắt tài chính</span>
            </div>
            <div className="grid grid-cols-3 gap-4 text-sm">
              ...
              <div className="text-center">
                ...
                <div className="font-semibold text-red-600">{formatCurrency(totalPrizePool)}</div>
              </div>
              <div className="text-center">
                <div className="text-muted-foreground">Còn lại</div>
                <div className={`font-semibold ${initialPrizePool - totalPrizePool >= 0 ? 'text-green-600' : 'text-red-600'}`}>
