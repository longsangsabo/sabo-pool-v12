  ...
  <div className='space-y-6'>
   ...
   <div className='text-center space-y-4'>
    <div className='flex justify-center'>
     <div className='p-4 bg-success-100 dark:bg-green-900/20 rounded-full'>
      <CheckCircle className='h-12 w-12 text-success-600 dark:text-green-400' />
     </div>
    </div>

    <div>
     <h3 className='text-heading-bold text-success-700 dark:text-green-400 mb-2'>
      {status.title}
     </h3>
    ...
    <Card className='border-yellow-200 bg-warning-50 dark:bg-yellow-900/10 dark:border-yellow-800'>
     <CardContent className='p-6 text-center'>
      <div className='space-y-4'>
       ...
       <div>
        <h4 className='font-semibold text-warning-800 dark:text-yellow-400 mb-2'>
         Hoàn tất thanh toán
        </h4>
        <p className='text-body-small text-warning-700 dark:text-yellow-300 mb-4'>
    ...
    <CardContent className='space-y-4'>
     <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='space-y-3'>
       <div>
        <p className='text-body-small text-muted-foreground'>Tên giải:</p>
        <p className='font-medium'>{selectedTournament?.name}</p>
       </div>

       <div>
        <p className='text-body-small text-muted-foreground'>Thời gian:</p>
       ...
       <div>
        <p className='text-body-small text-muted-foreground'>Địa điểm:</p>
        <p className='font-medium flex items-center gap-2'>
      ...
      <div className='space-y-3'>
       <div>
        <p className='text-body-small text-muted-foreground'>Hạng giải:</p>
       ...
       <div>
        <p className='text-body-small text-muted-foreground'>Phí tham gia:</p>
        <p className='font-medium flex items-center gap-2'>
       ...
       <div>
        <p className='text-body-small text-muted-foreground'>Giải thưởng:</p>
        <p className='font-medium flex items-center gap-2'>
   ...
   <Card>
    ...
    <CardContent className='space-y-4'>
     <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='space-y-3'>
       <div>
        <p className='text-body-small text-muted-foreground'>Họ tên:</p>
        <p className='font-medium'>{watchedData.player_name}</p>
       </div>

       <div>
        <p className='text-body-small text-muted-foreground'>Số điện thoại:</p>
        <p className='font-medium flex items-center gap-2'>
      ...
      <div className='space-y-3'>
       ...
       <div>
        <p className='text-body-small text-muted-foreground'>Tuổi:</p>
        <p className='font-medium'>{watchedData.age} tuổi</p>
       </div>

       <div>
        <p className='text-body-small text-muted-foreground'>Kinh nghiệm:</p>
     ...
     {watchedData.notes && (
      <>
       <Separator />
       <div>
        <p className='text-body-small text-muted-foreground mb-2'>Ghi chú:</p>
        <p className='text-body-small bg-muted p-3 rounded-lg'>
         {watchedData.notes}
        </p>
       </div>
      </>
   ...
   <Card>
    ...
    <CardContent>
     <div className='space-y-3'>
      ...
      <div className='flex justify-between items-center'>
       <span className='text-body-small text-muted-foreground'>Trạng thái:</span>
       <Badge
