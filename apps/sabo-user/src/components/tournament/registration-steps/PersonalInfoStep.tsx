 ...
 return (
  <div className='space-y-6'>
   <div className='text-center'>
    <h3 className='text-body-large-semibold mb-2'>Thông tin cá nhân</h3>
   ...
   {selectedTournament && (
    <Card className='bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20'>
     <CardHeader className='pb-3'>
      <CardTitle className='text-body-large flex items-center gap-2'>
   ...
   <Card>
    ...
    <CardContent className='space-y-4'>
     ...
     <div className='space-y-2'>
      <Label htmlFor='player_name' className='text-body-small-medium'>
     ...
     <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='space-y-2'>
       <Label
        htmlFor='phone'
        className='text-body-small-medium flex items-center gap-2'
       >
     ...
     <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
      <div className='space-y-2'>
       ...
       />
       {errors.age && (
        <p className='text-body-small text-destructive'>{errors.age.message}</p>
       )}
      </div>
   ...
   <Card>
    ...
    <CardContent>
     <div className='space-y-2'>
      <Label htmlFor='notes' className='text-body-small-medium'>
       Ghi chú (tùy chọn)
      </Label>
      <Textarea
       id='notes'
      ...
      />
      {errors.notes && (
       <p className='text-body-small text-destructive'>{errors.notes.message}</p>
      )}
     </div>
    </CardContent>
   </Card>
   ...
   <Card>
    ...
    <CardContent className='space-y-4'>
     <div className='flex items-start space-x-2'>
      ...
      <Label
       htmlFor='agree_terms'
       className='text-body-small leading-relaxed cursor-pointer'
      >
     ...
     {errors.agree_terms && (
      <p className='text-body-small text-destructive ml-6'>
