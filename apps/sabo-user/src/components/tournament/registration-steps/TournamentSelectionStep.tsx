...
> = ({
 ...
 return (
  <div className='space-y-6'>
   <div className='text-center'>
    <h3 className='text-body-large-semibold mb-2'>Chọn giải đấu tham gia</h3>
     ...
     return (
      ...
      >
       ...
       <CardContent className='space-y-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-caption text-muted-foreground'>
         <div className='flex items-center gap-2'>
        ...
        {isSelected && (
         <div className='mt-4 p-3 bg-primary/5 rounded-lg border border-primary/20'>
          <div className='flex items-center gap-2 text-body-small-medium text-primary'>
