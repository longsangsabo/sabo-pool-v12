       ...
       {paymentMethods.map(method => (
        ...
        >
         <CardContent className='p-4'>
          ...
          <div className='space-y-2 text-body-small-neutral'>
    ...
    return (
     <div className='space-y-4'>
      <div className='text-center mb-6'>
       ...
       <div className='flex items-center justify-center gap-2 text-body-small-neutral'>
   ...
   case 'success':
    return (
     <div className='text-center py-8'>
      ...
      {qrCodeUrl && (
       <div className='mb-4'>
        <p className='text-body-small-neutral mb-2'>
