...
const AboutPage = () => {
 ...
 return (
  <PageLayout variant='full' className='bg-neutral-50'>
   <Navigation />
   ...
   <div className='pt-16'>
    ...
    <div className='bg-gradient-to-br from-blue-700 via-blue-600 to-emerald-600 text-white py-20'>
     <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
      ...
      <p className='text-title md:text-heading max-w-3xl mx-auto leading-relaxed'>
     ...
     <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      <div className='grid md:grid-cols-2 gap-12'>
       <div>
        ...
        <p className='text-body-large text-neutral-700 leading-relaxed'>
     ...
     <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
      ...
      <div className='grid md:grid-cols-3 gap-8'>
       {team.map((member, index) => (
        <div
         key={index}
         className='text-center bg-neutral-50 p-8 rounded-lg'
        >
         <img
          src={member.avatar}
          alt={member.name}
         ...
         />
         <h3 className='text-title font-bold text-neutral-900 mb-2'>
          {member.name}
         </h3>
    ...
    <div className='py-16 bg-neutral-50'>
     <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
      ...
      <p className='text-title text-neutral-600 mb-8'>
