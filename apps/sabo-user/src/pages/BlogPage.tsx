 ...
 return (
  <div className='space-y-6'>
   <div className='text-center space-y-4'>
    <h1 className='text-4xl font-bold text-neutral-900'>Blog & Tin tức</h1>
      ...
      {filteredPosts.map(post => (
       <Card key={post.id} className='hover:shadow-lg transition-shadow'>
        ...
        <CardHeader>
         ...
         <CardTitle className='text-body-large leading-tight'>
          {post.title}
         </CardTitle>
        </CardHeader>
        <CardContent className='space-y-4'>
         {post.excerpt && (
          <p className='text-neutral-600 text-body-small line-clamp-3'>
           {post.excerpt}
          </p>
         )}
