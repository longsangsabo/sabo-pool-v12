 ...
 return (
  <div className="container mx-auto p-6 space-y-6">
    ...
    <Card>
     <CardContent className="pt-4">
      <div className="flex items-center justify-between">
       <div>
        <p className="text-body-small-neutral dark:text-gray-400">Chờ phê duyệt</p>
        <p className="text-heading-bold text-info-600">{mockPendingApprovals.length}</p>
       </div>
   ...
   <Tabs value={activeTab} onValueChange={setActiveTab}>
    ...
    <TabsContent value="pending" className="form-spacing">
    ...
    <TabsContent value="completed" className="form-spacing">
     <div className="form-spacing">
         ...
         <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
           ...
           <div>
            ...
            <p className="text-body-small-neutral dark:text-gray-400">
    ...
    <TabsContent value="disputed" className="form-spacing">
     <Card>
      <CardContent className="text-center py-12">
