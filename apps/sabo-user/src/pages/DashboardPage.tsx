 ...
 return (
  <div className='animate-fade-in'>
   ...
   <div className='py-8'>
    ...
    <div className='mb-8'>
     <h3 className='text-body-large-semibold text-neutral-900 mb-4'>
      Thông số người chơi
     </h3>
     {/* Desktop View */}
      ...
      {playerStats.map((stat, index) => {
       ...
       return (
        ...
        >
         ...
         <CardContent>
          <div className={`text-heading-bold ${stat.color}`}>
           {stat.value}
          </div>
        ...
        return (
         ...
         >
          <CardContent className='p-4'>
           ...
           <div className={`text-title font-bold mb-1 ${stat.color}`}>
            {stat.value}
           </div>
           <div className='text-caption text-neutral-600'>{stat.title}</div>
          </CardContent>
         </Card>
        );
       })}
        ...
        {recentActivities.map(activity => (
         ...
         >
          ...
          <div className='flex-1'>
           <p className='text-body-small-medium'>{activity.title}</p>
           <p className='text-caption-neutral'>{activity.time}</p>
          </div>
         </div>
        ))}
       </div>
