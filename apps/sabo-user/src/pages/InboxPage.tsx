...
const InboxPage = () => {
 ...
 const getStatusBadge = (notification: any) => {
  ...
  return (
   <Badge variant='outline' className='text-caption-neutral'>
     ...
     <div className='mb-6'>
      <div className='flex items-center justify-between mb-6'>
       ...
       <div className='flex items-center gap-3'>
        <div
         className={`flex items-center gap-2 px-3 py-2 rounded-full text-body-small transition-all ${
          isConnected
      ...
      <div className='lg:col-span-1'>
       <Card className='shadow-lg border-0'>
        <CardHeader className='pb-4 bg-gradient-to-r from-gray-50 to-gray-100 rounded-t-lg'>
         <CardTitle className='text-body-large flex items-center justify-between'>
              ...
              <div className='flex items-start gap-3'>
               ...
               <div className='flex-1 min-w-0'>
                <div className='flex items-center gap-2 mb-2'>
                 <h4
                  className={`font-medium text-body-small truncate ${
                ...
                <p className='text-body-small-neutral line-clamp-2 mb-3'>
        ...
        {selectedMessage ? (
          ...
          <CardContent className='p-6'>
           <ScrollArea className='h-[500px]'>
            <div className='prose max-w-none'>
             <div className='text-neutral-700 leading-relaxed text-body mb-6'>
         ...
         <CardContent className='flex items-center justify-center h-full'>
          <div className='text-center text-neutral-500'>
           ...
           <h3 className='text-title-medium mb-3'>
            Chọn một tin nhắn
           </h3>
