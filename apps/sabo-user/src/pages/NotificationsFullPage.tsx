   ...
   <div className="min-h-screen bg-background flex items-center justify-center p-4">
    <Card className="w-full max-w-md">
     <CardContent className="pt-6 text-center">
      ...
      <h3 className="text-body-large font-medium mb-2">Đăng nhập để xem thông báo</h3>
   ...
   <div className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b">
    <div className="flex items-center justify-between p-4">
     <div className="flex items-center gap-3">
      ...
      <div>
       <h1 className="text-body-large-semibold">Thông báo</h1>
     ...
     >
      <TabsList className="grid w-full grid-cols-3">
       ...
       <TabsTrigger value="unread" className="text-caption">
        Chưa đọc
        <Badge variant="destructive" className="ml-1 text-caption">
         {unreadCount}
        </Badge>
       </TabsTrigger>
       <TabsTrigger value="read" className="text-caption">
        Đã đọc
   ...
   <div className="pb-20">
    {loading ? (
     ...
     <div className="flex flex-col items-center justify-center py-12 px-4">
      ...
      <h3 className="text-body-large font-medium text-center mb-2">
       {filters.tab === 'unread' ? 'Không có thông báo chưa đọc' : 
        filters.search ? 'Không tìm thấy kết quả' : 'Không có thông báo'}
      </h3>
      <p className="text-muted-foreground text-center text-body-small mb-4">
      ...
      {/* Debug info */}
      {totalCount === 0 && (
       <div className="text-caption text-muted-foreground bg-muted/50 p-3 rounded mt-4 max-w-sm text-center">
       ...
       <Card 
        ...
        className={`cursor-pointer transition-colors relative ${
         !notification.is_read 
          ? 'bg-primary-50/50 dark:bg-blue-950/20 border-primary-200 dark:border-blue-800' 
          : 'hover:bg-muted/50'
         ...
         <div className="flex items-start gap-3 ml-6">
          ...
          <div className="flex-1 min-w-0">
           <div className="flex items-start justify-between gap-2 mb-1">
            <h3 className="font-medium text-body-small leading-5">
             {notification.title}
            </h3>
            {!notification.is_read && (
             <div className="w-2 h-2 bg-primary-600 dark:bg-blue-400 rounded-full flex-shrink-0 mt-1.5"></div>
            )}
           </div>
           
           <p className="text-body-small text-muted-foreground mb-3 leading-5">
