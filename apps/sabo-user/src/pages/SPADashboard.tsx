    ...
    <div className="container mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600">Theo dõi điểm SPA và hoàn thành milestone</p>
        </div>
        <Card className="bg-gradient-to-r from-blue-500 to-purple-600 text-white">
          <CardContent className="p-4">
            <div className="text-center">
              <div className="text-2xl font-bold">{currentPoints.toLocaleString()}</div>
              <div className="text-sm opacity-90">Điểm SPA</div>
            </div>
          </CardContent>
        </Card>
      </div>
            ...
            <CardContent>
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-green-600">+100 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Đăng ký hạng</span>
                  <span className="font-semibold text-green-600">+200 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Giới thiệu bạn bè</span>
                  <span className="font-semibold text-green-600">+150 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Thắng giải đấu đầu tiên</span>
                  <span className="font-semibold text-green-600">+300 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Hoàn thiện profile</span>
                  <span className="font-semibold text-green-600">+75 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Nạp tiền lần đầu</span>
                  <span className="font-semibold text-green-600">+500 SPA</span>
                </div>
              </div>
            </CardContent>
          </Card>
