 ...
 return (
  <div className='container mx-auto px-4 py-8'>
   ...
   <div className='mt-12 p-6 bg-primary-50 rounded-lg'>
    <h2 className='text-heading-bold text-blue-900 mb-4'>
    ...
    <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
     <div className='text-center'>
      ...
      <div className='text-body-small-neutral'>Tổng số trang</div>
     </div>
     <div className='text-center'>
      <div className='text-3xl font-bold text-primary-600'>
       {pageCategories.length}
      </div>
      <div className='text-body-small-neutral'>Danh mục</div>
     </div>
     <div className='text-center'>
      <div className='text-3xl font-bold text-info-600'>✅</div>
      <div className='text-body-small-neutral'>Routing hoàn tất</div>
     </div>
     <div className='text-center'>
      <div className='text-3xl font-bold text-warning-600'>🎯</div>
      <div className='text-body-small-neutral'>Navigation cập nhật</div>
     </div>
    </div>
   </div>
  </div>
