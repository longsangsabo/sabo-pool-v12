     ...
     <div className='flex items-center justify-between mb-6'>
      ...
      <div className='flex gap-2'>
       <Button
        ...
        disabled={isRunning}
        className='bg-yellow-400 text-green-900 hover:bg-warning-500'
       >
        <RefreshCw
      ...
      <CardContent>
       <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
        <div className='text-center'>
         ...
         <p className='text-body-small-neutral'>Overall Health</p>
        </div>
        <div className='text-center'>
         <div className='text-heading-bold text-success-600'>
          {systemStatus.passedTests}
         </div>
         <p className='text-body-small-neutral'>Tests Passed</p>
        </div>
        <div className='text-center'>
         <div className='text-heading-bold text-error-600'>
          {systemStatus.errors.length}
         </div>
         <p className='text-body-small-neutral'>Critical Issues</p>
        </div>
        <div className='text-center'>
         <div className='text-heading-bold text-warning-600'>
          {systemStatus.warnings.length}
         </div>
         <p className='text-body-small-neutral'>Warnings</p>
        </div>
       </div>
       ...
       {systemStatus.errors.length > 0 && (
        <div className='mt-4 p-4 bg-error-50 rounded-lg'>
         <h4 className='font-semibold text-error-800 mb-2'>
          Critical Issues Found:
         </h4>
         <ul className='text-body-small text-error-700 space-y-1'>
         ...
         <CardContent className='p-4'>
          ...
          {result.details && (
           <details className='mt-3'>
            <summary className='cursor-pointer text-body-small-medium'>
             View Details
            </summary>
            <pre className='mt-2 text-caption bg-neutral-100 p-2 rounded overflow-auto max-h-40'>
           ...
           <CardContent className='p-4'>
            <div className='flex items-center gap-3'>
             ...
             <div className='flex-1'>
              ...
              <p className='text-body-small text-error-600'>
               {result.message}
              </p>
              {result.details && (
               <details className='mt-2'>
                <summary className='cursor-pointer text-caption-medium'>
                 Technical Details
                </summary>
                <pre className='mt-1 text-caption bg-error-100 p-2 rounded'>
                 {JSON.stringify(result.details, null, 2)}
                </pre>
               </details>
              )}
