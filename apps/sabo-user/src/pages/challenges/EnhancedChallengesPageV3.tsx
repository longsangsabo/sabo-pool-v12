    ...
    <div className="p-4 space-y-4">
     ...
     <div className="text-center space-y-2">
      <motion.h1
       ...
       className="text-heading-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent flex items-center justify-center gap-2"
      >
       🏆 THÁCH ĐẤU 🎯
      </motion.h1>
      <motion.div
   ...
   <div className="sticky bottom-0 bg-black/40 backdrop-blur-lg border-t border-gray-600/20 p-4">
    <div className="flex justify-around text-center">
     ...
     <motion.div whileHover={{ scale: 1.1 }}>
      ...
      <p className="text-caption text-muted-foreground">Đã xong</p>
     </motion.div>
    </div>
   </div>
