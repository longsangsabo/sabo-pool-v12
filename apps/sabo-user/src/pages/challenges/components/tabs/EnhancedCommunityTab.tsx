  ...
  if (tab.data.length === 0) {
   return (
    ...
    >
     ...
     <h3 className="text-body-large-semibold text-neutral-800 dark:text-gray-100 mb-2">
      Chưa có thách đấu
     </h3>
      ...
      <div className="border-b border-border/30 dark:border-border/20 bg-transparent backdrop-blur-sm">
       ...
       <div className="flex items-center gap-2 p-3 border-b border-border/20 dark:border-border/10">
        ...
        <Select value={sortBy} onValueChange={(value: any) => setSortBy(value)}>
         <SelectTrigger className="w-32 h-8 text-caption bg-transparent border-border/30 text-gray-300 dark:text-gray-200">
          <SelectValue />
         </SelectTrigger>
         <SelectContent>
        ...
        <Select value={timeFilter} onValueChange={(value: any) => setTimeFilter(value)}>
         <SelectTrigger className="w-28 h-8 text-caption bg-transparent border-border/30 text-gray-300 dark:text-gray-200">
          <SelectValue />
         </SelectTrigger>
         <SelectContent>
        ...
        {processedTabs.map((tab) => {
         ...
         return (
          ...
          >
           ...
           <div className={cn(
            'text-caption-medium transition-colors text-center',
            isActive 
