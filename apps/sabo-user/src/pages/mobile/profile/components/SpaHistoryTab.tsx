...
//    const { data: transactionData, error } = await supabase
 ...
 const formatAmount = (amount: number) => {
  ...
  const color = isPositive 
   ...
   : (theme === 'dark' ? 'text-red-400' : 'text-error-600');
  ...
  return (
   <div className="flex items-center justify-center py-8">
    <div className="flex items-center gap-2">
     ...
     <span className="text-body-small">Đang tải lịch sử SPA...</span>
    </div>
   </div>
  );
 }
   ...
   <Card className={
    ...
    <CardContent className="content-spacing">
     <div className="flex items-center justify-between">
      <div>
       <div className="text-body-small text-muted-foreground">Số dư SPA hiện tại</div>
   ...
   <div className="grid grid-cols-2 gap-4">
    <Card className={
     ...
     <CardContent className="p-3">
      <div className="flex items-center justify-between">
       <div>
        <div className="text-caption text-muted-foreground">Tổng thu</div>
    ...
    <Card className={
     theme === 'dark'
      ...
      : 'bg-gradient-to-r from-red-50 to-pink-50 border-error-200'
    }>
     <CardContent className="p-3">
      <div className="flex items-center justify-between">
       <div>
        <div className="text-caption text-muted-foreground">Tổng chi</div>
        <div className={`text-body-large font-bold ${
         theme === 'dark' ? 'text-red-300' : 'text-error-600'
        }`}>
       ...
       <Card key={transaction.id} className={
        ...
        <CardContent className="content-spacing">
         ...
         {transaction.metadata && Object.keys(transaction.metadata).length > 0 && (
          <div className={`mt-3 p-2 rounded text-caption ${
           theme === 'dark' 
