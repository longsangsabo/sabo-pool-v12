  ...
  <Card className='border-purple-300 bg-gradient-to-r from-purple-50 to-pink-100 dark:from-purple-950/30 dark:to-pink-900/30'>
   ...
   <CardContent>
    <div className='space-y-4'>
     ...
     <div className='grid md:grid-cols-2 gap-3 text-caption bg-info-50 dark:bg-purple-900/20 p-3 rounded-lg'>
      <div>
       <span className='font-medium text-info-700'>Semifinal 1:</span>
       <p>Winners Bracket Finalist #1 vs Losers Branch A Champion</p>
      </div>
      <div>
       <span className='font-medium text-info-700'>Semifinal 2:</span>
      ...
      {semifinalMatches.map((match, index) => (
       <div key={match.id} className='space-y-2'>
        <div className='flex items-center gap-2'>
         <Badge
          variant='outline'
          className='border-purple-300 text-info-700'
         >
          Semifinal {index + 1}
         </Badge>
     ...
     {/* Semifinals Summary */}
     <div className='mt-4 p-3 bg-info-100 dark:bg-purple-900/30 rounded-lg border border-purple-200'>
