...
-- Drop obsolete/duplicate double elimination functions
-- Keep only the essential ones that are actively used
...
-- Drop obsolete bracket generation functions
DROP FUNCTION IF EXISTS public.create_double_elimination_tournament CASCADE;
