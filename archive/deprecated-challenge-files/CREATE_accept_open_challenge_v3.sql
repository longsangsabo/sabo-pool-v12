-- TẠO accept_open_challenge_v3 - FUNCTION MỚI HOÀN TOÀN
-- ========================================================
...
BEGIN
    ...
    BEGIN
        ...
        SELECT 
            ...
            c.status,
            c.club_id,
            cr.rank as challenger_rank,
            pr.rank as current_user_rank
        INTO challenge_record
        FROM challenges c
        LEFT JOIN profiles cr ON cr.id = c.challenger_id  
        ...
        FROM profiles WHERE id = challenge_record.challenger_id;
        ...
        SET spa_balance = spa_balance - required_spa,
            updated_at = NOW()
        WHERE id = challenge_record.challenger_id;
...
-- Grant permissions
GRANT EXECUTE ON FUNCTION accept_open_challenge_v3(uuid, uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION accept_open_challenge_v3(uuid, uuid) TO service_role;

-- Test function
SELECT 'accept_open_challenge_v3 created successfully!' as status;
