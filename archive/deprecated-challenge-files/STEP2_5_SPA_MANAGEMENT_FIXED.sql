-- =============================================================================
-- STEP 2.5: SPA MANAGEMENT SYSTEM (CORRECTED SCHEMA) - FIX DROP FIRST
-- Deploy này trước Step 3 trên Supabase SQL Editor
-- =============================================================================

-- DROP existing functions first to avoid parameter name conflicts
DROP FUNCTION IF EXISTS update_spa_balance(UUID, INTEGER, VARCHAR(50), TEXT, UUID, VARCHAR(50)) CASCADE;
DROP FUNCTION IF EXISTS transfer_spa_points(UUID, UUID, INTEGER, VARCHAR(50), TEXT, UUID) CASCADE;
DROP FUNCTION IF EXISTS get_user_spa_history(UUID, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS deduct_challenge_spa(UUID, UUID, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS reward_challenge_spa(UUID, UUID, INTEGER) CASCADE;
DROP FUNCTION IF EXISTS refund_challenge_spa(UUID, UUID, INTEGER) CASCADE;
...
-- =============================================================================
-- COMMENT: STEP 2.5 SPA MANAGEMENT SYSTEM DEPLOYED (CORRECTED SCHEMA + DROP FIRST)
