                    ...
                    {formData.photos.map((photo, index) => (
                      <div key={index} className='relative group'>
                        ...
                        <button
                          ...
                          className='absolute -top-2 -right-2 bg-error-500 text-white rounded-full w-6 h-6 flex items-center justify-center text-xs hover:bg-error-600 opacity-0 group-hover:opacity-100 transition-opacity'
                        >
                          ×
                        </button>
                      </div>
