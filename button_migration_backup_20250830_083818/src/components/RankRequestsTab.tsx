        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-sm text-neutral-600'>Chờ xử lý</p>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-sm text-neutral-600'>Đã phê duyệt</p>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-sm text-neutral-600'>Kiểm tra tại chỗ</p>
