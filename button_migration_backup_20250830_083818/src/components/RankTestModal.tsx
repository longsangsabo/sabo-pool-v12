        ...
        {testPhase === 'testing' && (
          <div className='space-y-6'>
            ...
            <div className='bg-success-50 border border-success-200 rounded-lg p-4'>
              ...
              <div className='grid grid-cols-2 gap-2 text-sm text-success-700'>
                {rankInfo.requirements.map((req, index) => (
                    ...
                    {proofPhotos.map((photo, index) => (
                      <div key={index} className='relative group'>
                        ...
                        <button
                          ...
                          className='absolute -top-1 -right-1 bg-error-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity'
                        >
                          <X className='w-3 h-3' />
                        </button>
                      </div>
