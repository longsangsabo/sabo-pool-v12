      ...
      <Card>
        <CardContent className='pt-6'>
          <div className='text-center'>
            ...
            <p className='text-sm text-neutral-600'>Đang tải yêu cầu...</p>
          </div>
        </CardContent>
      </Card>
    );
        ...
        {notes && (
          <div className='space-y-3'>
            <div className='bg-primary-50 p-3 rounded-lg border border-primary-200'>
              <p className='text-sm text-primary-700 font-medium'>Lịch đã hẹn:</p>
              <p className='text-sm text-primary-600 mt-1'>{notes}</p>
            </div>
