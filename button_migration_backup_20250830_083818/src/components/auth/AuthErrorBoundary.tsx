      ...
      <div className='max-w-md w-full space-y-8'>
        ...
        {isDevelopment && error && (
          <div className='mt-4 p-4 bg-error-50 border border-error-200 rounded-md'>
            ...
            <p className='text-xs text-error-700 font-mono break-words'>
              {error.message}
            </p>
            {error.stack && (
        ...
        <div className='mt-8 space-y-3'>
          ...
          <button
            onClick={onReload}
            className='w-full flex justify-center py-2 px-4 border border-neutral-300 rounded-md shadow-sm text-sm font-medium text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
          >
            Tải lại trang
          </button>
