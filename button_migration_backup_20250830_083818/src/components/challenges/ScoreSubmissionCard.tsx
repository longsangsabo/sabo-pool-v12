  ...
  const renderScoreStatus = () => {
    ...
    if (!hasSubmittedScore) {
      return (
        <div className="space-y-2">
          ...
          <div className="text-xs text-neutral-500">Một trong hai người chơi cần nhập tỷ số</div>
        </div>
      );
    }
    ...
    return (
      <div className="space-y-2">
        ...
        <div className="text-xs text-neutral-500">Tỷ số đã xác nhận, chờ CLB phê duyệt và chuyển điểm SPA</div>
      </div>
    );
  };
    ...
    <Card className="border-l-4 border-l-gradient-to-b from-blue-500 to-purple-500 shadow-lg">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 items-center gap-4 p-3 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
          ...
          <div className="text-center">
            <div className="text-sm text-neutral-500 mb-1">Race to {challenge.race_to || 'N/A'}</div>
              ...
              return (
                <>
                  ...
                  <div className="bg-white dark:bg-neutral-800/50 rounded-lg p-4 border border-blue-100 dark:border-blue-800">
                    <div className="grid grid-cols-3 items-center gap-4">
                      <div className="text-center">
                        <div className="text-sm font-medium text-neutral-600 dark:text-gray-400 mb-1">
                          {challengerProfile.display_name}
                        </div>
                      ...
                      {!showConfirmation ? (
                        ...
                        <div className="space-y-3">
                          <div className="p-3 bg-warning-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg">
                            <div className="text-sm text-warning-800 dark:text-yellow-200 font-medium mb-2">
                              ⚠️ Xác nhận cuối cùng
                            </div>
                            <p className="text-xs text-warning-700 dark:text-yellow-300">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-neutral-800/50 rounded-lg p-4 border border-green-100 dark:border-green-800">
                <div className="text-center mb-3">
                  <div className="text-sm font-medium text-neutral-600 dark:text-gray-400">Kết quả cuối cùng</div>
                </div>
                ...
                <div className="grid grid-cols-3 items-center gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-400">vs</div>
                    <div className="text-xs text-neutral-500 mt-1">Race to {challenge.race_to || 'N/A'}</div>
                  </div>
              ...
              <div className="flex items-center justify-between p-3 bg-primary-50 dark:bg-blue-900/20 border border-primary-200 dark:border-blue-700 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-primary-800 dark:text-blue-200">
                    Chuyển điểm SPA
                  </span>
                </div>
              ...
              {challenge.response_message && (
                <div className="p-3 bg-neutral-50 dark:bg-neutral-800/50 border border-neutral-200 dark:border-gray-700 rounded-lg">
                  <div className="text-xs text-neutral-600 dark:text-gray-400 font-medium mb-1">Ghi chú CLB:</div>
