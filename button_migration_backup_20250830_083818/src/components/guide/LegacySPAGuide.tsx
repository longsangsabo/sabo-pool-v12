    ...
    <div className='space-y-6'>
      ...
      <div className='grid md:grid-cols-2 gap-6'>
        ...
        <Card>
          ...
          <CardContent className='space-y-2'>
            <div className='text-xs bg-neutral-100 p-2 rounded'>
              <code>SELECT COUNT(*) FROM legacy_spa_points;</code>
            </div>
            <div className='text-xs text-neutral-600'>Check total legacy players (should be 45)</div>
            
            <div className='text-xs bg-neutral-100 p-2 rounded mt-2'>
              <code>SELECT * FROM legacy_spa_points WHERE claimed = false;</code>
            </div>
            <div className='text-xs text-neutral-600'>See unclaimed legacy players</div>
          </CardContent>
        </Card>
      </div>
