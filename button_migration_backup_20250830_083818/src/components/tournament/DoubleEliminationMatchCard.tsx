            ...
            {canInputScore && (
              <div className='mt-2 flex items-center gap-2'>
                ...
                <input
                  ...
                  min='0'
                  max='50'
                  className='w-16 px-2 py-1 border border-primary-300 rounded text-center text-sm font-medium bg-white focus:outline-none focus:ring-1 focus:ring-blue-500'
                  placeholder='0'
                  value={player1Score}
        ...
        {canInputScore && (
          <div className='mt-3 space-y-2'>
            ...
            <Button
              ...
              className='w-full h-8 bg-success-600 hover:bg-success-700 text-white text-xs'
            >
