...
export const EnhancedMatchCard: React.FC<EnhancedMatchCardProps> = ({
  ...
  const getMatchStatusBadge = () => {
    switch (match.status) {
      ...
      case 'ongoing':
        return (
          <Badge className='bg-primary-500 hover:bg-primary-600'>Đang diễn ra</Badge>
        );
      case 'ready':
        return (
          ...
          >
            ...
            {isClubOwner && match.player1_id && match.player2_id && (
              <div className='mt-2 p-3 bg-primary-50 border border-primary-200 rounded-lg'>
                <div className='flex items-center gap-3'>
                  <span className='text-sm font-medium text-primary-700 min-w-[60px]'>
                    Tỷ số:
                  </span>
                  <input
                    ...
                    tabIndex={0}
                  />
                  <span className='text-xs text-primary-600 font-medium'>P1</span>
                </div>
              </div>
            )}
          </div>
          ...
          >
            ...
            {isClubOwner && match.player1_id && match.player2_id && (
              <div className='mt-2 p-3 bg-info-50 border border-purple-200 rounded-lg'>
                <div className='flex items-center gap-3'>
                  <span className='text-sm font-medium text-info-700 min-w-[60px]'>
                    Tỷ số:
                  </span>
                  <input
        ...
        {isClubOwner && match.player1_id && match.player2_id && (
          <div className='mt-4 space-y-3'>
            ...
            <Button
              ...
              className='w-full bg-success-600 hover:bg-success-700 text-white disabled:opacity-50'
            >
