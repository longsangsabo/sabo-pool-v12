      ...
      {transformedPlayers[currentIndex] && (
        <div className='absolute bottom-20 left-1/2 transform -translate-x-1/2 flex space-x-6 z-20'>
          <motion.button
            ...
            className='w-14 h-14 bg-error-500 rounded-full shadow-lg flex items-center justify-center hover:bg-error-600 transition-colors'
          >
          ...
          <motion.button
            ...
            className='w-12 h-12 bg-primary-500 rounded-full shadow-lg flex items-center justify-center hover:bg-primary-600 transition-colors'
          >
