      ...
      <div className='h-1/2 p-4 space-y-4'>
        ...
        <div className='bg-success-50 rounded-lg p-3'>
          ...
          <div className='flex flex-wrap gap-1'>
            ...
            )) || <span className='text-xs text-success-700'>Chưa cập nhật</span>}
          </div>
        </div>
        ...
        <div className='grid grid-cols-3 gap-3 text-center'>
          <div>
            ...
            <div className='text-xs text-neutral-500'>Trận đấu</div>
          </div>
          <div>
            <div className='text-lg font-bold text-success-600'>{winRate}%</div>
            <div className='text-xs text-neutral-500'>Tỷ lệ thắng</div>
          </div>
          <div>
