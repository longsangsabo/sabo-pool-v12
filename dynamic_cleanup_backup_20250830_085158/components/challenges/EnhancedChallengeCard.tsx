          ...
          <div className="flex items-center justify-between mb-3 relative z-10">
            ...
            <div className="flex flex-col items-end gap-1">
              {challenge.scheduled_time && (
                <div className="text-xs text-primary-600 dark:text-blue-400 font-medium bg-primary-50/50 dark:bg-blue-900/30 px-2 py-1 rounded">
          ...
          <div className="space-y-3 relative z-10">
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                {challenge.description && size !== 'compact' && (
                  <p className="text-sm text-neutral-700 dark:text-gray-200 line-clamp-2">
                    {challenge.description}
                  </p>
                )}
              </div>
              {challenge.bet_amount && (
                <div className="text-xs text-warning-600 dark:text-yellow-400 font-bold bg-warning-100/50 dark:bg-yellow-900/30 px-2 py-1 rounded">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 text-center">
                ...
                />
                <div className="text-xs font-medium text-neutral-700 dark:text-gray-300 truncate">
                ...
                {/* Player Info */}
                <div className="text-xs text-neutral-500 dark:text-gray-400 mt-1 space-y-0.5">
              ...
              <div className="mx-4 text-center">
                <div className="text-neutral-600 dark:text-gray-300 text-lg font-bold">
                  vs
                </div>
              ...
              <div className="space-y-2">
                ...
                {challenge.location && (
                  <div className="flex items-start gap-2 p-3 bg-success-50/50 dark:bg-green-900/20 rounded-lg border border-success-200/50 dark:border-green-700/30">
                    ...
                    <div className="flex-1">
                      <span className="text-neutral-600 dark:text-gray-400 text-xs font-medium block">CLB thi đấu</span>
                      <span className="text-neutral-800 dark:text-gray-100 font-semibold text-sm leading-relaxed">
                        {challenge.location}
                      </span>
                    </div>
                  </div>
                ...
                {challenge.required_rank && challenge.required_rank !== 'all' && (
                  <div className="flex items-start gap-2 p-3 bg-primary-50/50 dark:bg-blue-900/20 rounded-lg border border-primary-200/50 dark:border-blue-700/30">
                    ...
                    <div className="flex-1">
                      <span className="text-neutral-600 dark:text-gray-400 text-xs font-medium block">Yêu cầu hạng</span>
                      <span className="text-neutral-800 dark:text-gray-100 font-semibold text-sm">
