              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                {award.cashPrize > 0 && (
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <div className='text-sm text-neutral-500'>Tiền thưởng</div>
                ...
                {award.spaPoints > 0 && (
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <div className='text-sm text-neutral-500'>Điểm SPA</div>
                ...
                {award.eloPoints > 0 && (
                  <div className='flex items-center gap-2'>
                    <div className='w-8 h-8 bg-info-100 rounded-full flex items-center justify-center'>
                      <span className='text-info-600 text-xs font-semibold'>
                        ELO
                      </span>
                    </div>
                    <div>
                      <div className='text-sm text-neutral-500'>Điểm ELO</div>
                ...
                {award.physicalPrizes.length > 0 && (
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <div className='text-sm text-neutral-500'>Hiện vật</div>
