          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center">
                ...
                <div className="text-sm text-muted-foreground">Group A</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-primary-600">
                  {Math.round(stats.groupBProgress)}%
                </div>
                <div className="text-sm text-muted-foreground">Group B</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-info-600">
                  {Math.round(stats.crossBracketProgress)}%
                </div>
                <div className="text-sm text-muted-foreground">Cross-Bracket</div>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-2xl font-bold">{Math.round(stats.averageMatchDuration)}</div>
            <div className="text-sm text-muted-foreground">Avg Min/Match</div>
          </CardContent>
        </Card>
              ...
              {stats.nextMatches.map((match) => (
                <div key={match.id} className="flex items-center justify-between p-2 bg-muted rounded-lg">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">{match.bracket_type}</span>
                  </div>
