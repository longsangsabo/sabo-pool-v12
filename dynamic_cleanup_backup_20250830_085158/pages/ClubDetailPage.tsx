            ...
            <Card>
              ...
              <CardContent className='space-y-3'>
                <div className='flex items-start'>
                  ...
                  <div>
                    <p className='text-sm font-medium text-neutral-900'>Địa chỉ</p>
                    <p className='text-sm text-neutral-600'>{club.address}</p>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <div className='flex items-center justify-between'>
                  <span className='text-sm text-neutral-600'>Thành viên</span>
                  <span className='text-sm font-medium text-neutral-900'>
                    {memberCount}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm text-neutral-600'>Số bàn</span>
                  <span className='text-sm font-medium text-neutral-900'>
                    {club.table_count || 0}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-sm text-neutral-600'>Giải đấu</span>
                  <span className='text-sm font-medium text-neutral-900'>
                    {tournaments.length}
                  </span>
                </div>
