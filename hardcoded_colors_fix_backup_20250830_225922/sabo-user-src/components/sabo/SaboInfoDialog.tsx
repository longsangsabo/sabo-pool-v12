        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-3'>
            ...
            <div className={`text-body-small leading-relaxed p-4 rounded-lg border ${
              isDark 
                ...
                : 'bg-primary-50 border-primary-200 text-muted-foreground'
            }`}>
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-2'>
              ...
              <h3 className={`font-semibold text-body-large ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>🏆 Bảng Mapping Hạng - ELO</h3>
            </div>
              ...
              {ranks.map(rank => (
                ...
                >
                  <div className='flex items-center gap-3'>
                    <Badge variant='outline' className={`font-mono font-bold text-body-small ${
                      isDark 
                  ...
                  <div className={`text-caption max-w-48 text-right ${
            ...
            <div className={`text-caption p-2 rounded border ${
              isDark 
          ...
          <div className='space-y-3'>
            ...
            <div className='overflow-x-auto'>
              <table className={`w-full text-body-small border-collapse border ${
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-2'>
              ...
              <h3 className={`font-semibold text-body-large ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>🎯 Ý Nghĩa Từng Thành Phần</h3>
            </div>
              ...
              <div className='space-y-3'>
                <div className={`p-3 rounded-lg border ${
                  ...
                  <div className={`font-medium mb-2 ${
                    isDark ? 'text-blue-400' : 'text-primary-800'
                  }`}>handicap_1_rank</div>
                  <div className={`text-body-small ${
                    isDark ? 'text-slate-300' : 'text-primary-700'
                  }`}>
                ...
                <div className={`p-3 rounded-lg border ${
                  ...
                  <div className={`font-medium mb-2 ${
                    isDark ? 'text-green-400' : 'text-success-800'
                  }`}>Bet Points</div>
                  <div className={`text-body-small ${
                    isDark ? 'text-slate-300' : 'text-success-700'
                  }`}>
              ...
              <div className='space-y-3'>
                <div className={`p-3 rounded-lg border ${
                  isDark 
                    ...
                    : 'bg-info-50 border-purple-200'
                }`}>
                  <div className={`font-medium mb-2 ${
                    isDark ? 'text-purple-400' : 'text-purple-800'
                  }`}>handicap_05_rank</div>
                  <div className={`text-body-small ${
                    isDark ? 'text-slate-300' : 'text-info-700'
                  }`}>
                ...
                <div className={`p-3 rounded-lg border ${
                  isDark 
                    ...
                    : 'bg-warning-50 border-orange-200'
                }`}>
                  <div className={`font-medium mb-2 ${
                    isDark ? 'text-orange-400' : 'text-orange-800'
                  }`}>Race To</div>
                  <div className={`text-body-small ${
                    isDark ? 'text-slate-300' : 'text-warning-700'
                  }`}>
            ...
            <div className='grid gap-3'>
              <div className={`p-4 rounded-lg border ${
                isDark 
                  ...
                  : 'bg-gradient-to-r from-red-50 to-orange-50 border-error-200'
              }`}>
                <div className={`font-medium mb-2 ${
                  isDark ? 'text-red-400' : 'text-error-800'
                }`}>
                  🔥 Scenario 1: Chênh lệch 1 hạng chính
                </div>
                <div className={`text-body-small space-y-1 ${
                  isDark ? 'text-slate-300' : 'text-error-700'
                }`}>
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-2'>
              ...
              <h3 className={`font-semibold text-body-large ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>🎯 Nguyên Tắc Thiết Kế</h3>
            </div>
            <div className='grid md:grid-cols-2 gap-4 text-sm'>
              ...
              <div className='space-y-3'>
                ...
                <div className={`p-3 rounded-lg border ${
                  ...
                  <div className={isDark ? 'text-slate-300' : 'text-error-700'}>
          ...
          {/* Core Philosophy */}
          <div className='space-y-3'>
            <h3 className={`font-semibold text-body-large ${isDark ? 'text-slate-100' : 'text-slate-900'}`}>🎯 Core Philosophy</h3>
            <div className={`p-4 rounded-lg border-2 text-center ${
              isDark 
                ? 'bg-gradient-to-r from-blue-900/30 to-purple-900/30 border-blue-700' 
                : 'bg-gradient-to-r from-blue-100 to-purple-100 border-primary-300'
            }`}>
              <div className={`text-body-large font-bold mb-2 ${
                isDark ? 'text-blue-300' : 'text-primary-800'
              }`}>
                "Every match should be winnable by both players,<br/>regardless of initial skill difference."
              </div>
              <div className={`text-body-small ${
                isDark ? 'text-slate-400' : 'text-primary-700'
              }`}>
