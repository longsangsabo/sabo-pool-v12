          ...
          >
            ...
            {isClubOwner && match.player1_id && match.player2_id && (
              <div className='mt-2 p-3 bg-primary-50 border border-primary-200 rounded-lg'>
                <div className='flex items-center gap-3'>
                  <span className='text-body-small-medium text-primary-700 min-w-[60px]'>
                    Tỷ số:
                  </span>
                  <input
          ...
          >
            ...
            {isClubOwner && match.player1_id && match.player2_id && (
              <div className='mt-2 p-3 bg-info-50 border border-purple-200 rounded-lg'>
                <div className='flex items-center gap-3'>
                  <span className='text-body-small-medium text-info-700 min-w-[60px]'>
                    Tỷ số:
                  </span>
                  <input
        ...
        {isClubOwner && match.player1_id && match.player2_id && (
          <div className='mt-4 space-y-3'>
            ...
            {match.score_edit_count && match.score_edit_count > 0 && (
              <div className='text-caption text-muted-foreground flex items-center gap-1 justify-center'>
