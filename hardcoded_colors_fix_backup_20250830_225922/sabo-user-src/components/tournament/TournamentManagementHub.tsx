  ...
  */
  ...
  if (currentView === 'bracket-manager') {
    ...
    return (
      <div className="space-y-6">
        ...
        <Tabs defaultValue="single" className="form-spacing">
          ...
          <TabsContent value="single" className="form-spacing">
          ...
          <TabsContent value="double" className="form-spacing">
      ...
      <div className="space-y-6">
        ...
        <div className="form-spacing">
            ...
            <Tabs value={detailActiveTab === 'overview' || detailActiveTab === 'generate' || detailActiveTab === 'automation' ? 'bracket' : detailActiveTab} 
              ...
              <TabsContent value="bracket" className="form-spacing">
              ...
              <TabsContent value="results" className="form-spacing">
                <div className="form-spacing">
              ...
              {clubId && (
                <TabsContent value="tables" className="form-spacing">
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeFilter} onValueChange={setActiveFilter} className="form-spacing">
        ...
        <TabsContent value={activeFilter} className="form-spacing">
          ...
          <div className="space-y-4 max-h-[400px] overflow-y-auto">
            {tournamentParticipants.length === 0 ? (
              ...
              tournamentParticipants.map((participant) => (
                <Card key={participant.id} className="content-spacing">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                       <UserAvatar 
