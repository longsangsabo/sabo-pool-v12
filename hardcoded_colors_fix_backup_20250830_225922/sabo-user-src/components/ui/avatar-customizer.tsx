              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  ...
                  >
                    ...
                    <SelectContent>
                      {/* Basic Effects Group */}
                      <div className='px-2 py-1.5 text-caption-medium text-muted-foreground'>
                        🎯 Hiệu ứng cơ bản
                      </div>
                      {variantOptions
                      ...
                      <div className='px-2 py-1.5 text-caption-medium text-muted-foreground border-t mt-2 pt-2'>
                        💎 Hiệu ứng cao cấp
                      </div>
                      {variantOptions
            ...
            <CardContent className='space-y-4'>
              ...
              {avatar.error && (
                <div className='p-3 bg-destructive/10 border border-destructive/20 rounded-md'>
                  <p className='text-body-small text-destructive'>{avatar.error}</p>
                </div>
              )}
            </CardContent>
          </Card>
