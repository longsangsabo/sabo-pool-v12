                                ...
                                <div className='flex items-center justify-between gap-1'>
                                  ...
                                  >
                                    ...
                                    <div className='flex-1 min-w-0'>
                                      ...
                                      <Badge
                                        variant='outline'
                                        className='text-xs px-1 py-0 bg-primary-50 text-primary-700'
                                      >
                                  ...
                                  >
                                    <Avatar className='h-5 w-5 border border-white shadow-sm flex-shrink-0'>
                                      ...
                                      <AvatarFallback className='text-xs font-semibold bg-error-100 text-error-700'>
                                        {match.player2_name
                                          ?.charAt(0)
                                          ?.toUpperCase() || 'T'}
                                      </AvatarFallback>
                                  ...
                                  >
                                    <div className='flex items-center gap-2 flex-1 min-w-0'>
                                      ...
                                      <div className='flex-1 min-w-0 mr-2'>
                                        <div className='text-xs font-semibold truncate text-neutral-800'>
                                          {match.player1_name || 'TBD'}
                                        </div>
                                      </div>
                                      ...
                                      <Badge
                                        variant='outline'
                                        className='text-xs px-1.5 py-0.5 bg-primary-50 text-primary-700 border-primary-200 flex-shrink-0'
                                      >
                                        {match.player1_rank || 'K'}
                                      </Badge>
                                    </div>
