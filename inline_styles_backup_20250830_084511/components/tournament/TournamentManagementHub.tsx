  ...
  */
      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h3 className="text-lg font-semibold text-foreground mb-2">{tournament.name}</h3>
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Tạo bảng đấu cho {selectedTournament.name}</h2>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">ELO: {player.elo || 1000}</p>
                          </div>
                        </div>
                        {selectedPlayers.some(p => p.id === player.id) && (
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Quản lý Bảng đấu</h2>
        ...
        <Tabs defaultValue="single" className="space-y-4">
          ...
          <TabsContent value="single" className="space-y-4">
            <Card className="border-primary-200 bg-primary-50/50 dark:bg-blue-950/20 dark:border-blue-800">
              ...
              <CardContent>
                <div className="space-y-3 text-sm text-primary-600 dark:text-blue-400">
                        ...
                        <CardContent className="p-4">
                          ...
                          {tournament.current_participants > 0 && ![4, 8, 16, 32].includes(tournament.current_participants) && (
                            <div className="mt-3 p-3 bg-warning-50 dark:bg-orange-950 border border-orange-200 dark:border-orange-800 rounded-lg">
                              <p className="text-sm text-warning-700 dark:text-orange-300">
          ...
          <TabsContent value="double" className="space-y-4">
            <Card className="border-purple-200 bg-info-50/50 dark:bg-purple-950/20 dark:border-purple-800">
              ...
              <CardContent>
                <div className="space-y-3 text-sm text-info-600 dark:text-purple-400">
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold text-foreground">Quản lý giải đấu: {selectedTournament.name}</h2>
            <p className="text-muted-foreground">{selectedTournament.description}</p>
          </div>
        </div>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-foreground">Tournament Management Hub</h2>
          ...
          {filteredTournaments.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-lg font-semibold mb-2">Chưa có giải đấu nào</h3>
        ...
        <DialogContent className="sm:max-w-2xl max-h-[600px]">
          <DialogHeader>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div className="text-center">
                <div className="font-semibold text-success-600">Đã xác nhận</div>
