    ...
    <Card className="border-l-4 border-l-purple-500 shadow-lg">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
          <div className="text-body-small-medium text-neutral-600 dark:text-gray-400 mb-3">
            Thông tin trận đấu
          </div>
          ...
          <div className="grid grid-cols-3 items-center gap-4 mb-4">
            ...
            <div className="text-center">
              ...
              <div className="text-caption-neutral">Race to {challenge.race_to || 'N/A'}</div>
            </div>
          ...
          {challenge.scheduled_time && (
            <div className="text-caption-neutral text-center">
        ...
        <div className="bg-success-50 dark:bg-green-900/20 border border-success-200 dark:border-green-700 rounded-lg p-4">
          ...
          {spaDisplay.hasTransfer ? (
            ...
            <div className="text-center text-body-small-neutral dark:text-gray-400">
