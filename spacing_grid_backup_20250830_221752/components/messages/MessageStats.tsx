          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-heading-bold text-primary-600">{stats.total_messages}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-heading-bold text-error-600">{stats.unread_count}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-heading-bold text-success-600">{stats.sent_count}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-heading-bold text-warning-600">{stats.archived_count}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-body-small-medium">Đã đọc</span>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-body-small-medium">Chưa đọc</span>
                <div className="flex items-center gap-2">
                  <span className="text-body-small text-muted-foreground">
                    {stats.unread_count}
                  </span>
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-body-small-medium">Đã lưu trữ</span>
                <div className="flex items-center gap-2">
                  <span className="text-body-small text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  <span className="text-body-small-medium">Tỷ lệ tin nhắn hệ thống</span>
                  <Badge variant="outline">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-body-small text-muted-foreground">Tỷ lệ đọc tin nhắn</p>
            </div>
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-body-small text-muted-foreground">Tin nhắn đã gửi</p>
            </div>
            ...
            <div className="text-center space-y-2">
              ...
              <p className="text-body-small text-muted-foreground">Tỷ lệ lưu trữ</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <div className="space-y-3">
            ...
            {stats.archived_count === 0 && stats.total_messages > 20 && (
              <div className="flex items-center gap-3 p-3 bg-primary-50 border border-primary-200 rounded-lg">
                ...
                <div>
                  <p className="text-body-small-medium">Chưa có tin nhắn nào được lưu trữ</p>
                  <p className="text-caption text-muted-foreground">
            ...
            {stats.total_messages === 0 && (
              <div className="flex items-center gap-3 p-3 bg-success-50 border border-success-200 rounded-lg">
                ...
                <div>
                  <p className="text-body-small-medium">Hộp thư trống</p>
                  <p className="text-caption text-muted-foreground">
