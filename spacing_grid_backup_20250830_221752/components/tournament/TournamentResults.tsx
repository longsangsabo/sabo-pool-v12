    ...
    <Card>
      ...
      <CardContent className='p-0'>
            ...
            >
              ...
              <div className='flex items-center gap-6 text-sm'>
                <div className='text-center min-w-[50px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>Thắng</p>
                </div>
                ...
                <div className='text-center min-w-[50px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>Thua</p>
                </div>
                ...
                <div className='text-center min-w-[60px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>Tỷ lệ thắng</p>
                </div>
                ...
                <div className='text-center min-w-[60px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>SPA Points</p>
                </div>
                ...
                <div className='text-center min-w-[50px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>ELO</p>
                </div>
                ...
                <div className='text-center min-w-[80px]'>
                  ...
                  <p className='text-caption text-muted-foreground'>Tiền thưởng</p>
                </div>
        ...
        {maxResults && enhancedResults.length > maxResults && (
          <div className='text-center text-body-small text-muted-foreground p-4 border-t'>
