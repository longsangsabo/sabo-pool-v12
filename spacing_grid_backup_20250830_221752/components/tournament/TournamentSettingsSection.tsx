    ...
    <div className='space-y-3'>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption-medium'>Số người tham gia</Label>
        </div>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption-medium'>Giới hạn hạng tham gia</Label>
        </div>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption-medium'>Hình thức thi đấu</Label>
        </div>
        ...
        <div className='grid grid-cols-2 gap-2'>
          {Object.entries(TOURNAMENT_FORMATS).map(([key, label]) => (
            ...
            >
              <div className='text-body-small-medium'>{label}</div>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption-medium'>Môn thi đấu</Label>
        </div>
      ...
      {watchedData.tournament_type === 'single_elimination' && (
        <div className='space-y-3'>
          <div className='flex items-center gap-2'>
            ...
            <Label className='text-body-small-medium'>Cài đặt nâng cao</Label>
          </div>
          ...
          {watchedData.has_third_place_match && (
            <div className='flex items-center gap-2 text-body-small text-muted-foreground ml-6'>
