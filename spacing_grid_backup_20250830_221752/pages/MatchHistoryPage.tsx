          ...
          <Card>
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  <p className='text-heading-bold text-neutral-900'>
                    {stats.wins}
                  </p>
                  <p className='text-body-small-neutral'>Thắng</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-body-small-neutral'>Thua</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-body-small-neutral'>Tỷ lệ thắng</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-body-small-neutral'>Tổng trận</p>
                </div>
              </div>
            </CardContent>
          </Card>
