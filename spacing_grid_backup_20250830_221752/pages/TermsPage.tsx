  ...
  return (
    <div className='min-h-screen bg-neutral-50 p-4'>
      <Card className='max-w-4xl mx-auto'>
        <CardHeader>
          <CardTitle className='text-heading-bold text-center'>
            Điều khoản sử dụng
          </CardTitle>
        ...
        <CardContent className='space-y-6'>
          <section>
            <h2 className='text-title-semibold mb-3'>
          ...
          <section>
            <h2 className='text-title-semibold mb-3'>2. Mô tả dịch vụ</h2>
          ...
          <section>
            <h2 className='text-title-semibold mb-3'>4. Quy tắc sử dụng</h2>
            <div className='space-y-2 text-muted-foreground'>
              <p>Bạn không được:</p>
              <ul className='list-disc list-inside space-y-1 ml-4'>
          ...
          <section>
            <h2 className='text-title-semibold mb-3'>8. Chấm dứt dịch vụ</h2>
            <div className='space-y-2 text-muted-foreground'>
          ...
          <section>
            <h2 className='text-title-semibold mb-3'>9. Liên hệ</h2>
            <div className='space-y-2 text-muted-foreground'>
