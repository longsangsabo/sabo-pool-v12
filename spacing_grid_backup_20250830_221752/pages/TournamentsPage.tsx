      ...
      {isMobile ? (
        <div className='flex gap-2 mb-1'>
          <Button
            ...
            className='flex items-center gap-2 flex-1 text-body-small h-7'
            size='sm'
          >
            ...
            <div className='flex gap-1.5'>
              ...
              <div className='w-16'>
                <Select value={statusFilter} onValueChange={setStatusFilter}>
                  <SelectTrigger className='h-7 text-caption px-2'>
          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small text-muted-foreground'>Tổng giải đấu</p>
                  <p className='text-heading-bold'>{tournaments.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small text-muted-foreground'>Đang thi đấu</p>
                  <p className='text-heading-bold'>
          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small text-muted-foreground'>Đã kết thúc</p>
                  <p className='text-heading-bold'>
