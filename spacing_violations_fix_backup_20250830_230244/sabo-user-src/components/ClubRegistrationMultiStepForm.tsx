    ...
    <Card>
      <CardHeader>
        ...
        <div className='space-y-2'>
          ...
          <div className='flex justify-between text-body-small text-neutral-500'>
            <span
      ...
      <CardContent className='space-y-6'>
        ...
        {currentStep === 1 && (
          <div className='space-y-4'>
            <Typography variant="heading" size="lg">Bước 1: Thông tin cơ bản</Typography>
        ...
        {currentStep === 2 && (
          <div className='space-y-4'>
            <h3 className='text-body-large-semibold'>
              Bước 2: Chi tiết & Hình ảnh
            </h3>

            <div>
              <Typography variant="heading" size="md">Bảng giá chi tiết</Typography>
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div>
                  <label className='block text-body-small-medium text-neutral-700 mb-2'>
                    Giờ thường (VNĐ/h)
            ...
            <div>
              <Typography variant="heading" size="md">Tiện ích</Typography>
            ...
            <div>
              ...
              <div className='space-y-4'>
                <div
                  className='border-2 border-dashed border-neutral-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors cursor-pointer'
                  onClick={() =>
        ...
        {currentStep === 3 && (
          <div className='space-y-4'>
            ...
            <div>
              ...
              <div
                className='border-2 border-dashed border-neutral-300 rounded-lg p-4 text-center hover:border-blue-400 transition-colors cursor-pointer'
                onClick={() =>
            ...
            <div className='flex justify-between items-start'>
              <div className='flex-1'>
                ...
                {existingRegistration.rejection_reason && (
                  <div className='mt-2 p-2 bg-error-100 rounded'>
