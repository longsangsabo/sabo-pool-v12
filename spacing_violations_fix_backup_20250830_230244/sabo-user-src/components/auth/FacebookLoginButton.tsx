...
export const FacebookLoginButton = () => {
  ...
  return (
    <Button
      type='button'
      variant='outline'
      className='w-full hover:bg-primary-50 border-neutral-300 transition-all duration-200 group'
    ...
    >
      {loading ? (
        ...
        <Facebook className='w-5 h-5 mr-2 text-[var(--color-primary-600)] group-hover:scale-110 transition-transform' />
      )}
