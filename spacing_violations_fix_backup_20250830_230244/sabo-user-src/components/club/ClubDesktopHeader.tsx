      ...
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-4'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <Typography variant="heading" size="2xl">{t('club.management')}</Typography>
        ...
        <div className='flex items-center gap-4'>
          ...
          <div className='relative'>
            ...
            <input
              ...
              className='pl-12 pr-4 py-2 w-80 rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20'
            />
          </div>
