        ...
        <CardContent>
          {!clubs || clubs.length === 0 ? (
            <div className='text-center p-8 text-muted-foreground'>
              ...
              <Typography variant="body" size="md">Bạn chưa có câu lạc bộ nào</Typography>
            ...
            <Tabs defaultValue='info' className='w-full'>
                ...
                {isEditing ? (
                  ...
                  <div className='space-y-4'>
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                      <div className='space-y-4'>
                        <div>
                          <Label className='text-body-small-medium text-muted-foreground'>
                            Địa chỉ
                          </Label>
              ...
              <TabsContent value='stats' className='space-y-6'>
                {clubStats && clubStats.length > 0 ? (
                  ...
                  <div className='text-center p-8 text-muted-foreground'>
                    ...
                    <Typography variant="body" size="md">Chưa có dữ liệu thống kê</Typography>
                  </div>
                )}
              </TabsContent>
              ...
              <TabsContent value='members' className='space-y-6'>
                <div className='text-center p-8 text-muted-foreground'>
                  ...
                  <Typography variant="body" size="md">Quản lý thành viên sẽ có trong phiên bản tiếp theo</Typography>
                </div>
              </TabsContent>
            </Tabs>
          </CardContent>
