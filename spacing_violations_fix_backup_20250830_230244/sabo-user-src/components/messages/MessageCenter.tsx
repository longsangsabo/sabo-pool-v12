  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        {/* Inbox Tab */}
        <TabsContent value="inbox" className="form-spacing">
          <Card>
            <CardHeader>
        ...
        {/* Sent Tab */}
        <TabsContent value="sent" className="form-spacing">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* Search Tab */}
        <TabsContent value="search" className="form-spacing">
          <MessageSearch />
        </TabsContent>

        {/* Archive Tab */}
        <TabsContent value="archive" className="form-spacing">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* Trash Tab */}
        <TabsContent value="trash" className="form-spacing">
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
        ...
        {/* Stats Tab */}
        <TabsContent value="stats" className="form-spacing">
