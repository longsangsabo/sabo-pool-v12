        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            <div className='text-center'>
              ...
              <div className='text-body-small-neutral'>Điểm bảo mật</div>
            </div>
            <div className='text-center'>
              <Badge className={securityLevel.color}>
                {securityLevel.level}
              </Badge>
              <div className='text-body-small-neutral mt-1'>Mức độ bảo mật</div>
            </div>
            <div className='text-center'>
          ...
          {settings.twoFactorEnabled && (
            <div className='p-4 bg-primary-50 rounded-lg'>
              <div className='flex items-center gap-2 mb-2'>
                ...
                <span className='text-body-small-medium text-primary-800'>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-3'>
            <div>
              <label className='block text-body-small-medium text-neutral-700 mb-1'>
                Mật khẩu hiện tại
              </label>
