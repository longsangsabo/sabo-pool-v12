...
import { SABO32BracketViewer } from '@/components/tournament/SABO32BracketViewer';
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Badge variant="outline" className="text-body-large px-3 py-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-heading-bold text-primary-600">{tournamentStats.pendingMatches}</div>
            <div className="text-body-small text-muted-foreground">Pending Matches</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small text-muted-foreground">Avg Duration</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small text-muted-foreground">Est. Remaining</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small text-muted-foreground">Live Matches</div>
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  {tournamentStats.pendingMatches > 0 && (
                    <div className="text-body-small">
                      <div className="font-medium text-warning-600">Ready to Play</div>
                      <div className="text-muted-foreground">
                  ...
                  {progressPercentage === 100 && (
                    <div className="text-body-small">
                      <div className="font-medium text-success-600">🎉 Tournament Complete!</div>
                      <div className="text-muted-foreground">
        ...
        <TabsContent value="matches" className="form-spacing">
        ...
        <TabsContent value="management" className="form-spacing">
