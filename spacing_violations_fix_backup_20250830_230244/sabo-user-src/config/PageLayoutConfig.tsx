...
export const PAGE_TYPOGRAPHY = {
  ...
  // Section titles
  sectionTitle: {
    mobile: 'text-body-large md:text-title-semibold text-neutral-900 mb-4',
    desktop: 'text-title md:text-heading-semibold text-neutral-900 mb-6'
  },
  
  // Card titles
  cardTitle: {
    mobile: 'text-body md:text-body-large-semibold text-neutral-900',
    desktop: 'text-body-large md:text-title-semibold text-neutral-900'
  },
  
  // Card descriptions
  cardDescription: {
    mobile: 'text-body-small-neutral',
