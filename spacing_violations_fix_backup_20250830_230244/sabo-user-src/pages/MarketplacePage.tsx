    ...
    <div className='container mx-auto px-4 py-6'>
      ...
      <div className='mb-6 space-y-4'>
        <div className='relative'>
          ...
          <Input placeholder='Tìm kiếm thiết bị bida...' className='pl-12' />
        </div>
        ...
        {marketplaceItems.map(item => (
          ...
          >
            ...
            <CardContent className='p-4'>
              <h3 className='text-body-large-semibold text-neutral-900 mb-2 line-clamp-2'>
                {item.title}
              </h3>

              <div className='flex items-center justify-between mb-2'>
                <p className='text-title font-bold text-primary-600'>
                  {formatPrice(item.price)}
                </p>
                {item.originalPrice && item.originalPrice > item.price && (
                  <p className='text-body-small text-neutral-500 line-through'>
                    {formatPrice(item.originalPrice)}
                  </p>
                )}
              </div>

              <div className='flex items-center justify-between text-body-small text-neutral-500 mb-3'>
