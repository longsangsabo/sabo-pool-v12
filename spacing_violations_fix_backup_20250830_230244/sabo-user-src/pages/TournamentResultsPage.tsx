        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            <div className='flex items-center gap-2'>
              ...
              <div>
                <p className='text-body-small text-muted-foreground'>Ngày tổ chức</p>
          ...
          {tournament.description && (
            <div className='mt-4'>
              <p className='text-body-small text-muted-foreground mb-1'>Mô tả</p>
        ...
        <Card>
          ...
          <CardContent>
            <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
              <div className='text-center'>
                <p className='text-heading-bold text-primary-600'>
                  {results.reduce((sum, r) => sum + r.total_matches, 0)}
                </p>
                <p className='text-body-small text-muted-foreground'>Tổng số trận</p>
              </div>

              <div className='text-center'>
                <p className='text-heading-bold text-info-600'>
                  {results.reduce((sum, r) => sum + r.spa_points_earned, 0)}
                </p>
                <p className='text-body-small text-muted-foreground'>Tổng SPA Points</p>
              </div>

              <div className='text-center'>
                <p className='text-heading-bold text-warning-600'>
                  {results.reduce((sum, r) => sum + r.elo_points_awarded, 0)}
                </p>
                <p className='text-body-small text-muted-foreground'>Tổng ELO Points</p>
              </div>

              <div className='text-center'>
                <p className='text-heading-bold text-success-600'>
