          ...
          <div className='flex items-start justify-between mb-4'>
            <div className='flex items-center gap-3'>
              ...
              <div className='flex-1'>
                ...
                <Badge className={`text-caption border-0 ${
                  milestone.category === 'progress' 
                    ? (theme === 'dark' ? 'bg-blue-900/30 text-blue-300' : 'bg-primary-100 text-primary-700')
            ...
            <div className={`text-right ${
              ...
              <div className='flex items-center gap-1 text-body-large font-bold'>
                <Gift className='w-4 h-4' />
                {isCompleted ? '+' : ''}{milestone.spa_reward}
              </div>
              <div className='text-caption opacity-80'>SPA</div>
            </div>
          </div>
  ...
  return (
    <div className={`min-h-screen p-4 ${
      ...
      <div className='mb-6'>
        ...
        <h1 className={`text-heading-bold mb-2 ${
          theme === 'dark' ? 'text-slate-100' : 'text-slate-800'
        }`}>
          Milestone & Thành tựu
        </h1>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-3 mb-6'>
          <Card className={theme === 'dark' ? 'bg-slate-900/40 border-slate-700/50' : 'bg-white border-slate-200'}>
            <CardContent className='p-3 text-center'>
              ...
              <div className={`text-caption ${theme === 'dark' ? 'text-slate-400' : 'text-slate-500'}`}>
                Tổng số
              </div>
            </CardContent>
          </Card>
      ...
      {currentMilestones.length === 0 && (
        <div className={`text-center py-12 ${
          ...
          <p className='text-body-large font-medium mb-2'>Đang tải milestone...</p>
