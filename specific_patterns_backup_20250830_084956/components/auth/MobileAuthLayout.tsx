        ...
        {isLoading && (
          <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-sm text-neutral-600">Đang xử lý...</span>
            </div>
          </div>
        )}
      </div>
...
export const MobileAuthButton: React.FC<MobileAuthButtonProps> = ({
  ...
  const baseStyles = "w-full py-3 px-4 text-base font-medium rounded-lg transition-all duration-200 touch-manipulation";
