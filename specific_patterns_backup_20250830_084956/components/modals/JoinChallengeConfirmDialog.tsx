            ...
            <div className="space-y-4 text-left">
              ...
              <div className="space-y-3 p-3 bg-muted/30 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium">Đối thủ:</span>
                  <span className="text-sm">{challenge.challenger_name || 'Ẩn danh'}</span>
                </div>
                ...
                {challenge.bet_points && challenge.bet_points > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium">SPA cược:</span>
                ...
                {challenge.scheduled_time && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs">{formatTime(challenge.scheduled_time)}</span>
                  </div>
                )}
              ...
              {challenge.bet_points && challenge.bet_points > 0 && (
                <div className="p-2 bg-warning-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded">
                  <p className="text-xs text-warning-800 dark:text-yellow-200">
