        ...
        <TabsContent value="groupA" className="space-y-4">
          <Card className="border-success-200 dark:border-green-700">
            <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20">
              <CardTitle className="text-lg text-success-800 dark:text-green-200">Group A - Double Elimination</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
        ...
        <TabsContent value="groupB" className="space-y-4">
          <Card className="border-primary-200 dark:border-blue-700">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20">
              <CardTitle className="text-lg text-primary-800 dark:text-blue-200">Group B - Double Elimination</CardTitle>
            </CardHeader>
            <CardContent className="p-6">
