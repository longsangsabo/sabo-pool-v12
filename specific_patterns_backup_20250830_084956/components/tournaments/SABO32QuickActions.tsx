      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="p-2 bg-success-50 dark:bg-green-900/20 rounded-lg">
            <div className="text-lg font-bold text-success-600">{completedMatches}</div>
            <div className="text-xs text-muted-foreground">Completed</div>
          </div>
          <div className="p-2 bg-warning-50 dark:bg-orange-900/20 rounded-lg">
            <div className="text-lg font-bold text-warning-600">{pendingMatches}</div>
            <div className="text-xs text-muted-foreground">Pending</div>
          </div>
          <div className="p-2 bg-primary-50 dark:bg-blue-900/20 rounded-lg">
            <div className="text-lg font-bold text-primary-600">{Math.round(progressPercentage)}%</div>
