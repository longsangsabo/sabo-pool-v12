                ...
                {userStats ? (
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                    <div className='text-center p-4 bg-primary-50 rounded-lg'>
                      ...
                      <div className='text-sm text-neutral-600'>Điểm ELO</div>
                    </div>
                    <div className='text-center p-4 bg-success-50 rounded-lg'>
                      <div className='text-2xl font-bold text-success-600'>
                        {userStats.tournaments_played}
                      </div>
                      <div className='text-sm text-neutral-600'>Giải đấu</div>
                    </div>
                    <div className='text-center p-4 bg-info-50 rounded-lg'>
                      <div className='text-2xl font-bold text-info-600'>
                        {userStats.user?.current_rank || 'N/A'}
                      </div>
                      <div className='text-sm text-neutral-600'>Hạng hiện tại</div>
                    </div>
            ...
            <CardContent>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  ...
                  <div className='text-sm text-neutral-600'>Người tham gia</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-2xl font-bold'>
                    {seasonInfo?.total_matches || 0}
                  </div>
                  <div className='text-sm text-neutral-600'>Trận đấu</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-2xl font-bold'>{prizes.length}</div>
                  <div className='text-sm text-neutral-600'>Hạng giải thưởng</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-2xl font-bold'>
                    {prizes
                  ...
                  <div className='text-sm text-neutral-600'>Tổng giải thưởng</div>
                </div>
              </div>
            </CardContent>
          </Card>
