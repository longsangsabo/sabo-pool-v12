                  ...
                  <form onSubmit={handleSubmit} className='space-y-6'>
                    <div className='space-y-2'>
                      ...
                      <Input
                        ...
                        className='bg-success-700 border-green-600 text-white text-lg min-h-[44px]'
                        required
                      />
                    </div>
                    ...
                    <div className='space-y-2'>
                      ...
                      <Textarea
                        ...
                        className='bg-success-700 border-green-600 text-white text-lg min-h-[120px] resize-none'
                        required
                      />
                    </div>
                    ...
                    <Button
                      type='submit'
                      className='w-full bg-yellow-400 text-green-900 hover:bg-warning-500 font-bold py-4 text-xl min-h-[50px]'
                      disabled={loading}
                    >
                      {loading ? (
                        <>
