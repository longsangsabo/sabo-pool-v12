...
const DocCleanupDashboard = () => {
  ...
  const API_BASE =
    import.meta.env.VITE_CLEANUP_API || 'http://localhost:3001/api';
    ...
    <div className='p-6 space-y-6'>
      ...
      <div className='flex justify-between items-center'>
        ...
        <div className='flex gap-2'>
          ...
          <Button onClick={() => triggerCleanup(false)} disabled={triggering}>
            {triggering ? (
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-4'>
        ...
        <Card>
          ...
          <CardContent>
            <div className='text-2xl font-bold'>
              {metrics?.summary?.cleanupEfficiency || 0}%
            </div>
            <Progress
              value={metrics?.summary?.cleanupEfficiency || 0}
              className='mt-2'
            />
          </CardContent>
        </Card>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Document count over the last 30 days
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className='grid gap-4 md:grid-cols-2'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current status of cleanup components
            </CardDescription>
          </CardHeader>
          <CardContent className='space-y-4'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <Badge
                variant={health?.configuration ? 'default' : 'destructive'}
              >
          ...
          <CardContent>
            <div className='space-y-3'>
              {metrics?.recentActivity?.map((activity, index) => (
                <div
                  key={index}
                  className='flex flex-col space-y-1 pb-3 border-b last:border-0'
                >
