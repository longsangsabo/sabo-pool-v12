      ...
      <CardContent className="space-y-5">
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
          ...
          <div className="grid grid-cols-3 items-center gap-4 mb-4">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-gray-500">Race to {challenge.race_to || 'N/A'}</div>
            </div>
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg p-4">
          ...
          {spaDisplay.hasTransfer ? (
            <div className="space-y-2">
              <div className="flex items-center justify-between p-2 bg-green-100 dark:bg-green-800/30 rounded">
              ...
              <div className="flex items-center justify-between p-2 bg-red-100 dark:bg-red-800/30 rounded">
                <div className="flex items-center gap-2">
        ...
        <div className="space-y-3">
          {!showApprovalForm ? (
            ...
            <div className="space-y-4 p-4 border-2 border-purple-200 dark:border-purple-700 bg-purple-50/50 dark:bg-purple-900/20 rounded-lg">
              <div className="flex items-center gap-2">
              ...
              {approvalAction === 'reject' && (
                <div className="p-3 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded text-sm text-red-800 dark:text-red-200">
