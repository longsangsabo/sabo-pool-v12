  ...
  const getStatusConfig = (status: string, variant: string) => {
    const configs = {
      ...
      accepted: {
        label: 'Đã chấp nhận',
        icon: CheckCircle,
        className: 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 border-blue-200 dark:border-blue-700/50',
        pulse: false
      },
      ongoing: {
        label: 'Đang diễn ra',
        icon: Play,
        className: 'bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 border-red-200 dark:border-red-700/50',
        pulse: true
      },
      live: {
        label: 'LIVE',
      ...
      cancelled: {
        label: 'Đã hủy',
        icon: Pause,
        className: 'bg-gray-100 dark:bg-gray-800/50 text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700/50',
        pulse: false
      },
      expired: {
        label: 'Hết hạn',
