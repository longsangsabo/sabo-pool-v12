  ...
  const UserGuide = () => (
    <div className='space-y-6'>
      ...
      <Card className='bg-blue-50 border-blue-200'>
        <CardHeader>
          <CardTitle className='text-blue-800'>Top Legacy Players</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <div className='grid md:grid-cols-2 gap-6'>
        ...
        <Card>
          ...
          <CardContent className='space-y-2'>
            ...
            <div className='text-xs text-gray-600'>Check total legacy players (should be 45)</div>
            
            <div className='text-xs bg-gray-100 p-2 rounded mt-2'>
              <code>SELECT * FROM legacy_spa_points WHERE claimed = false;</code>
            </div>
            <div className='text-xs text-gray-600'>See unclaimed legacy players</div>
          </CardContent>
        </Card>
      </div>
