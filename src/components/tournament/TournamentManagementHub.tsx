      ...
      <CardContent className="p-4">
        ...
        <div className="space-y-2">
          <div className={`p-2 rounded-lg border-l-4 ${
            match.player1 ? 'bg-blue-50 border-blue-400' : 'bg-muted border-muted-foreground'
          }`}>
          ...
          <div className={`p-2 rounded-lg border-l-4 ${
            match.player2 ? 'bg-purple-50 border-purple-400' : 'bg-muted border-muted-foreground'
          }`}>
            <div className="text-sm font-medium">
                ...
                {loading ? (
                  ...
                  <div className="grid gap-4">
                    {singleEliminationTournaments.map((tournament) => (
                      <Card key={tournament.id} className="hover:shadow-md transition-shadow border-blue-200">
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
