...
export function TournamentBracketGenerator({
  ...
  const getStatusColor = () => {
    if (participantCount === 0) return 'bg-gray-500';
    if (participantCount < 4) return 'bg-yellow-500';
    if (!isValidCount) return 'bg-red-500';
    return 'bg-green-500';
  };
        ...
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            <CardTitle className="flex items-center gap-3 text-xl">
              <div className={`p-2 rounded-lg ${isDoubleElimination ? 'bg-purple-100 text-purple-600' : 'bg-blue-100 text-blue-600'}`}>
                {getTournamentIcon()}
              </div>
              {description.title}
            </CardTitle>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            >
              ...
              <span className="text-xs text-muted-foreground">Shuffle players randomly</span>
            </Button>
            ...
            >
              ...
              <span className="text-xs text-muted-foreground">Rank by skill level</span>
            </Button>
          </div>
        </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground">Shuffle selected players</span>
                </Button>
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground">Order by ELO rating</span>
                </Button>
              </div>
              ...
              {generatedBracket.length > 0 && (
                <div className='space-y-4'>
                  <div className="flex items-center justify-between">
                    <h5 className="font-medium text-sm">Generated Bracket Preview</h5>
