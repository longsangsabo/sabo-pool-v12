...
export const SaboAvatar: React.FC<SaboAvatarProps> = ({
  ...
  const renderOctagonFrame = () => (
    ...
    >
      <defs key={`octagon-defs-${avatar.variant}-${renderKey}`}>
        ...
        <linearGradient id={`octagon-rainbowGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`octagon-rainbowGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id={`octagon-platinumGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`octagon-platinumGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id={`octagon-diamondGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`octagon-diamondGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#f0f0f0">
            <animate attributeName="stop-color" 
        ...
        <linearGradient id={`octagon-chromeGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="0%">
        ...
        <linearGradient id={`octagon-chromeGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="0%">
        ...
        <radialGradient id={`octagon-frostGradient1-${renderKey}`} cx="50%" cy="50%">
        ...
        <radialGradient id={`octagon-frostGradient2-${renderKey}`} cx="30%" cy="30%">
          <stop offset="0%" stopColor="#ffffff" />
          <stop offset="100%" stopColor="#c8d5e6" />
        </radialGradient>

        {/* White Gold gradient */}
        <linearGradient id={`octagon-whiteGoldGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id={`octagon-whiteGoldGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="100%">
        ...
        <linearGradient id={`octagon-holoGradient1-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#c8c8c8">
            <animate attributeName="stop-color" 
        ...
        <linearGradient id={`octagon-holoGradient2-${renderKey}`} x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#e0e0e0" />
          <stop offset="50%" stopColor="#c8c8c8" />
          <stop offset="100%" stopColor="#f0f0f0" />
        </linearGradient>
      </defs>
      <g mask={(profile?.verified_rank || isVerified) ? `url(#octagon-frame-mask-${renderKey})` : undefined}>
        <polygon 
          points="50,10 350,10 390,50 390,350 350,390 50,390 10,350 10,50" 
          stroke={
            avatar.variant === 'rainbow' ? `url(#octagon-rainbowGradient1-${renderKey})` :
            avatar.variant === 'platinum-elite' ? `url(#octagon-platinumGradient1-${renderKey})` :
            avatar.variant === 'diamond-silver' ? `url(#octagon-diamondGradient1-${renderKey})` :
            avatar.variant === 'chrome-metal' ? `url(#octagon-chromeGradient1-${renderKey})` :
            avatar.variant === 'frost-silver' ? `url(#octagon-frostGradient1-${renderKey})` :
            avatar.variant === 'white-gold' ? `url(#octagon-whiteGoldGradient1-${renderKey})` :
            avatar.variant === 'silver-holographic' ? `url(#octagon-holoGradient1-${renderKey})` :
            frameStroke
          } 
          strokeWidth={
            ['rainbow', 'platinum-elite', 'diamond-silver', 'chrome-metal', 'frost-silver', 'white-gold', 'silver-holographic'].includes(avatar.variant) ? '6' : '4'
          } 
          fill="none"
          className={
            avatar.variant === 'rainbow' ? 'rainbow-frame-border' :
            ['platinum-elite', 'diamond-silver', 'chrome-metal', 'frost-silver', 'white-gold', 'silver-holographic'].includes(avatar.variant) ? 'premium-frame-border' : ''
          }
        />
        <polygon 
          points="0,80 80,0 320,0 400,80 400,320 320,400 80,400 0,320" 
          stroke={
            avatar.variant === 'rainbow' ? `url(#octagon-rainbowGradient2-${renderKey})` :
            avatar.variant === 'platinum-elite' ? `url(#octagon-platinumGradient2-${renderKey})` :
            avatar.variant === 'diamond-silver' ? `url(#octagon-diamondGradient2-${renderKey})` :
            avatar.variant === 'chrome-metal' ? `url(#octagon-chromeGradient2-${renderKey})` :
            avatar.variant === 'frost-silver' ? `url(#octagon-frostGradient2-${renderKey})` :
            avatar.variant === 'white-gold' ? `url(#octagon-whiteGoldGradient2-${renderKey})` :
            avatar.variant === 'silver-holographic' ? `url(#octagon-holoGradient2-${renderKey})` :
            frameStroke
          } 
          strokeWidth={
            ['rainbow', 'platinum-elite', 'diamond-silver', 'chrome-metal', 'frost-silver', 'white-gold', 'silver-holographic'].includes(avatar.variant) ? '4' : '2'
          } 
          fill="none"
          className={
            avatar.variant === 'rainbow' ? 'rainbow-frame-border-outer' :
            ['platinum-elite', 'diamond-silver', 'chrome-metal', 'frost-silver', 'white-gold', 'silver-holographic'].includes(avatar.variant) ? 'premium-frame-border-outer' : ''
          }
        />
      </g>
    </svg>
  ...
  const renderTechEdgeFrame = () => (
    ...
    >
      <defs key={`tech-defs-${avatar.variant}-${renderKey}`}>
        ...
        <linearGradient id={`tech-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path 
        ...
        mask={(profile?.verified_rank || isVerified) ? `url(#tech-frame-mask-${renderKey})` : undefined}
      />
    </svg>
  );
  ...
  const renderPremiumOctagonFrame = () => (
    ...
    >
      <defs key={`premium-defs-${avatar.variant}-${renderKey}`}>
        ...
        <linearGradient id={`premium-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path 
        ...
        mask={(profile?.verified_rank || isVerified) ? `url(#premium-frame-mask-${renderKey})` : undefined}
      />
  ...
  const renderHexagonFrame = () => (
    <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-full h-full'>
      <defs>
        <linearGradient id={`hexagon-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path d="M100 20 L300 20 L380 200 L300 380 L100 380 L20 200 Z" 
  ...
  const renderCrystalFrame = () => (
    <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-full h-full'>
      <defs>
        <linearGradient id={`crystal-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="rgba(255,255,255,0.9)" />
          <stop offset="50%" stopColor="rgba(200,255,255,0.7)" />
          <stop offset="100%" stopColor="rgba(150,200,255,0.5)" />
        </linearGradient>
      </defs>
      <path d="M200 10 L380 120 L320 350 L80 350 L20 120 Z" 
  ...
  const renderBladeFrame = () => (
    <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-full h-full'>
      <defs>
        <linearGradient id={`blade-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path d="M20 80 L80 20 L320 20 L380 80 L360 200 L380 320 L320 380 L80 380 L20 320 L40 200 Z" 
  ...
  const renderNeonCircuitFrame = () => (
    <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-full h-full'>
      <defs>
        <linearGradient id={`neon-gradient-${renderKey}`} x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      <path d="M60 20 L340 20 L380 60 L380 340 L340 380 L60 380 L20 340 L20 60 Z" 
        stroke={`url(#neon-gradient-${renderKey})`} 
        strokeWidth="3" 
        fill="none" 
        className="neon-circuit-frame" />
      {/* Circuit lines */}
      <line x1="20" y1="200" x2="380" y2="200" stroke="#00ffff" strokeWidth="1" opacity="0.7">
        <animate attributeName="opacity" values="0.7;1;0.7" dur="1s" repeatCount="indefinite" />
      </line>
      <line x1="200" y1="20" x2="200" y2="380" stroke="#ff00ff" strokeWidth="1" opacity="0.7">
        <animate attributeName="opacity" values="0.7;1;0.7" dur="1s" repeatCount="indefinite" />
      </line>
    </svg>
  );
  ...
  const renderFrame = () => {
    switch (avatar.frameType) {
      case 'octagon': return renderOctagonFrame();
      case 'tech-edge': return renderTechEdgeFrame();
      case 'premium-octagon': return renderPremiumOctagonFrame();
      case 'hexagon': return renderHexagonFrame();
      case 'crystal': return renderCrystalFrame();
      case 'blade': return renderBladeFrame();
      case 'neon-circuit': return renderNeonCircuitFrame();
      case 'plasma-ring': return renderPlasmaRingFrame();
      default: return renderPremiumOctagonFrame(); // Set premium-octagon as default
    }
  };

  // Tính toán màu shadow dựa trên theme
  const shadowColor = theme === 'light' ? 'rgba(0, 0, 0, 0.1)' : 'rgba(255, 255, 255, 0.1)';
  const frameStroke = theme === 'light' ? '#000' : '#fff';

  // Tạo avatar URL với fallback
  const avatarSrc = profile?.avatar_url || avatar.url || fallbackUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(fallbackName || 'User')}&background=random&size=400`;

  return (
    <div className={cn('sabo-avatar-container relative w-full h-full', className)} style={{ minWidth: '100px', minHeight: '100px' }}>
      ...
      <div 
        ...
        className={cn(
          ...
          avatar.variant === 'silver-holographic' && 'silver-holographic-variant'
        )} 
        style={{
          '--rainbow-intensity': avatar.intensity === 'subtle' ? '0.6' : avatar.intensity === 'intense' ? '1.0' : '0.8',
          '--animation-duration': avatar.speed === 'slow' ? '8s' : avatar.speed === 'fast' ? '2s' : '4s',
          '--rainbow-speed': avatar.speed === 'slow' ? '12s' : avatar.speed === 'fast' ? '4s' : '6s',
      ...
      >
        ...
        <div className="relative w-full h-full overflow-hidden">
          ...
          {avatar.frameType === 'tech-edge' && (
            <>
              <div key={`tech-background-${renderKey}`} className="tech-edge-background" style={{ zIndex: 1 }} />
            </>
          )}
          
          {avatar.frameType === 'hexagon' && (
            <>
              <div key={`hexagon-background-${renderKey}`} className="hexagon-background" style={{ zIndex: 1 }} />
            </>
          )}
          
          {avatar.frameType === 'crystal' && (
            <>
              <div key={`crystal-background-${renderKey}`} className="crystal-background" style={{ zIndex: 1 }} />
            </>
          )}
          
          {avatar.frameType === 'blade' && (
            <>
              <div key={`blade-background-${renderKey}`} className="blade-background" style={{ zIndex: 1 }} />
            </>
          )}
          
          {avatar.frameType === 'neon-circuit' && (
            <>
              <div key={`circuit-background-${renderKey}`} className="circuit-background" style={{ zIndex: 1 }} />
            </>
          )}
          
          {avatar.frameType === 'plasma-ring' && (
            <>
              <div key={`plasma-background-${renderKey}`} className="plasma-background" style={{ zIndex: 1 }} />
            </>
          )}
          ...
          <img
            ...
            style={{
              ...
              width: avatar.frameType === 'premium-octagon' ? 'calc(100% - 6px)' : 'calc(100% - 8px)',
              height: avatar.frameType === 'premium-octagon' ? 'calc(100% - 6px)' : 'calc(100% - 8px)',
              clipPath: (() => {
                switch (avatar.frameType) {
              ...
              transform: avatar.frameType === 'premium-octagon' ? 'scale(1.0)' : avatar.frameType === 'tech-edge' ? 'scale(0.88)' : 'scale(0.92)',
              transformOrigin: 'center',
              zIndex: 5
            }}
            onError={(e) => {
              e.currentTarget.src = fallbackUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(fallbackName || 'User')}&background=random&size=400`;
            }}
          />
          ...
          {avatar.frameType === 'tech-edge' && (
            <>
              <div key={`tech-inner-${renderKey}`} className="tech-edge-inner-accent" style={{ zIndex: 10 }} />
              <div key={`tech-outer-${renderKey}`} className="tech-edge-outer-border" style={{ zIndex: 10 }} />
              <div key={`tech-corners-${renderKey}`} className="tech-edge-corner-accents" style={{ zIndex: 10 }} />
              <div key={`tech-sides-${renderKey}`} className="tech-edge-side-accents" style={{ zIndex: 10 }} />
            </>
          )}
          
          {avatar.frameType === 'hexagon' && (
            <>
              <div key={`hexagon-inner-${renderKey}`} className="hexagon-inner-glow" style={{ zIndex: 10 }} />
            </>
          )}
          
          {avatar.frameType === 'crystal' && (
            <>
              <div key={`crystal-facets-${renderKey}`} className="crystal-facets" style={{ zIndex: 10 }} />
            </>
          )}
          
          {avatar.frameType === 'blade' && (
            <>
              <div key={`blade-edge-${renderKey}`} className="blade-edge" style={{ zIndex: 10 }} />
            </>
          )}
          
          {avatar.frameType === 'neon-circuit' && (
            <>
              <div key={`circuit-lines-${renderKey}`} className="circuit-lines" style={{ zIndex: 10 }} />
            </>
          )}
          
          {avatar.frameType === 'plasma-ring' && (
            <>
              <div key={`plasma-core-${renderKey}`} className="plasma-core" style={{ zIndex: 10 }} />
            </>
          )}
        </div>
        ...
        {/* Verified Stamp */}
        {(profile?.verified_rank || isVerified) && (
          <div className='stamp absolute bottom-[-35px] right-[-10px] w-[32%] h-auto z-30' style={{ filter: `drop-shadow(0 0 6px ${shadowColor})` }}>
            <img 
        ...
        <div className="absolute bottom-0 right-0">
          ...
          <label 
            ...
            className={cn(
              ...
              (isUploading || avatar.isUploading) && 'opacity-50 cursor-not-allowed'
            )}
          >
