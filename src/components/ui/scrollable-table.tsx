...
export const ScrollableTable: React.FC<ScrollableTableProps> = ({
  ...
  return (
    <div className='overflow-x-auto'>
      <div 
        className={cn(
          'bg-gray-800/30 backdrop-blur-sm border border-gray-600 rounded-xl overflow-hidden',
          className
        )}
      >
        <div 
...
export const ScrollableTableWithStickyHeader: React.FC<ScrollableTableWithStickyHeaderProps> = ({
  ...
  return (
    <div className='overflow-x-auto'>
      <div 
        className={cn(
          'bg-gray-800/30 backdrop-blur-sm border border-gray-600 rounded-xl overflow-hidden scrollbar-custom',
          className
        )}
        style={{ maxHeight }}
      >
