...
export const getPageLayouts = (getThemedValue: any) => ({
  dashboard: {
    ...
    background: getThemedValue('bg-gray-50', 'bg-gray-900'),
  ...
  content: {
    ...
    background: getThemedValue('bg-background', 'bg-gray-900'),
    minHeight: 'min-h-screen'
  },
  ...
  marketing: {
    ...
    background: getThemedValue('bg-white', 'bg-gray-900'),
    minHeight: 'min-h-screen'
  }
}) as const;
...
export const CARD_LAYOUTS = {
  ...
  standard: {
    ...
    content: 'p-4 md:p-6',
    footer: 'p-4 md:p-6 border-t border-gray-200 bg-gray-50'
  },
  
  // Compact card for listings
  compact: {
    wrapper: 'bg-white rounded-md border border-gray-200 shadow-sm',
    header: 'p-3 md:p-4 border-b border-gray-200',
    content: 'p-3 md:p-4',
    footer: 'p-3 md:p-4 border-t border-gray-200'
  },
  
  // Feature card for highlights
  feature: {
    wrapper: 'bg-white rounded-xl border border-gray-200 shadow-md hover:shadow-lg transition-shadow',
    header: 'p-6 md:p-8 border-b border-gray-200',
    content: 'p-6 md:p-8',
    footer: 'p-6 md:p-8 border-t border-gray-200 bg-gray-50'
  },
  
  // Tournament specific card
  tournament: {
    wrapper: 'bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all duration-200',
...
export const PAGE_TYPOGRAPHY = {
  // Page title styling
  pageTitle: {
    mobile: 'text-2xl md:text-3xl font-bold text-gray-900 mb-2',
    desktop: 'text-3xl md:text-4xl font-bold text-gray-900 mb-2'
  },
  
  // Page description
  pageDescription: {
    mobile: 'text-sm md:text-base text-gray-600 mb-6',
    desktop: 'text-base md:text-lg text-gray-600 mb-8'
  },
  
  // Section titles
  sectionTitle: {
    mobile: 'text-lg md:text-xl font-semibold text-gray-900 mb-4',
    desktop: 'text-xl md:text-2xl font-semibold text-gray-900 mb-6'
  },
  
  // Card titles
  cardTitle: {
    mobile: 'text-base md:text-lg font-semibold text-gray-900',
    desktop: 'text-lg md:text-xl font-semibold text-gray-900'
  },
  
  // Card descriptions
  cardDescription: {
    mobile: 'text-sm text-gray-600',
    desktop: 'text-sm md:text-base text-gray-600'
  }
} as const;
...
export const BUTTON_SIZES = {
  sm: {
    mobile: 'px-3 py-2 text-sm min-h-[44px]', // Touch-friendly height
    desktop: 'px-3 py-2 text-sm min-h-[36px]'
  },
  
  base: {
    mobile: 'px-4 py-2 text-base min-h-[48px]',
    desktop: 'px-4 py-2 text-base min-h-[40px]'
  },
  
  lg: {
    mobile: 'px-6 py-3 text-lg min-h-[52px]',
    desktop: 'px-6 py-3 text-lg min-h-[44px]'
  }
} as const;
...
export const StandardPageHeader: React.FC<StandardPageHeaderProps> = ({
  ...
  return (
    <div className={cn(
      getThemedValue('border-b border-gray-200 bg-white', 'border-b border-gray-700 bg-gray-800'),
