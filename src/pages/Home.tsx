...
const Home: React.FC = () => {
  ...
  return (
    <main className='min-h-screen flex flex-col bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-800 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800 dark:text-slate-50 transition-colors duration-300'>
        ...
        <div className='h-16 flex items-center justify-between gap-4 max-w-7xl mx-auto'>
          ...
          <Link to='/' className='flex items-center gap-3 group'>
            ...
            <div className='flex flex-col leading-none'>
              <span className='font-black text-lg md:text-xl bg-gradient-to-r from-sky-400 via-indigo-400 to-fuchsia-400 bg-clip-text text-transparent tracking-tight'>
                SABO
              </span>
              <span className='text-[10px] md:text-xs font-semibold tracking-[0.25em] text-slate-400 group-hover:text-slate-200 transition-colors'>
                ARENA
              </span>
            </div>
          </Link>
      ...
      <section className='relative w-full overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 md:px-10 pb-12 md:pb-16 text-center'>
          <h1 className='text-2xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight bg-gradient-to-r from-sky-600 via-indigo-600 to-fuchsia-600 dark:from-sky-300 dark:via-indigo-300 dark:to-fuchsia-300 bg-clip-text text-transparent drop-shadow'>
            ...
            <div className='text-lg md:text-2xl lg:text-3xl font-semibold tracking-wider'>
          ...
          <div
            id='stats'
            className='mt-12 grid grid-cols-2 md:grid-cols-4 gap-4 text-sm md:text-base'
          >
            <div className='p-4 rounded-lg bg-white/70 border border-slate-200/70 backdrop-blur-sm hover:border-sky-400/60 dark:bg-slate-900/50 dark:border-slate-700/60 dark:hover:border-sky-500/50 transition-colors'>
              ...
              <p className='text-[11px] md:text-xs text-slate-500 dark:text-slate-400 uppercase tracking-wide'>
                Thành viên
              </p>
            </div>
            <div className='p-4 rounded-lg bg-white/70 border border-slate-200/70 backdrop-blur-sm hover:border-sky-400/60 dark:bg-slate-900/50 dark:border-slate-700/60 dark:hover:border-sky-500/50 transition-colors'>
          ...
          <div className='mt-10 md:mt-14 max-w-4xl mx-auto'>
            <h3 className='text-sm md:text-base font-semibold text-slate-500 dark:text-slate-300 mb-6 text-center tracking-wide'>
            ...
            <div className='grid grid-cols-5 lg:grid-cols-10 gap-4 justify-items-center'>
              ...
              <a
                href='#'
                className='group flex items-center justify-center w-12 h-12 rounded-xl bg-white border border-slate-200 hover:border-blue-400/60 hover:bg-blue-50 dark:bg-slate-800/50 dark:border-slate-700/60 dark:hover:border-blue-500/50 dark:hover:bg-blue-900/20 transition-all duration-300'
              >
                <svg
              ...
              <a
                href='#'
                className='group flex items-center justify-center w-12 h-12 rounded-xl bg-white border border-slate-200 hover:border-blue-400/60 hover:bg-blue-50 dark:bg-slate-800/50 dark:border-slate-700/60 dark:hover:border-blue-400/50 dark:hover:bg-blue-800/20 transition-all duration-300'
              >
                <svg
              ...
              <a
                href='#'
                className='group flex items-center justify-center w-12 h-12 rounded-xl bg-white border border-slate-200 hover:border-red-400/60 hover:bg-red-50 dark:bg-slate-800/50 dark:border-slate-700/60 dark:hover:border-red-500/50 dark:hover:bg-red-900/20 transition-all duration-300'
              >
                <svg
              ...
              <a
                href='#'
                className='group flex items-center justify-center w-12 h-12 rounded-xl bg-white border border-slate-200 hover:border-green-400/60 hover:bg-green-50 dark:bg-slate-800/50 dark:border-slate-700/60 dark:hover:border-green-500/50 dark:hover:bg-green-900/20 transition-all duration-300'
              >
                <svg
              ...
              <a
                href='#'
                className='group flex items-center justify-center w-12 h-12 rounded-xl bg-white border border-slate-200 hover:border-purple-400/60 hover:bg-purple-50 dark:bg-slate-800/50 dark:border-slate-700/60 dark:hover:border-purple-500/50 dark:hover:bg-purple-900/20 transition-all duration-300'
              >
                <svg
      ...
      >
        <h2 className='text-xl md:text-3xl font-bold mb-8 md:mb-10 tracking-wide bg-gradient-to-r from-sky-600 to-indigo-600 dark:from-sky-400 dark:to-indigo-400 bg-clip-text text-transparent'>
          Tính năng nổi bật
        </h2>
          ...
          {features.map(f => (
            ...
            >
              ...
              <div className='relative flex flex-col gap-2 md:gap-3'>
                <div className='inline-flex items-center justify-center text-2xl md:text-[28px] drop-shadow select-none'>
                  {f.icon}
                </div>
                <h3 className='font-semibold text-slate-700 dark:text-slate-100 tracking-wide text-sm md:text-base leading-snug'>
                  {f.title}
                </h3>
                <p className='text-xs md:text-sm text-slate-500 dark:text-slate-400 leading-relaxed md:leading-relaxed'>
                  {f.desc}
                </p>
              </div>
      ...
      >
        <div className='max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8 justify-between text-center md:text-left'>
          <div className='max-w-xl'>
            <h3 className='text-xl md:text-2xl font-extrabold bg-gradient-to-r from-sky-600 via-indigo-600 to-fuchsia-600 dark:from-sky-400 dark:via-indigo-400 dark:to-fuchsia-400 bg-clip-text text-transparent'>
              Sẵn sàng vào bàn?
            </h3>
