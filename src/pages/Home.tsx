  ...
  return (
    <main className='min-h-screen flex flex-col bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-slate-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800'>
        ...
        <div className='h-16 flex items-center justify-between gap-4 max-w-7xl mx-auto'>
          ...
          <nav className='hidden md:flex items-center gap-6 text-sm font-medium'>
            ...
            <div className='hidden sm:flex gap-2'>
              <Link to='/auth/login'>
                <Button variant='outline' size='sm' className='border-slate-600/70 bg-slate-800/40 hover:bg-slate-700/50 hover:border-slate-400 font-slate'>
                  <LogIn className='w-4 h-4' />
                  <span>Đăng nhập</span>
                </Button>
              </Link>
              <Link to='/auth/register'>
                <Button size='sm' className='relative overflow-hidden bg-gradient-to-r from-indigo-500 via-sky-500 to-fuchsia-500 hover:from-indigo-400 hover:via-sky-400 hover:to-fuchsia-400 shadow-lg shadow-indigo-900/40 font-slate'>
      ...
      <section className='relative w-full overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 md:px-10 pb-20 text-center'>
          <h1 className='text-2xl md:text-4xl lg:text-5xl font-black tracking-tight leading-tight bg-gradient-to-r from-sky-300 via-indigo-300 to-fuchsia-300 bg-clip-text text-transparent drop-shadow'>
            <div className='mb-1'>SABO ARENA</div>
            <div className='text-lg md:text-2xl lg:text-3xl font-semibold tracking-wider'>THE FIRST BILLIARDS PLATFORM IN VIETNAM</div>
          </h1>
          ...
          <div className='mt-8 flex flex-col sm:flex-row gap-4 justify-center'>
            <Link to='/auth/register' className='group'>
              <Button size='lg' className='relative overflow-hidden bg-gradient-to-r from-indigo-500 via-sky-500 to-fuchsia-500 hover:from-indigo-400 hover:via-sky-400 hover:to-fuchsia-400 shadow-xl shadow-indigo-900/40 rounded-xl px-10 font-semibold tracking-wide font-slate'>
            ...
            <Link to='/auth/login'>
              <Button
                variant='outline'
                size='lg'
                className='rounded-xl border-slate-600/70 bg-slate-800/50 backdrop-blur hover:bg-slate-700/60 hover:border-slate-400/80 text-slate-200 font-slate'
              >
                Đăng nhập
              </Button>
            </Link>
          ...
          <div className='mt-16 max-w-4xl mx-auto'>
            <h3 className='text-sm md:text-base font-semibold text-slate-300 mb-6 text-center tracking-wide'>Kết nối với chúng tôi</h3>
            <div className='grid grid-cols-3 sm:grid-cols-5 lg:grid-cols-10 gap-4 justify-items-center'>
              {/* Facebook */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-blue-500/50 hover:bg-blue-900/20 transition-all duration-300'>
              ...
              {/* Instagram */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-pink-500/50 hover:bg-pink-900/20 transition-all duration-300'>
              ...
              {/* Zalo */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-blue-400/50 hover:bg-blue-800/20 transition-all duration-300'>
              ...
              {/* Threads */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-slate-300/50 hover:bg-slate-700/20 transition-all duration-300'>
                <svg className='w-6 h-6 text-slate-300 group-hover:text-slate-200 transition-colors' fill='currentColor' viewBox='0 0 24 24'>
              ...
              {/* YouTube */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-red-500/50 hover:bg-red-900/20 transition-all duration-300'>
              ...
              {/* Spotify */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-green-500/50 hover:bg-green-900/20 transition-all duration-300'>
              ...
              {/* Shop */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-amber-500/50 hover:bg-amber-900/20 transition-all duration-300'>
              ...
              {/* Phone */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-emerald-500/50 hover:bg-emerald-900/20 transition-all duration-300'>
              ...
              {/* Community */}
              <a href='#' className='group flex items-center justify-center w-12 h-12 rounded-xl bg-slate-800/50 border border-slate-700/60 hover:border-purple-500/50 hover:bg-purple-900/20 transition-all duration-300'>
      ...
      <section id='join' className='mt-auto w-full bg-slate-900/70 border-t border-slate-800/70 py-14 px-6'>
        <div className='max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-8 justify-between text-center md:text-left'>
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <Link to='/auth/register'>
              <Button size='lg' className='relative overflow-hidden bg-gradient-to-r from-indigo-500 via-sky-500 to-fuchsia-500 hover:from-indigo-400 hover:via-sky-400 hover:to-fuchsia-400 shadow-lg shadow-indigo-900/40 rounded-xl px-8 font-semibold tracking-wide font-slate'>
                Đăng ký
              </Button>
            </Link>
            <Link to='/auth/login'>
              <Button
                variant='outline'
                size='lg'
                className='rounded-xl border-slate-600/70 bg-slate-800/40 backdrop-blur hover:bg-slate-700/60 hover:border-slate-400/80 text-slate-200 font-slate'
              >
                Đăng nhập
              </Button>
            </Link>
