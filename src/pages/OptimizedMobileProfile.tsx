...
const OptimizedMobileProfile = () => {
  ...
  const [clubsForRank, setClubsForRank] = useState<
  ...
  const submitRankChange = async () => {
    console.log('[submitRankChange] start', {
      selectedClubId,
      requestedRank,
      rankReason,
      user: user?.id,
  ...
  const skillKey = skillLevels[profile.skill_level]
    ? profile.skill_level
    : 'beginner';
  ...
  return (
    <>
      ...
      <PageLayout
        variant='dashboard'
        className={theme === 'dark' ? 'relative z-10 bg-transparent' : ''}
      >
        <Helmet>
          <title>Hồ sơ cá nhân - SABO ARENA</title>
        </Helmet>
        <div
          className='pb-20 min-h-screen relative'
          style={
            theme === 'light'
              ? {
                  backgroundImage:
          ...
          >
            <CardContent className='p-0'>
              ...
              >
                ...
                >
                  <div
                    className={`relative mx-auto mb-1 w-4 h-4 flex items-center justify-center ${
                      activeTab === 'activities'
                        ? 'drop-shadow-lg'
                        : 'drop-shadow-sm'
                    }`}
                ...
                >
                  <div
                    className={`relative mx-auto mb-1 w-4 h-4 flex items-center justify-center ${
                      activeTab === 'edit' ? 'drop-shadow-lg' : 'drop-shadow-sm'
                    }`}
                  >
                    <UserCircle
                      className={`w-4 h-4 transition-all duration-200 ${
                ...
                >
                  <div
                    className={`relative mx-auto mb-1 w-4 h-4 flex items-center justify-center ${
                      activeTab === 'rank' ? 'drop-shadow-lg' : 'drop-shadow-sm'
                    }`}
                  >
                    <Award
                      className={`w-4 h-4 transition-all duration-200 ${
                ...
                >
                  <div
                    className={`relative mx-auto mb-1 w-4 h-4 flex items-center justify-center ${
                      activeTab === 'club' ? 'drop-shadow-lg' : 'drop-shadow-sm'
                    }`}
                  >
                    <Star
                      className={`w-4 h-4 transition-all duration-200 ${
              ...
              {activeTab === 'edit' && (
                <TabEditProfile
                  ...
                  onSave={async () => {
                    await handleSaveProfile(); /* stay on same tab */
                  }}
                  onCancel={() => {
                    handleCancelEdit(); /* stay on same tab */
                  }}
                  theme={theme}
                />
              )}
                ...
                <div className='p-4 space-y-3'>
                  <div className='text-center py-6'>
                    ...
                    <p className='text-xs text-muted-foreground mb-4'>
                      Xác nhận hoặc cập nhật trình độ chơi bida của bạn thông
                      qua câu lạc bộ uy tín
                    </p>
                    {profile.verified_rank && (
                      ...
                      >
                        ...
                        >
                          Bạn có thể gửi yêu cầu cập nhật / xác thực lại nếu
                          hạng của bạn thay đổi
                        </div>
                      </div>
                    )}
              ...
              >
                <div className='flex items-center gap-4 p-4'>
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    >
                      Hoàn thành 5 trận đấu đầu tiên
                    </div>
                  </div>
                  <div
                    className={`text-right ${
          ...
          <DialogContent className='max-w-sm'>
            ...
            <div className='space-y-4'>
              ...
              <p className='text-[10px] text-muted-foreground'>
                Sau khi CLB phê duyệt, hạng của bạn sẽ được cập nhật và đồng bộ
                đến các khu vực liên quan.
              </p>
            </div>
          </DialogContent>
        </Dialog>
