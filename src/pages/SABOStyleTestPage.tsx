        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <ul style={{ marginLeft: '20px', marginTop: '8px' }}>
              <li><strong>Fonts:</strong> Oswald, Bebas Neue, Antonio, Fjalla One, Roboto Condensed</li>
              <li><strong>Style:</strong> Condensed, tall, tactical look</li>
              <li><strong>Line-height:</strong> 0.9 (compact và cao)</li>
              <li><strong>Letter-spacing:</strong> 0.05em (spacing nhỏ)</li>
              <li><strong>Font-variant:</strong> Small-caps cho cứng cáp</li>
              <li><strong>Font-stretch:</strong> Condensed cho nén thon</li>
              <li><strong>Weight:</strong> 900 (extra bold)</li>
            </ul>
          </div>
      </div>
    </div>
