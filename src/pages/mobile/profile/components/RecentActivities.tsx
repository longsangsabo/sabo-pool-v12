  ...
  const activities = [
    {
      icon: (
        <Trophy
          className={`w-4 h-4 ${theme === 'dark' ? 'text-blue-300' : 'text-blue-600'}`}
        />
      ),
    ...
    },
    {
      icon: (
        <Star
          className={`w-4 h-4 ${theme === 'dark' ? 'text-emerald-300' : 'text-emerald-600'}`}
        />
      ),
    ...
    },
    {
      icon: (
        <User
          className={`w-4 h-4 ${theme === 'dark' ? 'text-amber-300' : 'text-amber-600'}`}
        />
      ),
