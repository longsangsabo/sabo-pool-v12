import { Crown, Shield, Star, Award, Gem, Sword, Target, Trophy, Medal, Zap, Flame, Diamond } from 'lucide-react';
...
export const getRankInfo = (rank: string) => {
  ...
  return rankColors[normalizedRank as keyof typeof rankColors] || rankColors['G'];
};
