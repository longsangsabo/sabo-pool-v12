      ...
      <CardContent className='p-4'>
        <div className='flex items-center justify-between'>
          ...
          <div className='text-right'>
            <div className='text-sm text-neutral-500'>Hôm nay</div>
        ...
        <div className='mt-4 space-y-2'>
          <div className='text-xs text-neutral-500 mb-1'>Cột mốc tiếp theo:</div>
          {userStreak.current_streak < 30 && (
            <div className='flex items-center gap-2'>
              ...
              <span className='text-xs text-neutral-500'>30 ngày (+50 điểm)</span>
            </div>
          )}
          {userStreak.current_streak >= 30 &&
