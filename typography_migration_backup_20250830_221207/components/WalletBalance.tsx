      ...
      <Card>
        ...
        <CardContent>
          <div className='text-center py-4'>
            ...
            <p className='text-sm text-neutral-500 mt-2'>Đang tải...</p>
          </div>
        </CardContent>
      </Card>
    );
      ...
      <CardContent>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mb-6'>
          ...
          <div className='text-center p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg'>
            ...
            <div className='text-sm text-success-600'>Số dư hiện tại</div>
          </div>
          ...
          <div className='text-center p-4 bg-gradient-to-r from-blue-50 to-sky-50 rounded-lg'>
            ...
            <div className='text-sm text-primary-600'>Tổng đã kiếm</div>
          </div>
          ...
          <div className='text-center p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg'>
            ...
            <div className='text-sm text-warning-600'>Tổng đã chi</div>
          </div>
        </div>
