      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-600 dark:text-gray-400">Chờ phê duyệt</p>
                <p className="text-2xl font-bold text-info-600">{mockPendingApprovals.length}</p>
              </div>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-600 dark:text-gray-400">Đã phê duyệt hôm nay</p>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-600 dark:text-gray-400">Tranh chấp</p>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-neutral-600 dark:text-gray-400">SPA đã chuyển</p>
          ...
          {mockPendingApprovals.length > 0 ? (
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-lg font-medium text-neutral-900 dark:text-gray-100 mb-2">
