          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-primary-100 rounded-lg">
              ...
              <div>
                ...
                <div className="text-sm text-primary-600">{groupAProgress}% Complete</div>
                {isGroupACompleted && (
            ...
            <div className="flex items-center gap-3 p-3 bg-info-100 rounded-lg">
              ...
              <div>
                ...
                <div className="text-sm text-info-600">{groupBProgress}% Complete</div>
                {isGroupBCompleted && (
                  <Badge className="mt-1 bg-success-100 text-success-800">✅ Qualified</Badge>
                )}
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {groupData.final.map((match, index) => (
                <div key={match.id} className="max-w-md mx-auto">
                  <h4 className="text-sm font-medium text-warning-700 mb-2 text-center">
                    Final {index + 1}
                  </h4>
                  <SABOMatchCard
                    match={match}
