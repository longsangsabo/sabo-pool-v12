            ...
            {filteredPlayers.map(player => (
              ...
              >
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className='flex items-center gap-2'>
                          ...
                          <div className='flex items-center gap-1 text-body-small-neutral'>
                ...
                <CardContent className='space-y-4'>
                  {player.bio && (
                    <p className='text-body-small-neutral'>{player.bio}</p>
                  )}
                  ...
                  {player.achievements.length > 0 && (
                    <div>
                      <div className='text-body-small-medium text-neutral-700 mb-2'>
                        Thành tích:
                      </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {filteredClubs.map(club => (
              <Card key={club.id} className='hover:shadow-lg transition-shadow'>
                ...
                <CardContent className='space-y-4'>
                  <p className='text-body-small-neutral'>{club.description}</p>
