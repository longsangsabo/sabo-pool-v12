                ...
                <Card key={region}>
                  <CardContent className='p-6'>
                    <div className='flex items-center justify-between mb-4'>
                      <h3 className='text-body-large-semibold text-neutral-900'>
                    ...
                    <Button
                      ...
                      className='mt-4 w-full text-primary-600 hover:text-primary-800 text-body-small-medium'
                    >
                      Xem bảng xếp hạng{' '}
                      {regionNames[region as keyof typeof regionNames]}
                    </Button>
            ...
            <div className='overflow-x-auto'>
              <table className='min-w-full divide-y divide-gray-200'>
                <thead className='bg-neutral-50'>
                  <tr>
                    <th className='px-6 py-3 text-left text-caption-medium text-neutral-500 uppercase tracking-wider'>
                      Hạng
                    </th>
                    <th className='px-6 py-3 text-left text-caption-medium text-neutral-500 uppercase tracking-wider'>
                      Người chơi
                    ...
                    <tr key={ranking.id} className='hover:bg-neutral-50'>
                      ...
                      <td className='px-6 py-4 whitespace-nowrap'>
                        <div className='flex items-center'>
                          ...
                          <div>
                            <div className='text-body-small-medium text-neutral-900'>
