                ...
                {userStats ? (
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                    <div className='text-center p-4 bg-primary-50 rounded-lg'>
                      ...
                      <div className='text-body-small-neutral'>Điểm ELO</div>
                    </div>
                    <div className='text-center p-4 bg-success-50 rounded-lg'>
                      <div className='text-heading-bold text-success-600'>
                        {userStats.tournaments_played}
                      </div>
                      <div className='text-body-small-neutral'>Giải đấu</div>
                    </div>
                    ...
                    <div className='text-center p-4 bg-warning-50 rounded-lg'>
                      ...
                      <div className='text-body-small-neutral'>Vị trí</div>
                    </div>
                  </div>
                ) : (
                  <div className='text-center py-8 text-neutral-500'>
            ...
            <CardContent>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  ...
                  <div className='text-body-small-neutral'>Người tham gia</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading-bold'>
                    {seasonInfo?.total_matches || 0}
                  </div>
                  <div className='text-body-small-neutral'>Trận đấu</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading-bold'>{prizes.length}</div>
                  <div className='text-body-small-neutral'>Hạng giải thưởng</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading-bold'>
                    {prizes
                  ...
                  <div className='text-body-small-neutral'>Tổng giải thưởng</div>
                </div>
              </div>
            </CardContent>
          </Card>
