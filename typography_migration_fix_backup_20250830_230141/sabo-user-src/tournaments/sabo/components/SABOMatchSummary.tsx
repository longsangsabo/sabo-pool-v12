...
export const SABOMatchSummary: React.FC<SABOMatchSummaryProps> = ({
  ...
  return (
    <div className='bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20 border border-success-200 dark:border-green-800 rounded-lg p-4'>
      {/* Winner Highlight */}
      <div className='flex items-center justify-center mb-3'>
        <Trophy className='w-6 h-6 text-yellow-500 mr-2' />
        <span className='text-body-large font-bold text-success-700 dark:text-green-400'>
      ...
      <div className='flex items-center justify-center space-x-4'>
        ...
        <div className='text-gray-400 dark:text-neutral-600 text-title font-bold'>
          -
        </div>
