      ...
      <Card className='bg-gradient-to-r from-blue-50 to-purple-50 border-primary-200'>
        <CardContent className='p-6 text-center'>
          <div className='flex flex-col items-center gap-3'>
            ...
            <h3 className='font-semibold text-neutral-900'>Check-in hàng ngày</h3>
      ...
      <CardContent className='space-y-4'>
          ...
          <div className='flex items-center gap-3'>
            <div
              className={`w-12 h-12 rounded-full flex items-center justify-center ${
                hasCheckedInToday ? 'bg-success-100' : 'bg-warning-100'
              }`}
            >
              {hasCheckedInToday ? (
        ...
        {userStreak && (
          <div className='space-y-3'>
            <div className='flex items-center justify-between text-sm'>
              <span className='text-neutral-600'>Điểm hiện tại:</span>
              <span className='font-bold text-body-large text-neutral-900'>
        ...
        {userStreak && (
          <div className='space-y-2'>
            ...
            <div className='text-caption text-neutral-500 text-right'>
