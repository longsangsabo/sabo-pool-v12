      ...
      <Card>
        <CardContent className='pt-6'>
          <div className='text-center py-8'>
            ...
            <p className='text-body-small-muted mt-1'>{error}</p>
          ...
          <CardContent className='p-3'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-title font-bold'>{data.memberStats.total}</p>
            ...
            <Badge variant='secondary' className='text-caption mt-1 px-1 py-0'>
          ...
          <CardContent className='p-3'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-title font-bold'>{data.matchStats.total}</p>
            ...
            <Badge variant='outline' className='text-caption mt-1 px-1 py-0'>
          ...
          <CardContent className='p-3'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-caption-muted'>Đã tổ chức</p>
              </div>
              <Calendar className='h-8 w-8 text-muted-foreground' />
            </div>
            <Badge variant='default' className='text-caption mt-1 px-1 py-0'>
          ...
          <CardContent className='p-3'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-title font-bold text-warning-600'>
                  {data.trustScore.toFixed(1)}%
                </p>
                <p className='text-caption-muted'>Đánh giá</p>
              </div>
            ...
            <Badge
              ...
              className='text-caption mt-1 px-1 py-0'
            >
              {data.trustScore >= 90
                ? 'Xuất sắc'
                : data.trustScore >= 75
            ...
            {data.pendingVerifications.length === 0 ? (
              ...
              <div className='space-y-2'>
                ...
                {data.pendingVerifications.length > 3 && (
                  <p className='text-caption-muted text-center'>
                ...
                {data.recentNotifications.slice(0, 3).map(notification => (
                  ...
                  >
                    <div className='flex-1 min-w-0'>
                      ...
                      <p className='text-caption-muted line-clamp-2'>
