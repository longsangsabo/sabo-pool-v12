...
const ClubSidebar: React.FC<ClubSidebarProps> = ({
  ...
  const menuItems = [
    ...
    {
      title: 'Thành viên & Xác thực',
      icon: UserCheck,
      href: '/club-management/members',
      description: 'Quản lý thành viên & xác thực hạng',
    },
    {
      title: 'Thông báo',
      icon: Bell,
        ...
        <div className='flex items-center gap-3'>
          ...
          {!collapsed && (
            <div className='flex-1 min-w-0'>
              <h2 className='font-semibold text-body-small truncate'>
          ...
          {menuItems.map(item => {
            ...
            return (
              <NavLink
                ...
                className={({ isActive }) =>
                  cn(
                    'flex items-center gap-3 px-3 py-2 rounded-lg text-body-small font-medium transition-colors',
              ...
              >
                ...
                {!collapsed && (
                  <div className='flex-1 min-w-0'>
                    ...
                    <div className='text-caption opacity-70 truncate'>
                      {item.description}
                    </div>
                  </div>
                )}
