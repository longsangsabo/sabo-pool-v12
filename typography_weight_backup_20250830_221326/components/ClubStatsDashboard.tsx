    ...
    return (
      <Card>
        <CardContent className='text-center py-8'>
          ...
          <h3 className='text-body-large font-semibold text-neutral-700 mb-2'>
            Không có câu lạc bộ
          </h3>
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex justify-between items-start'>
        <div>
          <h2 className='text-heading font-bold'>{clubInfo.name}</h2>
          <p className='text-neutral-600'>{clubInfo.address}</p>
        </div>
        <Button
          variant='outline'
          size='sm'
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <Card className='bg-gradient-to-br from-blue-50 to-blue-100'>
          <CardContent className='pt-6'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-primary-600 font-medium'>Thành viên</p>
                <p className='text-heading font-bold text-primary-700'>
        ...
        <Card className='bg-gradient-to-br from-green-50 to-green-100'>
          <CardContent className='pt-6'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-success-600 font-medium'>Đã xác thực</p>
                <p className='text-heading font-bold text-success-700'>
        ...
        <Card className='bg-gradient-to-br from-yellow-50 to-yellow-100'>
          <CardContent className='pt-6'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-warning-600 font-medium'>Điểm tin cậy TB</p>
                <p className='text-heading font-bold text-warning-700'>
        ...
        <Card className='bg-gradient-to-br from-purple-50 to-purple-100'>
          <CardContent className='pt-6'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-info-600 font-medium'>Trận tháng này</p>
                <p className='text-heading font-bold text-info-700'>
                ...
                {members.slice(0, 5).map(member => (
                  ...
                  >
                    ...
                    <div className='text-right'>
                      ...
                      <p className='text-caption text-neutral-500'>tin cậy</p>
                    </div>
                  </div>
                ))}
              </div>
