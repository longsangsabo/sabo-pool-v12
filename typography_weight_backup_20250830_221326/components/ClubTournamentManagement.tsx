    ...
    const ActionToolbar = () => (
      <div className='flex items-center justify-between bg-card border rounded-lg p-4 mb-4'>
        <div className='flex items-center gap-4'>
          <div className='text-body-small-muted'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div>
              ...
              <div className='space-y-2'>
                ...
                <div>
                  <span className='text-body-small-muted'>Mô tả:</span>
                ...
                <div key={registration.id} className='border rounded-lg p-4'>
                  <div className='flex items-center justify-between'>
                    <div className='flex-1'>
                      ...
                      <div className='text-body-small-muted space-y-1'>
                        <p>
            ...
            <CardContent>
              <div className='space-y-4'>
                ...
                <div className='bg-white rounded p-4 border'>
                  ...
                  <ol className='text-body-small-muted space-y-1 list-decimal list-inside'>
    ...
    <Card>
      ...
      <CardContent>
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-4'>
          <div>
            <p className='text-body-small font-medium'>Loại giải</p>
            <p className='text-body-small-muted'>
              {getTournamentTypeLabel(tournament.tournament_type)}
            </p>
          </div>
          <div>
            <p className='text-body-small font-medium'>Người tham gia</p>
            <p className='text-body-small-muted'>
              0/{tournament.max_participants}
            </p>
          </div>
          <div>
            <p className='text-body-small font-medium'>Phí tham gia</p>
            <p className='text-body-small-muted'>
              {tournament.entry_fee.toLocaleString('vi-VN')} VNĐ
            </p>
          </div>
          <div>
            <p className='text-body-small font-medium'>Bắt đầu</p>
            <p className='text-body-small-muted'>
