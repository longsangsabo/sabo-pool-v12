      ...
      <div className='w-full bg-white rounded-t-2xl p-4 max-h-[80vh] overflow-y-auto'>
        <Card className='border-0 shadow-none'>
          ...
          <CardContent className='space-y-6'>
            {/* Rank Filter */}
            <div>
              <Label className='text-body font-semibold flex items-center space-x-2 mb-3'>
            ...
            <div>
              ...
              <Slider
                ...
                className='w-full'
              />
              <div className='flex justify-between text-body-small text-neutral-500 mt-1'>
                <span>5km</span>
                <span>100km</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className='space-y-3'>
                <div>
                  <Label className='text-body-small text-neutral-600'>Tối thiểu</Label>
                  <Slider
                ...
                <div>
                  <Label className='text-body-small text-neutral-600'>Tối đa</Label>
                  <Slider
