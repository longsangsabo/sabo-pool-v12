          ...
          <div className='hidden lg:flex lg:items-center lg:space-x-8'>
            {navigationItems.map(item => (
              <Link
                ...
                className={`px-3 py-2 text-body-small font-medium transition-colors ${
                  item.current
            ...
            {user && (
              <Link
                to='/inbox'
                className={`relative px-3 py-2 text-body-small font-medium transition-colors ${
                ...
                <DropdownMenuContent className='w-56' align='end' forceMount>
                  <DropdownMenuLabel className='font-normal'>
                    <div className='flex flex-col space-y-1'>
                      <p className='text-body-small font-medium leading-none'>
            ...
            <div className='px-2 pt-2 pb-3 space-y-1'>
              ...
              {navigationItems.map(item => (
                <Link
                  key={item.name}
                  to={item.href}
                  className={`block px-3 py-2 text-body font-medium rounded-md transition-colors ${
                    item.current
              ...
              {user && (
                <Link
                  to='/inbox'
                  className={`flex items-center justify-between px-3 py-2 text-body font-medium rounded-md transition-colors ${
                    location.pathname === '/inbox'
                      ? 'text-primary bg-primary/10'
                      : 'text-muted-foreground hover:text-primary hover:bg-muted/50'
                  }`}
              ...
              {isAdmin && (
                <Link
                  to='/admin'
                  className={`flex items-center px-3 py-2 text-body font-medium rounded-md transition-colors ${
                    location.pathname === '/admin'
              ...
              {!user && (
                <div className='pt-4 border-t border-border'>
                  <Link
                    to='/login'
                    className='block px-3 py-2 text-body font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50 rounded-md transition-colors'
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Đăng nhập
                  </Link>
                  <Link
                    to='/register'
                    className='block px-3 py-2 text-body font-medium bg-gradient-to-r from-primary to-primary-glow text-primary-foreground rounded-md mt-2 transition-colors'
                    onClick={() => setIsMenuOpen(false)}
                  >
                    Đăng ký
                  </Link>
