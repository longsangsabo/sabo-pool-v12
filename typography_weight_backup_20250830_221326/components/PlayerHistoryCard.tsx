...
export const PlayerHistoryCard: React.FC<PlayerHistoryCardProps> = ({
  ...
  const getRankIcon = (rank: number) => {
    ...
    return <span className='font-semibold text-neutral-600'>#{rank}</span>;
  };
            ...
            <Card className='border-success-200 bg-success-50'>
              ...
              <CardContent>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                  ...
                  <div className='text-center'>
                    <p className='text-body-small text-neutral-600'>Điểm cao nhất</p>
                    <p className='text-body-large font-bold text-success-800'>
                      {formatPoints(bestSeason.ranking_points)}
                    </p>
                  </div>
                  <div className='text-center'>
                    <p className='text-body-small text-neutral-600'>Hạng</p>
