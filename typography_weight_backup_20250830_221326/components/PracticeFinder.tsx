      ...
      <CardContent className='space-y-4'>
        ...
        {isLoadingPlayers ? (
          ...
          <div className='text-center py-8'>
            ...
            <p className='text-neutral-500'>Không tìm thấy người chơi nào</p>
              ...
              const getStatusDisplay = (status: string) => {
                switch (status) {
                  ...
                  case 'available_weekend':
                    return {
                      text: 'Rảnh cuối tuần',
                      color: 'bg-info-100 text-purple-800',
                    };
                  default:
                    return {
                      text: 'Có thể rảnh',
              ...
              return (
                ...
                >
                  ...
                  <div className='flex-1 min-w-0'>
                    ...
                    {player.location && (
                      <div className='flex items-center gap-1 text-caption-muted mt-1'>
        ...
        {/* Help Text */}
        <div className='text-caption-muted bg-primary-50 p-3 rounded-lg'>
