        ...
        <div className='flex flex-col lg:flex-row items-start gap-6'>
          ...
          <div className='flex items-center gap-4 lg:min-w-fit'>
            ...
            <div className='min-w-0'>
              ...
              {profile.member_since && (
                <p className='text-caption-muted flex items-center'>
              ...
              {uploading && (
                <p className='text-caption text-primary mt-1'>Đang tải ảnh...</p>
              )}
            </div>
          </div>
          ...
          <div className='flex-1 lg:max-w-xs'>
            <div className='bg-gradient-to-r from-primary/10 to-primary/5 p-4 rounded-lg border border-primary/20'>
              <div className='flex items-center justify-between'>
                <div>
                  <p className='text-caption-muted mb-1'>
                    Hạng hiện tại
                  </p>
                  ...
                  <p className='text-caption-muted mt-1'>
                    {getVerificationText()}
                  </p>
                  {getNewUserMessage() && (
                    <p className='text-caption text-warning-600 mt-1 font-medium leading-tight'>
                      {getNewUserMessage()}
                    </p>
                  )}
                </div>
          ...
          <div className='flex-1'>
            {loading || clubLoading ? (
              ...
              <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
                <div className='bg-gradient-to-br from-green-50 to-green-100 p-4 rounded-lg border border-success-200 hover:shadow-sm transition-shadow'>
                ...
                <div className='bg-gradient-to-br from-blue-50 to-blue-100 p-4 rounded-lg border border-primary-200 hover:shadow-sm transition-shadow'>
                  <div className='flex flex-col'>
                    <div className='flex items-center justify-between mb-2'>
                ...
                <div className='bg-gradient-to-br from-orange-50 to-orange-100 p-4 rounded-lg border border-orange-200 hover:shadow-sm transition-shadow'>
                  <div className='flex flex-col'>
                    ...
                    <p className='text-title font-bold text-warning-700'>
                ...
                {!hasClubProfile && (
                  ...
                  >
                    <div className='flex flex-col justify-between h-full'>
                      <div className='flex items-center justify-between mb-2'>
                        <p className='text-caption text-info-600 font-medium'>
                          Đăng ký CLB
                        </p>
                        <Building2 className='w-4 h-4 text-purple-500' />
                      </div>
                      <div className='flex items-center justify-between'>
                        <p className='text-caption text-purple-500 leading-tight'>
                          Quản lý CLB
                        </p>
                ...
                {hasClubProfile && (
                  <div className='bg-gradient-to-br from-emerald-50 to-emerald-100 p-4 rounded-lg border border-emerald-200 hover:shadow-sm transition-shadow'>
                    <div className='flex flex-col'>
                      ...
                      <p className='text-title font-bold text-emerald-700'>✓</p>
                    </div>
                  </div>
                )}
              </div>
