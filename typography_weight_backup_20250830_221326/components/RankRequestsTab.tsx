        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              ...
              variant='outline'
              disabled={updating}
              className='border-red-500 text-error-600 hover:bg-error-50'
            >
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-body-small text-neutral-600'>Tổng cộng</p>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-body-small text-neutral-600'>Chờ xử lý</p>
                <p className='text-heading font-bold'>{stats.pending}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-body-small text-neutral-600'>Đã phê duyệt</p>
                <p className='text-heading font-bold'>{stats.approved}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-body-small text-neutral-600'>Kiểm tra tại chỗ</p>
                <p className='text-heading font-bold'>{stats.on_site_test}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='flex items-center space-x-2'>
              ...
              <div>
                <p className='text-body-small text-neutral-600'>Bị từ chối</p>
                <p className='text-heading font-bold'>{stats.rejected}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                    ...
                    <div className='flex items-start space-x-4 flex-1'>
                      ...
                      <div className='flex-1 space-y-2'>
                        ...
                        {request.rejection_reason && (
                          <div className='text-body-small text-error-600 bg-error-50 p-2 rounded'>
