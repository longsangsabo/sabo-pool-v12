          ...
          <div className='space-y-6'>
            ...
            <div className='border-2 border-primary-200 rounded-lg p-4 bg-primary-50'>
              <div className='flex items-center gap-2 mb-3'>
                <Trophy className='w-5 h-5 text-primary-600' />
                <h3 className='font-bold text-body-large text-primary-800'>
                  {rankInfo.name}
                </h3>
              </div>
            ...
            <div className='bg-warning-50 border border-yellow-200 rounded-lg p-4'>
              <div className='flex'>
                ...
                <div className='text-sm'>
                  <strong className='text-warning-800'>Lưu ý quan trọng:</strong>
                  <ul className='mt-2 space-y-1 text-warning-700'>
        ...
        {testPhase === 'testing' && (
          <div className='space-y-6'>
            <div className='text-center'>
              ...
              <h3 className='text-heading font-bold text-primary-600 mb-2'>
            ...
            <div className='bg-success-50 border border-success-200 rounded-lg p-4'>
              ...
              <div className='grid grid-cols-2 gap-2 text-body-small text-success-700'>
                {rankInfo.requirements.map((req, index) => (
            ...
            <div className='text-center'>
              <Button
                ...
                className='bg-error-600 hover:bg-red-700'
                size='lg'
              >
        ...
        {testPhase === 'result' && (
          <div className='space-y-6'>
            <div className='text-center mb-6'>
              <h3 className='text-title font-bold mb-2'>Kết quả test</h3>
              <div className='text-body-large text-primary-600'>
              ...
              <div className='mt-2 space-y-3'>
                <div className='flex items-center gap-2'>
                  ...
                  <label
                    ...
                    className='flex items-center gap-2 px-4 py-2 bg-primary-50 border border-primary-200 rounded-lg cursor-pointer hover:bg-primary-100 transition-colors'
                  >
                    {uploading ? (
