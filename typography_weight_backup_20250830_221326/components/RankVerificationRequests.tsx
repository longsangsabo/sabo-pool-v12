      ...
      <Card>
        <CardContent className='pt-6'>
          <div className='text-center'>
            ...
            <p className='text-body-small text-neutral-600'>Đang tải yêu cầu...</p>
          </div>
        </CardContent>
      </Card>
    );
                    ...
                    <div className='bg-primary-50 border border-primary-200 rounded-lg p-4'>
                      <div className='flex items-center mb-3'>
                        ...
                        <div>
                          ...
                          <p className='text-body-small text-primary-600 mt-1'>
        ...
        {notes && (
          <div className='space-y-3'>
            <div className='bg-primary-50 p-3 rounded-lg border border-primary-200'>
              <p className='text-body-small text-primary-700 font-medium'>Lịch đã hẹn:</p>
              <p className='text-body-small text-primary-600 mt-1'>{notes}</p>
            </div>
            ...
            <div className='flex space-x-2'>
              ...
              <Button
                ...
                disabled={processing}
                className='border-red-300 text-error-600 hover:bg-error-50'
              >
  ...
  return (
    <div className='space-y-4 p-4 border border-primary-200 rounded-lg bg-primary-50'>
      <div className='flex items-center justify-between'>
        <h4 className='font-medium text-primary-800'>Hẹn lịch test</h4>
        <Button
          size='sm'
          variant='ghost'
      ...
      <div className='grid grid-cols-2 gap-3'>
        <div>
          <label className='block text-body-small font-medium text-neutral-700 mb-1'>
            Ngày
          </label>
          <input
            type='date'
            ...
            className='w-full px-3 py-2 border border-neutral-300 rounded-md focus:ring-2 focus:ring-blue-500'
          />
        </div>
        <div>
          <label className='block text-body-small font-medium text-neutral-700 mb-1'>
