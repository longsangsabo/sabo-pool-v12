...
export const Season2Info: React.FC = () => {
      ...
      <Card>
        <CardContent className='p-6'>
          <div className='text-center'>
            ...
            <p className='mt-2 text-neutral-600'>Đang tải thông tin Season 2...</p>
          </div>
        </CardContent>
      </Card>
    );
  ...
  return (
    <div className='space-y-6'>
            ...
            {checkingEligibility ? (
              ...
              <div className='space-y-3'>
                <div className='flex items-center gap-2'>
                  ...
                  <span
                    className={
                      eligibility.eligible ? 'text-success-600' : 'text-error-600'
                    }
                  >
                    {eligibility.eligible
                ...
                {eligibility.reason && (
                  <div className='text-body-small text-error-600 bg-error-50 p-3 rounded-lg'>
                    {eligibility.reason}
                  </div>
                )}
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            <div>
              ...
              <p className='text-body-small text-neutral-600'>Không giới hạn</p>
            </div>
          </div>
        </CardContent>
      </Card>
              ...
              >
                ...
                <div className='text-right'>
                  ...
                  {prize.voucher_amount > 0 && (
                    <div className='text-body-small text-primary-600'>
                      + {prize.voucher_amount.toLocaleString()}đ voucher
                    </div>
                  )}
                  {prize.member_months > 0 && (
                    <div className='text-body-small text-info-600'>
      ...
      {/* Important Notes */}
      <Card className='border-orange-200 bg-warning-50'>
        <CardHeader>
