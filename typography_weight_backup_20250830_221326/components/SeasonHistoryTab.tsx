              ...
              <Card>
                <CardContent className='p-6'>
                  <div className='flex items-center space-x-2'>
                    ...
                    <div>
                      <p className='text-body-small font-medium text-neutral-600'>
                        Tổng người chơi
                      </p>
            ...
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div className='space-y-2'>
                  <label className='text-body-small font-medium'>Mùa giải</label>
                  <Select
                ...
                <div className='space-y-2'>
                  <label className='text-body-small font-medium'>Kết quả</label>
                ...
                <table className='w-full'>
                  ...
                  <tbody>
                    {history.map((player, index) => (
                      <tr key={player.id} className='border-b hover:bg-neutral-50'>
                        <td className='p-3'>
                          <Badge
