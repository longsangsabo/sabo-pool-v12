...
export const AnalyticsDashboard: React.FC<AnalyticsDashboardProps> = ({
      ...
      setData({
        ...
        performance: {
          monthly: {
            ...
            earnings: [
              150000, 180000, 220000, 160000, 200000, 250000, 280000, 210000,
              190000, 240000, 270000, 300000,
            ],
          },
          categories: {
            tournament: 45,
  ...
  const getRankColor = (rank: string) => {
    switch (rank) {
      ...
      case 'F+':
      case 'F':
        return 'bg-info-100 text-purple-800';
      case 'G+':
      case 'G':
  ...
  if (!data) {
    return (
      <div className='text-center py-8'>
        <p className='text-neutral-500'>Không có dữ liệu thống kê</p>
      </div>
    );
  }
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          <h1 className='text-3xl font-bold text-neutral-900'>Thống kê cá nhân</h1>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-body-small font-medium'>Tổng trận đấu</CardTitle>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-body-small font-medium'>Tỷ lệ thắng</CardTitle>
            <Trophy className='h-4 w-4 text-muted-foreground' />
          </CardHeader>
          <CardContent>
            <div className='text-heading font-bold'>{data.overview.winRate}%</div>
            <p className='text-caption-muted'>
              <TrendingUp className='h-3 w-3 inline text-green-500' />
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-body-small font-medium'>Tổng thu nhập</CardTitle>
        ...
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-body-small font-medium'>Hạng hiện tại</CardTitle>
            ...
            <div className='space-y-4'>
              <div>
                <div className='flex justify-between text-body-small mb-2'>
                  ...
                  <span>
                    {
                      data.performance.monthly.matches[
                        data.performance.monthly.matches.length - 1
                      ]
                    }
                  </span>
                </div>
              ...
              <div>
                <div className='flex justify-between text-body-small mb-2'>
                  ...
                  <span>
                    {
                      data.performance.monthly.wins[
                        data.performance.monthly.wins.length - 1
                      ]
                    }
                  </span>
                </div>
              ...
              <div>
                <div className='flex justify-between text-body-small mb-2'>
                  ...
                  <span>
                    {formatCurrency(
                      data.performance.monthly.earnings[
                        data.performance.monthly.earnings.length - 1
                      ]
                    )}
                  </span>
                </div>
            ...
            <div className='space-y-3'>
              <div className='flex items-center justify-between'>
                ...
                <span className='text-body-small font-medium'>
                  {data.performance.categories.tournament}
                </span>
              </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <span className='text-body-small font-medium'>
                  {data.performance.categories.challenge}
                </span>
              </div>
              ...
              <div className='flex items-center justify-between'>
                ...
                <span className='text-body-small font-medium'>
                  {data.performance.categories.friendly}
                </span>
              </div>
            </div>
          </CardContent>
          ...
          <CardContent>
            <div className='space-y-3'>
              ...
              <div className='pt-3 border-t'>
                ...
                <div className='flex items-center gap-2 text-body-small text-primary-600'>
        ...
        <CardContent>
          <div className='flex items-center justify-between'>
            ...
            <div className='text-right'>
              <div className='text-body-small text-neutral-600'>Kỷ lục cá nhân</div>
              <div className='text-body-large font-bold'>15 trận</div>
            </div>
          </div>
        </CardContent>
      </Card>
