      ...
      <div className='max-w-md w-full space-y-8'>
        ...
        {isDevelopment && error && (
          <div className='mt-4 p-4 bg-error-50 border border-error-200 rounded-md'>
            <h3 className='text-body-small font-medium text-error-800 mb-2'>
        ...
        <div className='mt-8 space-y-3'>
          <button
            onClick={onRetry}
            className='w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-body-small font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
          >
            Thử lại
          </button>
          ...
          <button
            onClick={onReload}
            className='w-full flex justify-center py-2 px-4 border border-neutral-300 rounded-md shadow-sm text-body-small font-medium text-neutral-700 bg-white hover:bg-neutral-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
          >
            Tải lại trang
          </button>
        ...
        {/* Support info */}
        <div className='mt-6 text-center text-caption text-neutral-500'>
