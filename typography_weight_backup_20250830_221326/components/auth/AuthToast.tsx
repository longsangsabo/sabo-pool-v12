    ...
    >
      <div className={getToastStyles()}>
        ...
        <div className='flex-1 min-w-0'>
          <h4 className='font-semibold text-body-small mb-1'>{toast.title}</h4>
          <p className='text-body-small opacity-90'>{toast.message}</p>
          ...
          {toast.action && (
            <button
              ...
              className={`
                mt-2 text-body-small font-medium underline hover:no-underline
