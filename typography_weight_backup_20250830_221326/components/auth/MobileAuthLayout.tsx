      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            {/* Title */}
            <h1 className="text-body-large font-semibold text-neutral-900 flex-1 text-center">
              {title}
            </h1>
          ...
          {/* Subtitle */}
          {subtitle && (
            <p className="text-body-small text-neutral-600 text-center mt-2">
              {subtitle}
            </p>
          )}
        </div>
        ...
        {isLoading && (
          <div className="absolute inset-0 bg-white/80 backdrop-blur-sm flex items-center justify-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-body-small text-neutral-600">Đang xử lý...</span>
            </div>
          </div>
        )}
      </div>
...
export const MobileAuthButton: React.FC<MobileAuthButtonProps> = ({
  ...
  const baseStyles = "w-full py-3 px-4 text-body font-medium rounded-lg transition-all duration-200 touch-manipulation";
