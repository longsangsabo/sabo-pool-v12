...
const BookingForm = ({
  ...
  return (
    <div className='container mx-auto px-4 py-8'>
      ...
      >
        <h2 className='text-heading font-bold text-yellow-400 text-center mb-6'>
          Thông tin đặt bàn
        </h2>
        ...
        {formData.timeSlot && formData.duration && (
          <div className='bg-success-700 rounded-lg p-4'>
            <div className='flex justify-between items-center'>
              ...
              <span className='text-yellow-400 text-heading font-bold'>
        ...
        <Button
          type='submit'
          disabled={loading}
          className='w-full bg-yellow-400 text-green-900 hover:bg-warning-500 min-h-[50px] text-body-large font-bold'
        >
          {loading ? (
            <>
