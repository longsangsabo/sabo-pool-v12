    ...
    <Card className="border-l-4 border-l-purple-500 shadow-lg">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4">
          <div className="text-body-small font-medium text-neutral-600 dark:text-gray-400 mb-3">
            Thông tin trận đấu
          </div>
          ...
          <div className="grid grid-cols-3 items-center gap-4 mb-4">
            ...
            <div className="text-center">
              <div className="text-body-large font-bold text-neutral-600">vs</div>
              <div className="text-caption text-neutral-500">Race to {challenge.race_to || 'N/A'}</div>
            </div>
        ...
        <div className="bg-primary-50 dark:bg-blue-900/20 border border-primary-200 dark:border-blue-700 rounded-lg p-4">
          ...
          <div className="grid grid-cols-3 items-center gap-4">
            ...
            <div className="text-center">
              <div className="text-title font-bold text-gray-400">-</div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between p-2 bg-success-100 dark:bg-green-800/30 rounded">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-small font-medium text-success-800 dark:text-green-200">
                    Người thắng
                  </span>
                </div>
              ...
              <div className="flex items-center justify-between p-2 bg-error-100 dark:bg-red-800/30 rounded">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-small font-medium text-error-800 dark:text-red-200">
                    Người thua
                  </span>
                </div>
              ...
              <div className="text-caption text-neutral-600 dark:text-gray-400 bg-neutral-100 dark:bg-neutral-800 p-2 rounded">
                {spaDisplay.summaryText}
              </div>
            </div>
          ) : (
            <div className="text-center text-body-small text-neutral-600 dark:text-gray-400">
