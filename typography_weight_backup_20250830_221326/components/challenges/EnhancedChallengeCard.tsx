          ...
          <div className="flex items-center justify-between mb-3 relative z-10">
            ...
            <div className="flex flex-col items-end gap-1">
              ...
              {(() => {
                ...
                if (expiryInfo) {
                  return (
                    <div className={`text-caption font-medium px-2 py-1 rounded ${expiryInfo.color} ${
                      expiryInfo.expired 
          ...
          <div className="space-y-3 relative z-10">
            ...
            <div className="flex items-center justify-between">
              <div className="flex-1 text-center">
                ...
                />
                <div className="text-caption font-medium text-neutral-700 dark:text-gray-300 truncate">
                ...
                {/* Player Info */}
                <div className="text-caption text-neutral-500 dark:text-gray-400 mt-1 space-y-0.5">
              ...
              <div className="space-y-2">
                ...
                {challenge.location && (
                  <div className="flex items-start gap-2 p-3 bg-success-50/50 dark:bg-green-900/20 rounded-lg border border-success-200/50 dark:border-green-700/30">
                    ...
                    <div className="flex-1">
                      <span className="text-neutral-600 dark:text-gray-400 text-caption font-medium block">CLB thi đấu</span>
                ...
                {challenge.required_rank && challenge.required_rank !== 'all' && (
                  <div className="flex items-start gap-2 p-3 bg-primary-50/50 dark:bg-blue-900/20 rounded-lg border border-primary-200/50 dark:border-blue-700/30">
                    ...
                    <div className="flex-1">
                      <span className="text-neutral-600 dark:text-gray-400 text-caption font-medium block">Yêu cầu hạng</span>
