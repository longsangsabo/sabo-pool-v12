      ...
      return (
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-amber-600">
            ...
            <span className="text-body-small font-medium">Bước 1: Chờ nhập tỷ số</span>
          </div>
          <Progress value={20} className="h-2" />
          <div className="text-caption text-neutral-500">Một trong hai người chơi cần nhập tỷ số</div>
        </div>
      );
    }
    ...
    return (
      <div className="space-y-2">
        <div className="flex items-center gap-2 text-info-600">
          ...
          <span className="text-body-small font-medium">Bước 3: Chờ CLB phê duyệt</span>
        </div>
        <Progress value={90} className="h-2" />
        <div className="text-caption text-neutral-500">Tỷ số đã xác nhận, chờ CLB phê duyệt và chuyển điểm SPA</div>
      </div>
    );
  };
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 items-center gap-4 p-3 bg-neutral-50 dark:bg-neutral-900 rounded-lg">
          <div className="text-center">
            ...
            {hasSubmittedScore && (
              <div className="text-heading font-bold text-primary-600 mt-1">
          ...
          <div className="text-center">
            ...
            <div className="text-heading font-bold">vs</div>
          ...
          <div className="text-center">
            ...
            {hasSubmittedScore && (
              <div className="text-heading font-bold text-success-600 mt-1">
            ...
            {!showScoreInput ? (
              ...
              <div className="space-y-3 p-4 border rounded-lg">
                <div className="grid grid-cols-3 items-center gap-4">
                  <div>
                    <label className="block text-body-small font-medium mb-1">
        ...
        {hasSubmittedScore && needsConfirmation && (
          <div className="space-y-4 p-5 border-2 border-primary-200 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl shadow-sm">
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className="bg-white dark:bg-neutral-800/50 rounded-lg p-4 border border-blue-100 dark:border-blue-800">
                    <div className="grid grid-cols-3 items-center gap-4">
                      <div className="text-center">
                        <div className="text-body-small font-medium text-neutral-600 dark:text-gray-400 mb-1">
                          {challengerProfile.display_name}
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-heading font-bold text-gray-400">vs</div>
                      </div>
                  ...
                  {!needsMyConfirmation && (
                    <div className="flex items-center justify-center gap-2 p-3 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg">
                      ...
                      <span className="text-body-small text-neutral-600 dark:text-gray-400">
        ...
        {challenge.status === 'completed' && (
          <div className="p-5 border-2 border-success-200 bg-gradient-to-br from-green-50/50 to-emerald-50/50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-xl shadow-sm">
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-neutral-800/50 rounded-lg p-4 border border-green-100 dark:border-green-800">
                <div className="text-center mb-3">
                  <div className="text-body-small font-medium text-neutral-600 dark:text-gray-400">Kết quả cuối cùng</div>
                </div>
                ...
                <div className="grid grid-cols-3 items-center gap-4">
                  ...
                  <div className="text-center">
                    <div className="text-heading font-bold text-gray-400">vs</div>
                    <div className="text-caption text-neutral-500 mt-1">Race to {challenge.race_to || 'N/A'}</div>
                  </div>
              ...
              <div className="flex items-center justify-between p-3 bg-primary-50 dark:bg-blue-900/20 border border-primary-200 dark:border-blue-700 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-small font-medium text-primary-800 dark:text-blue-200">
                    Chuyển điểm SPA
                  </span>
                </div>
