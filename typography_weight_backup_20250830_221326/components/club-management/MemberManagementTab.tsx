...
const statusColors = {
  ...
  inactive: 'bg-warning-100 text-warning-800',
        ...
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Tổng thành viên</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-heading font-bold'>{stats.active}</p>
              <p className='text-body-small-muted'>Đang hoạt động</p>
            </div>
          </CardContent>
        </Card>
        <Card>
