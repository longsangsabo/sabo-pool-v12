...
interface RankVerification {
  ...
  test_scheduled_date: string | undefined;
  test_score: number | null;
  instructor_feedback: string | undefined;
  profiles: {
    full_name: string;
    phone: string;
  };
...
const statusColors = {
  ...
  testing: 'bg-info-100 text-purple-800',
        ...
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Tổng yêu cầu</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Chờ xử lý</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Đã duyệt</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-heading font-bold'>{stats.thisMonth}</p>
              <p className='text-body-small-muted'>Tháng này</p>
            </div>
          </CardContent>
        </Card>
      </div>
