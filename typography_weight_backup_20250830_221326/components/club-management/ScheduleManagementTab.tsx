        ...
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Tổng lịch test</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-heading font-bold'>{stats.available}</p>
              <p className='text-body-small-muted'>Có thể đặt</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-heading font-bold'>{stats.thisWeek}</p>
              <p className='text-body-small-muted'>Tuần này</p>
            </div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className='pt-6'>
            <div className='text-center'>
              ...
              <p className='text-heading font-bold'>{stats.completed}</p>
              <p className='text-body-small-muted'>Đã hoàn thành</p>
            </div>
          </CardContent>
        </Card>
      </div>
