    ...
    <div className='min-h-screen pb-24 px-4 pt-4 space-y-6'>
      ...
      <div className='grid grid-cols-2 gap-3'>
        ...
        >
          ...
          <span className='text-body-small font-medium'>Mời thành viên</span>
        </Button>
        <Button
          variant='outline'
          className='justify-start gap-2 h-12 text-left'
        ...
        >
          ...
          <span className='text-body-small font-medium'>Cài đặt CLB</span>
        </Button>
        <Button
          variant='outline'
          className='justify-start gap-2 h-12 text-left'
        ...
        >
          ...
          <span className='text-body-small font-medium'>Quản lý thành viên</span>
        </Button>
        <Button
          variant='outline'
          className='justify-start gap-2 h-12 text-left'
        ...
        >
          ...
          <span className='text-body-small font-medium'>Hoạt động gần đây</span>
        </Button>
      </div>
