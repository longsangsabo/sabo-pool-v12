...
export const ClubProfileMobile: React.FC<ClubProfileMobileProps> = ({
  ...
  if (anyError) {
    return (
      <div className='min-h-screen flex flex-col items-center justify-center p-6 text-center'>
        ...
        <p className='text-body-small-muted mb-4'>{anyError}</p>
        <Button
          variant='outline'
          size='sm'
  ...
  if (!club) {
    return (
      <div className='p-6 text-center text-body-small-muted'>
    ...
    <div className='mobile-container pb-24 px-4'>
      ...
      <Card className={`${dark ? 'mobile-card-glass' : 'bg-white/80'} mb-4`}>
        <CardContent className='flex flex-col items-center p-5'>
          ...
          <h2 className='text-heading font-bold tracking-wide mobile-heading-primary'>
            {club.name}
          </h2>
