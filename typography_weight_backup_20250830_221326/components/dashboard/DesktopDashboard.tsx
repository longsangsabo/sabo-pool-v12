    ...
    React.createElement('div', {
      ...
      React.createElement(Card, {
        ...
        React.createElement('div', { key: 'content', className: "flex items-center justify-between" }, [
          React.createElement('div', { key: 'text' }, [
            React.createElement('p', {
              key: 'label',
              className: "text-body-small font-medium text-muted-foreground"
            }, "Tổng trận đấu"),
            React.createElement('p', {
              key: 'value',
          ...
          React.createElement('div', {
            key: 'icon',
            className: "p-3 bg-primary-100 dark:bg-blue-900/20 rounded-full"
          }, React.createElement(Target, { className: "w-6 h-6 text-primary-600" }))
        ]),
        React.createElement('div', { key: 'trend', className: "mt-4 flex items-center" }, [
          React.createElement(TrendingUp, { key: 'trend-icon', className: "w-4 h-4 text-success-600 mr-1" }),
          React.createElement('span', { key: 'trend-text', className: "text-body-small text-success-600" }, "+12% tuần này")
        ])
      ])),
      ...
      React.createElement(Card, {
        ...
        React.createElement('div', { key: 'content', className: "flex items-center justify-between" }, [
          ...
          React.createElement('div', {
            key: 'icon',
            className: "p-3 bg-success-100 dark:bg-green-900/20 rounded-full"
          }, React.createElement(Trophy, { className: "w-6 h-6 text-success-600" }))
        ]),
      ...
      React.createElement(Card, {
        ...
        React.createElement('div', { key: 'content', className: "flex items-center justify-between" }, [
          ...
          React.createElement('div', {
            key: 'icon',
            className: "p-3 bg-info-100 dark:bg-purple-900/20 rounded-full"
          }, React.createElement(BarChart3, { className: "w-6 h-6 text-info-600" }))
        ]),
        React.createElement('div', { key: 'rank', className: "mt-4 flex items-center" }, [
          React.createElement('span', {
            key: 'rank-text',
            className: "text-body-small-muted"
      ...
      React.createElement(Card, {
        ...
        React.createElement('div', { key: 'content', className: "flex items-center justify-between" }, [
          ...
          React.createElement('div', {
            key: 'icon',
            className: "p-3 bg-warning-100 dark:bg-orange-900/20 rounded-full"
          }, React.createElement(Flame, { className: "w-6 h-6 text-warning-600" }))
        ]),
        React.createElement('div', { key: 'status', className: "mt-4 flex items-center" }, [
          React.createElement('span', {
            key: 'status-text',
            className: "text-body-small text-success-600"
          }, "🔥 Đang lên form!")
        ])
      ]))
    ]),
        ...
        React.createElement('div', { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4" }, [
          ...
          React.createElement(Button, {
            ...
            React.createElement('div', { key: 'text', className: "flex-1" }, [
              ...
              React.createElement('p', {
                key: 'desc',
                className: "text-body-small-muted mt-1"
          ...
          React.createElement(Button, {
            key: 'join-tournament',
            variant: "outline",
            className: "h-auto p-4 justify-start text-left hover:scale-[1.02] transition-transform border-success-200 hover:bg-success-50"
          }, React.createElement('div', { className: "flex items-center gap-3 w-full" }, [
            React.createElement('div', {
              key: 'icon-container',
              className: "p-2 rounded-lg bg-success-100"
          ...
          React.createElement(Button, {
            key: 'practice',
            variant: "outline",
            className: "h-auto p-4 justify-start text-left hover:scale-[1.02] transition-transform border-orange-200 hover:bg-warning-50"
          }, React.createElement('div', { className: "flex items-center gap-3 w-full" }, [
            React.createElement('div', {
              key: 'icon-container',
              className: "p-2 rounded-lg bg-warning-100"
