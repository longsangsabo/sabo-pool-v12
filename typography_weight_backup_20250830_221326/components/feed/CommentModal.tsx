          ...
          <div className='flex items-center gap-4'>
            ...
            {!isReply && (
              <button
                ...
                className='flex items-center gap-1 text-caption text-neutral-500 hover:text-blue-500 transition-colors'
              >
            ...
            <button
              ...
              className='flex items-center gap-1 text-caption text-neutral-500 hover:text-red-500 transition-colors'
            >
