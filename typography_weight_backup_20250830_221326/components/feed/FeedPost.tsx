...
export const FeedPost: React.FC<FeedPostProps> = ({
  ...
  const renderPostContent = () => {
    switch (post.type) {
        ...
        return (
          <div className='space-y-3'>
            ...
            {post.challenge?.opponent && (
              <div className='flex items-center gap-2'>
                <span className='text-body-small text-neutral-600'>Đối thủ:</span>
          ...
          <div className='space-y-3'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <div className='text-body-small text-warning-600 font-medium'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='flex items-center gap-3'>
                <div>
                  ...
                  <div className='text-body-small text-neutral-600 text-right'>
      ...
      default:
        return <p className='text-neutral-800'>{post.content}</p>;
    }
  };
