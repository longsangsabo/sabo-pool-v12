...
export const LegacyClaimForm: React.FC<LegacyClaimFormProps> = ({ selectedEntry, onSuccess }) => {
  ...
  if (submitted) {
    return (
      <div className="text-center p-8 bg-neutral-900/95 backdrop-blur-sm rounded-xl border border-gray-700/50">
        <CheckCircle className="w-20 h-20 text-green-400 mx-auto mb-6" />
        <h3 className="text-heading font-bold text-green-400 mb-3">
          Gửi yêu cầu thành công! ✅
        </h3>
        <p className="text-gray-300 mb-6 text-body-large">
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center justify-center mb-6">
        ...
        <h2 className="text-heading font-bold text-white">Claim SPA Points</h2>
      </div>
