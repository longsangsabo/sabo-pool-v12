        ...
        {clubRegistration ? (
          <div className='space-y-4'>
            <div className='flex items-center justify-between'>
              ...
              <span
                className={`inline-flex items-center px-3 py-1 rounded-full text-body-small font-medium ${getStatusColor(clubRegistration.status)}`}
              >
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
        ...
        <div className='bg-white rounded-lg shadow-sm border p-6'>
          <div className='text-center mb-6'>
            <h3 className='text-title font-semibold text-neutral-900'>CLB Cơ bản</h3>
            <div className='mt-4'>
          ...
          <ul className='space-y-3 mb-6'>
            ...
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Quản lý thành viên</span>
            </li>
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Tổ chức giải đấu</span>
            </li>
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Thống kê cơ bản</span>
            </li>
            <li className='flex items-center'>
        ...
        <div className='bg-white rounded-lg shadow-sm border-2 border-purple-500 p-6 relative'>
          <div className='absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/2'>
            <span className='bg-info-500 text-white px-3 py-1 rounded-full text-caption font-medium'>
              Khuyến nghị
            </span>
          </div>

          <div className='text-center mb-6'>
            <h3 className='text-title font-semibold text-neutral-900'>CLB Premium</h3>
            <div className='mt-4'>
          ...
          <ul className='space-y-3 mb-6'>
            ...
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Hệ thống đặt bàn</span>
            </li>
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Thống kê nâng cao</span>
            </li>
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
              <span className='text-body-small text-neutral-600'>Marketing tools</span>
            </li>
            <li className='flex items-center'>
              <Check className='w-4 h-4 text-green-500 mr-3' />
