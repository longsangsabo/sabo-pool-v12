              ...
              <div className="flex items-start gap-3">
                ...
                >
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {/* Timestamp */}
                    <span className="text-caption-muted ml-auto whitespace-nowrap">
                  ...
                  {/* Subject */}
                  {message.subject && (
                    <h4 className={`text-body-small font-medium mb-1 truncate ${
                  ...
                  {/* Content Preview */}
                  <p className="text-body-small text-neutral-600 line-clamp-2">
                    {message.content}
                  </p>
