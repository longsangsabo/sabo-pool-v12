        ...
        {[...Array(8)].map((_, i) => (
          <Card
            ...
            className={`animate-pulse overflow-hidden ${
              theme === 'dark'
                ? 'bg-neutral-800/60 border-gray-700/50'
    ...
    return (
      ...
      >
        <CardContent className='p-8 text-center'>
          <p
            className={`${theme === 'dark' ? 'text-red-400' : 'text-error-600'}`}
          >
            {error}
          </p>
        </CardContent>
                ...
                <CardContent className='p-3'>
                  <div className='flex items-center space-x-3'>
                    ...
                    <div className='flex-1 min-w-0'>
                      <p
                        className={`font-semibold truncate transition-colors duration-200 ${
                          theme === 'dark' ? 'text-gray-100' : 'text-neutral-900'
                        }`}
                      >
                      ...
                      <div className='flex items-center gap-2 mt-1'>
                        <Badge
                          variant='secondary'
                          className={`text-caption px-2 py-0.5 transition-all duration-200 ${getRankBadgeColor(player.current_rank)}`}
                        >
                    ...
                    <div className='text-right'>
                      <p
                        className={`text-body-large font-bold transition-colors duration-200 ${
                          activeTab === 'elo'
                            ? theme === 'dark'
                              ? 'text-blue-400'
                              : 'text-primary-600'
