            ...
            <div className="space-y-4 text-left">
              ...
              <div className="space-y-3 p-3 bg-muted/30 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-body-small font-medium">Đối thủ:</span>
                  <span className="text-body-small">{challenge.challenger_name || 'Ẩn danh'}</span>
                </div>
                
                <div className="flex items-center gap-2">
                  <Trophy className="h-4 w-4 text-yellow-500" />
                  <span className="text-body-small font-medium">Loại:</span>
                ...
                <div className="flex items-center gap-2">
                  <span className="text-body-small font-medium">Định dạng:</span>
                ...
                {challenge.bet_points && challenge.bet_points > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-body-small font-medium">SPA cược:</span>
                ...
                {challenge.scheduled_time && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-body-small font-medium">Thời gian:</span>
                ...
                {challenge.description && (
                  <div className="space-y-1">
                    <span className="text-body-small font-medium">Mô tả:</span>
                    <p className="text-caption-muted bg-background p-2 rounded">
                      {challenge.description}
                    </p>
                  </div>
                )}
