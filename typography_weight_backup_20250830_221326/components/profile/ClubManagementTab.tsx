        ...
        <Card className='bg-card dark:bg-card border-border dark:border-border'>
          <CardContent className='pt-6'>
            <div className='text-center mb-6'>
              ...
              <h2 className='text-heading font-bold text-card-foreground dark:text-card-foreground mb-2'>
                Đăng ký Câu lạc bộ
              </h2>
            ...
            <Card className='bg-secondary/10 dark:bg-secondary/20 border-secondary/30 dark:border-secondary/40'>
              <CardContent className='pt-6'>
                <div className='flex items-center justify-between mb-4'>
                  <div>
                    <h3 className='text-body-large font-semibold text-card-foreground dark:text-card-foreground'>
                      Quản lý thông tin CLB
                    </h3>
                    <p className='text-body-small-muted dark:text-muted-foreground'>
