      ...
      <Card>
        <CardContent className='p-6 text-center'>
          <div className='text-red-500 mb-4'>
            ...
            <p className='text-body-small-muted'>{error}</p>
          </div>
  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        <div>
          <h2 className='text-heading font-bold'>Hệ thống Hạng SPA</h2>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Tổng trận đấu</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Trận thắng</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className='p-4'>
            <div className='text-center'>
              ...
              <p className='text-body-small-muted'>Tỷ lệ thắng</p>
            </div>
          </CardContent>
        </Card>
      </div>
