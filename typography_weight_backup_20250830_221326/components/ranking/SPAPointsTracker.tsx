        ...
        <CardContent>
          ...
          <div className='mt-6 p-4 bg-muted rounded-lg'>
            <div className='flex justify-between items-center mb-2'>
              <span className='text-body-small font-medium'>Thách đấu hôm nay</span>
              ...
              return (
                <div key={source} className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span
                      className={`font-semibold ${points >= 0 ? 'text-success-600' : 'text-error-600'}`}
                    >
                      {points >= 0 ? '+' : ''}
          ...
          <div className='space-y-3'>
            {recentEntries.slice(0, 5).map(entry => (
              ...
              >
                ...
                <span
                  className={`font-semibold ${entry.points_earned >= 0 ? 'text-success-600' : 'text-error-600'}`}
                >
