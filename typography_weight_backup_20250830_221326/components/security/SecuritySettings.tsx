...
export const SecuritySettings: React.FC<SecuritySettingsProps> = ({
  ...
  const getSecurityLevel = (score: number) => {
    if (score >= 80)
      return { level: 'Cao', color: 'bg-success-100 text-success-800' };
    if (score >= 60)
      return { level: 'Trung bình', color: 'bg-warning-100 text-warning-800' };
    return { level: 'Thấp', color: 'bg-error-100 text-error-800' };
  };
        ...
        <CardContent>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            <div className='text-center'>
              ...
              <div className='text-body-small text-neutral-600'>Điểm bảo mật</div>
            </div>
            <div className='text-center'>
              <Badge className={securityLevel.color}>
                {securityLevel.level}
              </Badge>
              <div className='text-body-small text-neutral-600 mt-1'>Mức độ bảo mật</div>
            </div>
            <div className='text-center'>
              <div className='text-3xl font-bold text-success-600'>3</div>
          ...
          {settings.twoFactorEnabled && (
            <div className='p-4 bg-primary-50 rounded-lg'>
              <div className='flex items-center gap-2 mb-2'>
                ...
                <span className='text-body-small font-medium text-primary-800'>
        ...
        <CardContent className='space-y-4'>
          <div className='space-y-3'>
            <div className='flex items-center justify-between p-3 bg-neutral-50 rounded-lg'>
              ...
              <Badge className='bg-success-100 text-success-800'>Hiện tại</Badge>
            </div>
