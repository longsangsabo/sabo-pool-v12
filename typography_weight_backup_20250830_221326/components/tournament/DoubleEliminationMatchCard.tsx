      ...
      <CardContent className='p-4'>
        ...
        <div className='flex items-center justify-between mb-3'>
          <div className='flex items-center gap-2'>
            <Badge variant='outline' className='px-2 py-1 text-caption font-medium'>
              Trận {match.match_number}
            </Badge>
            {match.bracket_type && (
              <Badge
                variant='outline'
                className={`px-2 py-1 text-caption font-medium ${bracketInfo.color} ${bracketInfo.bgColor} ${bracketInfo.borderColor}`}
              >
                {bracketInfo.icon}
          ...
          {(match.assigned_table?.table_number ||
            ...
            <div className='bg-emerald-500 text-white px-2 py-0.5 rounded-full text-caption font-medium'>
              Bàn{' '}
              {match.assigned_table?.table_number ||
                match.assigned_table_number}
            </div>
        ...
        <div className='space-y-2'>
          ...
          <div
            className={`p-2 rounded-lg border-l-2 ${
              match.player1
                ? 'bg-primary-50/50 border-blue-400'
              ...
              {match.player1 ? (
                <div className='flex items-center gap-2 flex-1'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <div className='font-medium text-body-small truncate flex items-center gap-1'>
                      {match.player1.display_name || match.player1.full_name}
                      <span className='text-caption bg-primary text-primary-foreground px-1.5 py-0.5 rounded font-medium'>
            ...
            {canInputScore && (
              <div className='mt-2 flex items-center gap-2'>
                ...
                <input
                  ...
                  min='0'
                  max='50'
                  className='w-16 px-2 py-1 border border-primary-300 rounded text-center text-body-small font-medium bg-white focus:outline-none focus:ring-1 focus:ring-blue-500'
                  placeholder='0'
                  value={player1Score}
          ...
          <div className='flex items-center justify-center'>
            <div className='bg-primary text-primary-foreground px-2 py-0.5 rounded-full text-caption font-medium'>
              VS
            </div>
          </div>
          ...
          <div
            className={`p-2 rounded-lg border-l-2 ${
              match.player2
                ? 'bg-info-50/50 border-purple-400'
                : 'bg-muted/30 border-muted-foreground'
          ...
          >
            ...
            {canInputScore && (
              <div className='mt-2 flex items-center gap-2'>
                <span className='text-caption font-medium text-info-700'>
                  Tỷ số:
                </span>
                <input
                  type='number'
                  min='0'
                  max='50'
                  className='w-16 px-2 py-1 border border-purple-300 rounded text-center text-body-small font-medium bg-white focus:outline-none focus:ring-1 focus:ring-purple-500'
                  placeholder='0'
                  value={player2Score}
