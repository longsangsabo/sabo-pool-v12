  ...
  return (
    <div className='space-y-6'>
      <div className='text-center'>
        <h3 className='text-body-large font-semibold text-neutral-900 mb-2'>
          Cơ cấu giải thưởng
        </h3>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
                ...
                {award.cashPrize > 0 && (
                  <div className='flex items-center gap-2'>
                    <div className='w-8 h-8 bg-success-100 rounded-full flex items-center justify-center'>
                      <span className='text-success-600 text-body-small font-semibold'>
                        ₫
                      </span>
                    </div>
                    <div>
                      <div className='text-body-small text-neutral-500'>Tiền thưởng</div>
                ...
                {award.spaPoints > 0 && (
                  <div className='flex items-center gap-2'>
                    <div className='w-8 h-8 bg-primary-100 rounded-full flex items-center justify-center'>
                      <span className='text-primary-600 text-caption font-semibold'>
                        SPA
                      </span>
                    </div>
                    <div>
                      <div className='text-body-small text-neutral-500'>Điểm SPA</div>
                ...
                {award.eloPoints > 0 && (
                  <div className='flex items-center gap-2'>
                    <div className='w-8 h-8 bg-info-100 rounded-full flex items-center justify-center'>
                      <span className='text-info-600 text-caption font-semibold'>
                        ELO
                      </span>
                    </div>
                    <div>
                      <div className='text-body-small text-neutral-500'>Điểm ELO</div>
                ...
                {award.physicalPrizes.length > 0 && (
                  <div className='flex items-center gap-2'>
                    ...
                    <div>
                      <div className='text-body-small text-neutral-500'>Hiện vật</div>
                      <div className='text-body-small font-medium text-warning-600'>
      ...
      {awards.length === 0 && (
        <div className='text-center py-8'>
          ...
          <p className='text-neutral-500'>Chưa có thông tin giải thưởng</p>
        </div>
      )}
    </div>
  );
