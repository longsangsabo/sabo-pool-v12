  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'registration_closed':
        return 'bg-primary-500/20 text-primary-700 border-primary-200';
      case 'completed':
        return 'bg-info-500/20 text-info-700 border-purple-200';
      default:
  ...
  return (
    <Card className='bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-2'>
            ...
            {isConnected && (
              <Badge
                variant='outline'
                className='bg-success-500/20 text-success-700 border-success-200'
              >
      ...
      <CardContent className='space-y-6'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
          <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
            ...
            <div>
              ...
              <div className='text-caption-muted'>Matches Done</div>
            </div>
          </div>
          ...
          <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
            ...
            <div>
              <div className='text-body-small font-medium'>{readyMatches}</div>
              <div className='text-caption-muted'>Ready to Play</div>
            </div>
          </div>
          ...
          <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
            ...
            <div>
              ...
              <div className='text-caption-muted'>Need Players</div>
            </div>
          </div>
          ...
          <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
            ...
            <div>
              <div className='text-body-small font-medium'>{progressPercentage}%</div>
              <div className='text-caption-muted'>Progress</div>
            </div>
          </div>
        </div>
        ...
        {/* Progress Bar */}
        <div>
          <div className='flex justify-between text-body-small-muted mb-2'>
        ...
        <div className='flex flex-wrap gap-3'>
          ...
          {needsRecovery && (
            <Button
              ...
              variant='outline'
              className='border-orange-200 text-warning-700 hover:bg-warning-50'
            >
              {isRecovering ? (
                <div className='flex items-center gap-2'>
        ...
        {/* Warnings */}
        {needsRecovery && (
          <div className='p-3 bg-warning-50 dark:bg-orange-900/20 rounded-lg border border-orange-200'>
            <div className='flex items-start gap-2'>
              <AlertTriangle className='h-4 w-4 text-warning-600 mt-0.5' />
              <div>
                <div className='text-body-small font-medium text-orange-800 dark:text-orange-200'>
