      ...
      <CardContent className="p-6">
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <h3 className="text-body-large font-semibold text-foreground mb-2">{tournament.name}</h3>
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-body-small-muted">ELO: {player.elo || 1000}</p>
                          </div>
                        </div>
                        {selectedPlayers.some(p => p.id === player.id) && (
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-4 text-body-small-muted">
        ...
        <Card className="bg-gradient-primary text-primary-foreground">
          <CardContent className="p-4 text-center">
            <div className="flex items-center justify-center gap-2 mb-2">
              ...
              <h1 className="text-heading font-bold">{selectedTournament.name}</h1>
            </div>
            ...
            <Tabs value={detailActiveTab === 'overview' || detailActiveTab === 'generate' || detailActiveTab === 'automation' ? 'bracket' : detailActiveTab} 
              ...
              <TabsContent value="bracket" className="space-y-4">
                <div className="text-center py-2">
                  <h3 className="text-body-large font-semibold mb-2">Sơ đồ giải đấu</h3>
                </div>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="text-center p-3 bg-warning-50 rounded-lg border border-yellow-200">
                          ...
                          <div className="text-body-small-muted">Tổng người chơi</div>
                        </div>
                        <div className="text-center p-3 bg-primary-50 rounded-lg border border-primary-200">
                          ...
                          <div className="text-body-small-muted">Tổng số trận</div>
                        </div>
                        <div className="text-center p-3 bg-success-50 rounded-lg border border-success-200">
                          ...
                          <div className="text-body-small-muted">Hoàn thành</div>
                        </div>
                        <div className="text-center p-3 bg-info-50 rounded-lg border border-purple-200">
                          ...
                          <div className="text-body-small-muted">Ngày tạo</div>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
          ...
          {filteredTournaments.length === 0 ? (
            <Card>
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <h3 className="text-body-large font-semibold mb-2">Chưa có giải đấu nào</h3>
