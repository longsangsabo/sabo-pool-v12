...
export const TournamentMatchManager: React.FC<TournamentMatchManagerProps> = ({
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'scheduled':
        return 'bg-warning-500/20 text-warning-700 border-orange-200';
      default:
        ...
        <CardContent>
          <div className='grid grid-cols-2 md:grid-cols-5 gap-4'>
            <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
              ...
              <div>
                <div className='text-body-small font-medium'>{stats.total}</div>
                <div className='text-caption-muted'>Total</div>
              </div>
            </div>
            ...
            <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
              ...
              <div>
                <div className='text-body-small font-medium'>{stats.completed}</div>
            ...
            <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
              ...
              <div>
                <div className='text-body-small font-medium'>{stats.ready}</div>
                <div className='text-caption-muted'>Ready</div>
              </div>
            </div>
            ...
            <div className='flex items-center gap-2 p-3 bg-white/50 rounded-lg'>
              ...
              <div>
                <div className='text-body-small font-medium'>{stats.ongoing}</div>
                <div className='text-caption-muted'>Live</div>
              </div>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className='p-4'>
          <div className='flex flex-wrap items-center gap-4'>
            ...
            <div className='flex items-center gap-2'>
              ...
              <span className='text-body-small font-medium'>Round:</span>
              <Tabs
            ...
            {/* Status Filter */}
            <div className='flex items-center gap-2'>
              <span className='text-body-small font-medium'>Status:</span>
