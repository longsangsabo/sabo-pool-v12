        ...
        <CardContent>
          <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
            <div className='text-center'>
              ...
              <div className='text-body-small-muted'>Đã xác nhận</div>
            </div>
            <div className='text-center'>
              <div className='text-heading font-bold text-warning-600'>
                {pendingRegistrations.length}
              </div>
              <div className='text-body-small-muted'>Chờ xác nhận</div>
            </div>
            <div className='text-center'>
              <div className='text-heading font-bold text-primary-600'>
                {waitlistRegistrations.length}
              </div>
              <div className='text-body-small-muted'>Danh sách chờ</div>
            </div>
            <div className='text-center'>
              <div className='text-heading font-bold text-muted-foreground'>
                {maxParticipants - confirmedRegistrations.length}
              </div>
              <div className='text-body-small-muted'>Còn lại</div>
            </div>
          </div>
              ...
              {confirmedRegistrations.map((registration, index) => (
                ...
                >
                  <div className='flex items-center gap-3'>
                    <div className='text-body-small font-medium text-muted-foreground w-8'>
                      #{index + 1}
                    </div>
