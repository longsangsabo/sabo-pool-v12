    ...
    <div className='space-y-3'>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption font-medium'>Số người tham gia</Label>
        </div>
        ...
        <div className='grid grid-cols-4 gap-1'>
          {PARTICIPANT_SLOTS.map(slot => (
            ...
            >
              ...
              <div className='text-caption-muted'>người</div>
            </button>
          ))}
        </div>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption font-medium'>Giới hạn hạng tham gia</Label>
        </div>

        <div className='space-y-3'>
          <div className='grid grid-cols-2 gap-3'>
            <div className='space-y-1'>
              <Label className='text-caption-muted'>
                Hạng thấp nhất
              </Label>
              <select
                ...
                className='w-full h-8 px-2 text-body-small border border-border rounded bg-background hover:bg-muted/50 focus:border-primary focus:outline-none'
              >
          ...
          {(watchedData.min_rank_requirement ||
            ...
            <div className='p-2 bg-primary-50/50 rounded border border-primary-200'>
              <div className='flex items-center gap-1 text-caption text-primary-700'>
                <Info className='h-3 w-3' />
                <span>
                  {watchedData.min_rank_requirement &&
                  watchedData.max_rank_requirement
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption font-medium'>Hình thức thi đấu</Label>
        </div>
        ...
        <div className='grid grid-cols-2 gap-2'>
          {Object.entries(TOURNAMENT_FORMATS).map(([key, label]) => (
            ...
            >
              <div className='text-body-small font-medium'>{label}</div>
      ...
      <div className='space-y-2'>
        <div className='flex items-center gap-2'>
          ...
          <Label className='text-caption font-medium'>Môn thi đấu</Label>
        </div>
      ...
      {watchedData.tournament_type === 'single_elimination' && (
        <div className='space-y-3'>
          <div className='flex items-center gap-2'>
            ...
            <Label className='text-body-small font-medium'>Cài đặt nâng cao</Label>
          </div>
          ...
          {watchedData.has_third_place_match && (
            <div className='flex items-center gap-2 text-body-small-muted ml-6'>
