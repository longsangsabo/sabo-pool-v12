    ...
    <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className={`h-7 text-caption ${className}`}
        >
          {isLoading ? (
          ...
          tournaments.map((tournament) => (
            ...
            >
              <div className="flex items-center justify-between w-full">
                <div className="font-medium text-body-small truncate flex-1 mr-2">
                  {tournament.name}
                </div>
              ...
              <div className="flex items-center justify-between w-full text-caption-muted">
        ...
        {tournaments.length > 0 && (
          <>
            ...
            <DropdownMenuItem 
              ...
              disabled={isLoading}
              className="justify-center text-caption-muted"
            >
              {isLoading ? (
                <RefreshCw className="h-3 w-3 mr-1 animate-spin" />
              ) : (
