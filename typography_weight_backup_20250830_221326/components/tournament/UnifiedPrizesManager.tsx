          ...
          <div className="flex items-center justify-between text-body-small">
            <div className="flex items-center gap-4">
              <span className="text-muted-foreground">
                Tổng giải thưởng: <span className="font-semibold text-success-600">{formatCurrency(totalPrizePool)}</span>
              </span>
              <span className="text-muted-foreground">
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-body-small font-medium">Tóm tắt tài chính</span>
            </div>
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="text-body-small-muted mt-1">
                ...
                <div className="mt-2 text-caption-muted">
