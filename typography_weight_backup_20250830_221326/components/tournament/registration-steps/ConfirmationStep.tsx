  ...
  return (
    <div className='space-y-6'>
      ...
      <div className='text-center space-y-4'>
        ...
        <div>
          <h3 className='text-heading font-bold text-success-700 dark:text-green-400 mb-2'>
            {status.title}
          </h3>
        ...
        <CardContent className='space-y-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='space-y-3'>
              <div>
                <p className='text-body-small-muted'>Tên giải:</p>
                <p className='font-medium'>{selectedTournament?.name}</p>
              </div>

              <div>
                <p className='text-body-small-muted'>Thời gian:</p>
            ...
            <div className='space-y-3'>
              <div>
                <p className='text-body-small-muted'>Hạng giải:</p>
              ...
              <div>
                <p className='text-body-small-muted'>Phí tham gia:</p>
                <p className='font-medium flex items-center gap-2'>
              ...
              <div>
                <p className='text-body-small-muted'>Giải thưởng:</p>
                <p className='font-medium flex items-center gap-2'>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='space-y-3'>
              <div>
                <p className='text-body-small-muted'>Họ tên:</p>
                <p className='font-medium'>{watchedData.player_name}</p>
              </div>

              <div>
                <p className='text-body-small-muted'>Số điện thoại:</p>
                <p className='font-medium flex items-center gap-2'>
              ...
              {watchedData.email && (
                <div>
                  <p className='text-body-small-muted'>Email:</p>
                  <p className='font-medium flex items-center gap-2'>
            ...
            <div className='space-y-3'>
              <div>
                <p className='text-body-small-muted'>Hạng hiện tại:</p>
              ...
              <div>
                <p className='text-body-small-muted'>Tuổi:</p>
                <p className='font-medium'>{watchedData.age} tuổi</p>
              </div>

              <div>
                <p className='text-body-small-muted'>Kinh nghiệm:</p>
          ...
          {watchedData.notes && (
            <>
              <Separator />
              <div>
                <p className='text-body-small-muted mb-2'>Ghi chú:</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-3'>
            ...
            <div className='flex justify-between items-center'>
              <span className='text-body-small-muted'>Trạng thái:</span>
              <Badge
      ...
      {/* Contact Support */}
      <div className='text-center text-body-small-muted'>
        <p>
