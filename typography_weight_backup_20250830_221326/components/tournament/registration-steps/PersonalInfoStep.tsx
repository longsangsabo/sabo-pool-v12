  ...
  return (
    <div className='space-y-6'>
      <div className='text-center'>
        <h3 className='text-body-large font-semibold mb-2'>Thông tin cá nhân</h3>
      ...
      <Card>
        ...
        <CardContent className='space-y-4'>
          ...
          <div className='space-y-2'>
            <Label htmlFor='player_name' className='text-body-small font-medium'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <div className='space-y-2'>
              <Label
                htmlFor='phone'
                className='text-body-small font-medium flex items-center gap-2'
              >
