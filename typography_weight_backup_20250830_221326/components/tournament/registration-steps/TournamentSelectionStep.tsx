...
> = ({
  ...
  return (
    <div className='space-y-6'>
      <div className='text-center'>
        <h3 className='text-body-large font-semibold mb-2'>Chọn giải đấu tham gia</h3>
            ...
            >
              ...
              <CardContent className='space-y-4'>
                {tournament.description && (
                  <p className='text-body-small-muted line-clamp-2'>
                    {tournament.description}
                  </p>
                )}
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-caption-muted'>
                  <div className='flex items-center gap-2'>
                ...
                {isSelected && (
                  <div className='mt-4 p-3 bg-primary/5 rounded-lg border border-primary/20'>
                    <div className='flex items-center gap-2 text-body-small font-medium text-primary'>
