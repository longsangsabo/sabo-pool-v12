      ...
      <CardContent className="space-y-4">
        ...
        {analysis && (
          <div className="space-y-3 mt-4">
            <div className="text-body-small font-semibold text-warning-700 dark:text-orange-300">
              Analysis Results:
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div>
                <div className="text-caption font-medium mb-2">Group A Finals:</div>
              ...
              <div>
                <div className="text-caption font-medium mb-2">Group B Finals:</div>
            ...
            <div>
              <div className="text-caption font-medium mb-2">Cross-Bracket Status:</div>
            ...
            {analysis.fixesApplied.length > 0 && (
              <div>
                <div className="text-caption font-medium mb-2">Fixes Applied:</div>
                <div className="space-y-1">
                  {analysis.fixesApplied.map((fix: string, index: number) => (
                    <div key={index} className={`text-caption p-2 rounded border ${
                      fix.startsWith('✅') 
