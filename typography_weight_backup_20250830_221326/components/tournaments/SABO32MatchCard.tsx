    ...
    <Card className={cn(
      ...
      {isOptimistic && (
        <div className="absolute inset-0 bg-primary-500/10 rounded-lg flex items-center justify-center z-10">
          <div className="bg-primary-600 dark:bg-primary-500 text-white px-2 py-1 rounded text-caption font-medium">
            Đang cập nhật...
          </div>
        </div>
      )}
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <CardTitle className="text-body-small font-semibold text-foreground">
            {optimisticMatch.sabo_match_id}
          </CardTitle>
          <div className="flex items-center gap-2">
            <Badge variant="outline" className="text-caption border-border">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-3 items-center gap-4">
            ...
            <div className={cn(
              ...
              <div className="font-medium text-body-small text-foreground">{player1Name}</div>
              {isCompleted && (
                <div className="text-body-large font-bold mt-1 text-foreground">{optimisticMatch.score_player1 || 0}</div>
              )}
            </div>
            ...
            <div className="text-center">
              {canSubmitScore && isEditing ? (
                <div className="flex items-center gap-1">
                  ...
                  />
                  <span className="text-caption font-semibold text-muted-foreground">vs</span>
                  <Input
                    type="number"
                    min="0"
                    max="99"
                ...
                <div className="text-caption font-semibold text-muted-foreground">VS</div>
              )}
            </div>
            ...
            <div className={cn(
              ...
              <div className="font-medium text-body-small text-foreground">{player2Name}</div>
              {isCompleted && (
                <div className="text-body-large font-bold mt-1 text-foreground">{optimisticMatch.score_player2 || 0}</div>
              )}
            </div>
          </div>
          ...
          {/* Match Info */}
          <div className="text-caption-muted text-center pt-2 border-t border-border">
