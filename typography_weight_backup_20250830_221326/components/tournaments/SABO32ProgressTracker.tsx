      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-heading font-bold">{stats.completedMatches}</div>
            <div className="text-body-small-muted">Completed</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-heading font-bold">{stats.pendingMatches}</div>
            <div className="text-body-small-muted">Ready</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-heading font-bold">{Math.round(stats.averageMatchDuration)}</div>
            <div className="text-body-small-muted">Avg Min/Match</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small-muted">Est. Complete</div>
          </CardContent>
        </Card>
      </div>
