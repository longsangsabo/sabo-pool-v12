    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="p-2 bg-success-50 dark:bg-green-900/20 rounded-lg">
            <div className="text-body-large font-bold text-success-600">{completedMatches}</div>
            <div className="text-caption-muted">Completed</div>
          </div>
          <div className="p-2 bg-warning-50 dark:bg-orange-900/20 rounded-lg">
            <div className="text-body-large font-bold text-warning-600">{pendingMatches}</div>
            <div className="text-caption-muted">Pending</div>
          </div>
          <div className="p-2 bg-primary-50 dark:bg-blue-900/20 rounded-lg">
            <div className="text-body-large font-bold text-primary-600">{Math.round(progressPercentage)}%</div>
        ...
        <div className="space-y-2">
          ...
          <Button
            ...
            disabled={isProcessing}
            className="w-full text-info-600 border-purple-300 hover:bg-info-50"
          >
          ...
          <Button
            ...
            disabled={isProcessing}
            className="w-full text-error-600 border-red-300 hover:bg-error-50"
          >
        ...
        <div className="space-y-2">
          ...
          {pendingMatches > 0 && (
            <div className="flex items-center gap-2 text-body-small text-warning-600">
          ...
          {progressPercentage === 100 && (
            <div className="flex items-center gap-2 text-body-small text-success-600">
