      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            <div className="text-heading font-bold text-primary-600">{tournamentStats.pendingMatches}</div>
            <div className="text-body-small-muted">Pending Matches</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small-muted">Avg Duration</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small-muted">Est. Remaining</div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-body-small-muted">Live Matches</div>
          </CardContent>
        </Card>
      </div>
