        ...
        <Card className="border-yellow-400 bg-gradient-to-r from-yellow-50 to-amber-50">
          <CardContent className="p-6">
            <div className="text-center">
              ...
              <div className="text-heading font-semibold text-neutral-800">
                {champion.name}
              </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-heading font-bold">{champion ? 1 : 0}</div>
            <div className="text-body-small-muted">Champion</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <Users className="w-8 h-8 mx-auto mb-2 text-blue-500" />
            <div className="text-heading font-bold">{standings.length}</div>
            <div className="text-body-small-muted">Players</div>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-4 text-center">
            <Star className="w-8 h-8 mx-auto mb-2 text-green-500" />
            <div className="text-heading font-bold">{completedMatches}</div>
        ...
        <Card>
          <CardContent className="p-4 text-center">
            ...
            <div className="text-heading font-bold">{totalMatches}</div>
            <div className="text-body-small-muted">Total Matches</div>
          </CardContent>
        </Card>
      </div>
    </div>
