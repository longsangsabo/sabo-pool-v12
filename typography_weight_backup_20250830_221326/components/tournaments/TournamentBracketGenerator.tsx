        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            >
              ...
              <span className="text-caption-muted">Shuffle players randomly</span>
            </Button>
            ...
            >
              ...
              <span className="text-caption-muted">Rank by skill level</span>
            </Button>
          </div>
        </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='grid grid-cols-1 gap-3 sm:grid-cols-2'>
                ...
                >
                  ...
                  <span className="text-caption-muted">Shuffle selected players</span>
                </Button>
                ...
                >
                  ...
                  <span className="text-caption-muted">Order by ELO rating</span>
                </Button>
              </div>
                  ...
                  <div className='max-h-40 overflow-y-auto space-y-2 p-3 bg-muted/30 rounded-lg border'>
                    {generatedBracket.map((match, index) => (
                      <div key={index} className='flex items-center justify-between p-2 bg-background rounded border text-sm'>
                        <div className="flex items-center gap-2">
                          <div className="w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center text-caption font-medium">
                            {match.match_number}
                          </div>
