...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const [step, setStep] = useState<
    'select' | 'details' | 'confirm' | 'processing' | 'success' | 'error'
  >('select');
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (selectedMethod === 'qr_code') {
        setQrCodeUrl(
          'https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=payment_qr_code_data'
        );
      }
    ...
    switch (step) {
        ...
        return (
          <div className='space-y-4'>
            <div className='text-center mb-6'>
              <h3 className='text-body-large font-medium mb-2'>{getTypeTitle()}</h3>
              <div className='text-heading font-bold text-primary-600'>
              ...
              {paymentMethods.map(method => (
                ...
                >
                  <CardContent className='p-4'>
                    ...
                    <div className='space-y-2 text-body-small text-neutral-600'>
                      ...
                      <div>
                        Giới hạn: {formatCurrency(method.minAmount)} -{' '}
      ...
      case 'details':
        ...
        return (
          <div className='space-y-4'>
            <div className='text-center mb-6'>
              <h3 className='text-body-large font-medium mb-2'>Thông tin thanh toán</h3>
              <div className='flex items-center justify-center gap-2 text-body-small text-neutral-600'>
            ...
            <form onSubmit={handleFormSubmit} className='space-y-4'>
              {selectedMethod === 'bank_transfer' && (
                <>
                  <div>
                    <label className='block text-body-small font-medium text-neutral-700 mb-2'>
                      Số tài khoản
                    </label>
                    <Input
      ...
      case 'confirm':
        ...
        return (
          <div className='space-y-4'>
            <div className='text-center mb-6'>
              <h3 className='text-body-large font-medium mb-2'>Xác nhận thanh toán</h3>
            </div>
            ...
            <div className='bg-primary-50 p-4 rounded-lg'>
              <div className='flex items-center gap-2 mb-2'>
                ...
                <span className='font-medium text-primary-800'>Lưu ý</span>
              </div>
              <p className='text-body-small text-primary-700'>
                Vui lòng kiểm tra kỹ thông tin trước khi xác nhận. Giao dịch sẽ
                được xử lý trong {method?.processingTime}.
              </p>
            </div>
      ...
      case 'processing':
        return (
          <div className='text-center py-8'>
            ...
            <h3 className='text-body-large font-medium mb-2'>Đang xử lý thanh toán</h3>
            <p className='text-neutral-600'>Vui lòng chờ trong giây lát...</p>
          </div>
        );
      ...
      case 'success':
        return (
          <div className='text-center py-8'>
            ...
            <h3 className='text-body-large font-medium mb-2'>Thanh toán thành công!</h3>
      ...
      case 'error':
        return (
          <div className='text-center py-8'>
            ...
            <h3 className='text-body-large font-medium mb-2'>Thanh toán thất bại</h3>
            <p className='text-neutral-600 mb-4'>
