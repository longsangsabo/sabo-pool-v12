      ...
      <DialogContent className='max-w-md'>
        ...
        <div className='space-y-6'>
          ...
          <div className='bg-primary-50 p-4 rounded-lg'>
            <div className='text-body-small text-primary-600 mb-1'>Số dư hiện tại</div>
            <div className='text-heading font-bold text-primary-800'>
          ...
          <div className='space-y-3'>
            ...
            {amount && !isValidAmount() && (
              <div className='flex items-center gap-2 text-body-small text-error-600'>
          ...
          {selectedUser && amount && isValidAmount() && (
            <div className='bg-neutral-50 p-4 rounded-lg space-y-2'>
              <div className='text-body-small font-medium text-neutral-700'>
                Tóm tắt giao dịch:
              </div>
