        ...
        <div className='min-h-screen bg-gradient-to-br from-primary/20 via-background to-secondary/20 flex items-center justify-center p-4'>
          <Card className='w-full max-w-md shadow-2xl border-0 bg-card/95 backdrop-blur-sm text-center'>
            <CardHeader className='space-y-4'>
              ...
              <CardTitle className='text-heading font-bold text-success-600'>
                Email đã được gửi!
              </CardTitle>
              <CardDescription>
            ...
            <CardContent className='space-y-4'>
              ...
              <button
                ...
                className='text-body-small-muted hover:text-foreground'
              >
                Gửi lại email
              </button>
            </CardContent>
      ...
      <div className='min-h-screen bg-gradient-to-br from-primary/20 via-background to-secondary/20 flex items-center justify-center p-4'>
        <Card className='w-full max-w-md shadow-2xl border-0 bg-card/95 backdrop-blur-sm'>
          <CardHeader className='text-center space-y-4'>
            ...
            <div>
              <CardTitle className='text-heading font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent'>
                {getPageTitle()}
              </CardTitle>
          ...
          <CardFooter className='flex flex-col space-y-4 text-center'>
            ...
            <Link
              to='/'
              className='text-body-small-muted hover:text-foreground transition-colors'
            >
              ← Về trang chủ
            </Link>
          </CardFooter>
