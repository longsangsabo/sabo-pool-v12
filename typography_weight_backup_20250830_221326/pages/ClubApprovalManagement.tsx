      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-body-small text-neutral-600 dark:text-gray-400">Chờ phê duyệt</p>
                <p className="text-heading font-bold text-info-600">{mockPendingApprovals.length}</p>
              </div>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-body-small text-neutral-600 dark:text-gray-400">Đã phê duyệt hôm nay</p>
                <p className="text-heading font-bold text-success-600">8</p>
              </div>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-body-small text-neutral-600 dark:text-gray-400">Tranh chấp</p>
                <p className="text-heading font-bold text-error-600">2</p>
              </div>
        ...
        <Card>
          <CardContent className="pt-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-body-small text-neutral-600 dark:text-gray-400">SPA đã chuyển</p>
                <p className="text-heading font-bold text-primary-600">2,450</p>
              </div>
          ...
          {mockPendingApprovals.length > 0 ? (
            ...
            <Card>
              <CardContent className="text-center py-12">
                ...
                <h3 className="text-body-large font-medium text-neutral-900 dark:text-gray-100 mb-2">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-body-small text-neutral-600 dark:text-gray-400">
