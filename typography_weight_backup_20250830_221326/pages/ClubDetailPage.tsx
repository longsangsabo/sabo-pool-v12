    ...
    return (
      <div className='min-h-screen flex items-center justify-center'>
        <div className='text-center'>
          ...
          <h2 className='text-title font-semibold text-neutral-900 mb-2'>
                          ...
                          >
                            <div className='flex items-center space-x-3'>
                              ...
                              <div>
                                ...
                                <div className='flex items-center space-x-2 text-body-small text-neutral-600'>
                          ...
                          >
                            <div className='flex items-start justify-between'>
                              <div className='flex-1'>
                                ...
                                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-body-small text-neutral-600'>
                                  <div className='flex items-center'>
                                ...
                                {tournament.description && (
                                  <p className='mt-2 text-body-small text-neutral-600 line-clamp-2'>
                                    {tournament.description}
                                  </p>
                                )}
                              </div>
            ...
            <Card>
              ...
              <CardContent className='space-y-3'>
                <div className='flex items-start'>
                  ...
                  <div>
                    <p className='text-body-small font-medium text-neutral-900'>Địa chỉ</p>
                    <p className='text-body-small text-neutral-600'>{club.address}</p>
                  </div>
                </div>
                ...
                {club.email && (
                  <div className='flex items-center'>
                    ...
                    <div>
                      <p className='text-body-small font-medium text-neutral-900'>Email</p>
                      <a
            ...
            <Card>
              ...
              <CardContent className='space-y-4'>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Thành viên</span>
                  <span className='text-body-small font-medium text-neutral-900'>
                    {memberCount}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Số bàn</span>
                  <span className='text-body-small font-medium text-neutral-900'>
                    {club.table_count || 0}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Giải đấu</span>
                  <span className='text-body-small font-medium text-neutral-900'>
                    {tournaments.length}
                  </span>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Đánh giá</span>
                  <div className='flex items-center'>
                    <Star className='w-4 h-4 text-yellow-400 fill-current' />
                    <span className='text-body-small font-medium text-neutral-900 ml-1'>
                      4.5
                    </span>
                  </div>
                </div>
                    ...
                    >
                      <div className='flex-shrink-0'>
                        {index < 3 ? (
                          ...
                          <div className='w-6 h-6 rounded-full bg-neutral-200 flex items-center justify-center text-caption font-medium text-neutral-600'>
                            {index + 1}
                          </div>
                        )}
                      </div>
