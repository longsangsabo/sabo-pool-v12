      ...
      <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 to-primary/10'>
        <Card className='max-w-md mx-auto'>
          <CardContent className='pt-6 text-center'>
            ...
            <h2 className='text-heading font-bold mb-2'>Đăng ký câu lạc bộ</h2>
    ...
    <div className='min-h-screen bg-gradient-to-br from-primary/5 to-primary/10 pt-20 pb-8'>
      <div className='max-w-6xl mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-title text-muted-foreground max-w-3xl mx-auto'>
          ...
          <Card>
            ...
            <CardContent className='space-y-4'>
              <div className='flex items-start space-x-3'>
                <CheckCircle className='w-5 h-5 mt-0.5 text-success-600' />
                <div>
        ...
        <div className='text-center'>
          <Card className='max-w-2xl mx-auto'>
            <CardContent className='pt-8 pb-8'>
              <h2 className='text-heading font-bold mb-4'>Sẵn sàng bắt đầu?</h2>
              <p className='text-muted-foreground mb-6'>
              ...
              <Button
                ...
                className='text-body-large px-8'
              >
