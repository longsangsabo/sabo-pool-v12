      ...
      <CardContent className='p-4'>
        <div className='flex items-start space-x-4'>
          ...
          <div className='flex-1 min-w-0'>
            ...
            <div className='space-y-1 text-body-small-muted'>
              {player.city && (
              ...
              <span
                className={`text-caption px-2 py-1 rounded-full ${
                  player.status === 'online'
                    ? 'bg-success-100 text-success-700 dark:bg-green-900/20'
                    : player.status === 'playing'
                      ? 'bg-warning-100 text-warning-700 dark:bg-yellow-900/20'
                      : 'bg-neutral-100 text-neutral-700 dark:bg-neutral-900/20'
                }`}
              >
        ...
        <TabsContent value='friends' className='space-y-4'>
          <Card>
            <CardContent className='p-8 text-center'>
              ...
              <h3 className='text-body-large font-semibold mb-2'>Chưa có bạn bè</h3>
