...
const DiscoveryPage: React.FC = () => {
  ...
  const [selectedTab, setSelectedTab] = useState<'players' | 'clubs'>(
    'players'
  );
      ...
      setClubs([
        {
          ...
          description:
            'Câu lạc bộ bida hàng đầu tại Hà Nội với nhiều tay chơi chuyên nghiệp',
        ...
        },
        {
          ...
          name: 'Bida Đà Nẵng',
          description:
            'CLB bida thân thiện tại Đà Nẵng, phù hợp cho mọi trình độ',
  ...
  return (
    <div className='min-h-screen bg-neutral-50'>
      <div className='max-w-6xl mx-auto px-4 py-6'>
        {/* Header */}
        <div className='mb-6'>
          <h1 className='text-3xl font-bold text-neutral-900'>Khám phá</h1>
            ...
            {filteredPlayers.map(player => (
              ...
              >
                    ...
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <div className='flex items-center gap-2'>
                          ...
                          <div className='flex items-center gap-1 text-body-small text-neutral-600'>
                ...
                <CardContent className='space-y-4'>
                  {player.bio && (
                    <p className='text-body-small text-neutral-600'>{player.bio}</p>
                  )}

                  <div className='space-y-2'>
                    <div className='flex justify-between text-sm'>
                      <span className='text-neutral-600'>Tỷ lệ thắng:</span>
                      <span className='font-medium'>{player.win_rate}%</span>
                    </div>
                    <div className='flex justify-between text-sm'>
                      <span className='text-neutral-600'>Tổng trận đấu:</span>
                  ...
                  {player.achievements.length > 0 && (
                    <div>
                      <div className='text-body-small font-medium text-neutral-700 mb-2'>
                        Thành tích:
                      </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {filteredClubs.map(club => (
              <Card key={club.id} className='hover:shadow-lg transition-shadow'>
                ...
                <CardContent className='space-y-4'>
                  <p className='text-body-small text-neutral-600'>{club.description}</p>

                  <div className='space-y-2'>
                    <div className='flex justify-between text-sm'>
                      <span className='text-neutral-600'>Thành viên:</span>
                  ...
                  <div className='flex gap-2'>
                    <Button className='flex-1'>Tham gia</Button>
                    <Button variant='outline' size='sm'>
                      <MessageCircle className='h-4 w-4' />
                    </Button>
                    <Button variant='outline' size='sm'>
