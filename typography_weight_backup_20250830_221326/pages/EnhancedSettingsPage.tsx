  ...
  if (!user) {
    return (
      <div className='flex items-center justify-center min-h-screen'>
        <p className='text-neutral-600'>Vui lòng đăng nhập để truy cập cài đặt</p>
      </div>
    );
  }
        ...
        <Tabs defaultValue='profile' className='space-y-6'>
          ...
          <TabsContent value='privacy' className='space-y-6'>
            <Card>
              ...
              <CardContent className='space-y-6'>
                <div className='space-y-4'>
                  <h3 className='text-body-small font-medium text-neutral-900'>
                    Quyền riêng tư
                  </h3>
                ...
                <div className='space-y-4'>
                  <h3 className='text-body-small font-medium text-neutral-900'>Bảo mật</h3>
          ...
          <TabsContent value='account' className='space-y-6'>
            <Card>
              ...
              <CardContent className='space-y-6'>
                ...
                <div className='space-y-3'>
                  <h3 className='text-body-small font-medium text-error-600'>
                    Vùng nguy hiểm
                  </h3>
                  <p className='text-body-small text-neutral-500'>
