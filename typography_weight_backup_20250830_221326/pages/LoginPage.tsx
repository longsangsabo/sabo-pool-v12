      ...
      <div className="max-w-md w-full">
        <div className="bg-neutral-800 p-8 rounded-xl border border-gray-700 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Email Field */}
            <div>
              <label htmlFor="email" className="block text-body-small font-medium text-gray-300 mb-2">
                Email Address
              </label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-body-small font-medium text-gray-300 mb-2">
                Password
              </label>
              <div className="relative">
