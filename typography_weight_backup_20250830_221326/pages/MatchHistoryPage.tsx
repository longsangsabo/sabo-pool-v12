  ...
  return (
    <div className='min-h-screen bg-neutral-50'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        {/* Header */}
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-neutral-900'>Lịch sử trận đấu</h1>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6 mb-6'>
          <Card>
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  <p className='text-heading font-bold text-neutral-900'>
                    {stats.wins}
                  </p>
                  <p className='text-body-small text-neutral-600'>Thắng</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-body-small text-neutral-600'>Thua</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className='p-6'>
              <div className='flex items-center'>
                ...
                <div className='ml-4'>
                  ...
                  <p className='text-body-small text-neutral-600'>Tỷ lệ thắng</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className='p-6'>
              <div className='flex items-center'>
                <Calendar className='w-8 h-8 text-info-600' />
                <div className='ml-4'>
                  <p className='text-heading font-bold text-neutral-900'>
                    {stats.total}
                  </p>
                  <p className='text-body-small text-neutral-600'>Tổng trận</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card>
          {loading ? (
            <CardContent className='text-center py-12'>
              ...
              <p className='mt-2 text-neutral-600'>Đang tải lịch sử trận đấu...</p>
            </CardContent>
          ) : matches.length === 0 ? (
            <CardContent className='text-center py-12'>
              <History className='w-16 h-16 mx-auto text-gray-400 mb-4' />
            ...
            <div className='divide-y divide-gray-200'>
              {matches.map(match => {
                ...
                return (
                  <div key={match.id} className='p-6 hover:bg-neutral-50'>
                    <div className='flex items-center justify-between'>
                      <div className='flex items-center space-x-4'>
                        {/* Result Badge */}
                        <div
                          className={`w-12 h-12 rounded-full flex items-center justify-center ${
                            result === 'win' ? 'bg-success-100' : 'bg-error-100'
                          }`}
                        >
                          {result === 'win' ? (
                        ...
                        <div className='mt-4 pt-4 border-t border-gray-100'>
                          <div className='grid grid-cols-2 md:grid-cols-4 gap-4 text-sm'>
                            <div className='text-center'>
                              ...
                              <p className='text-neutral-500'>Tỷ lệ vào bi</p>
                            </div>
                            <div className='text-center'>
                              <p className='font-medium text-neutral-900'>
                                {match.match_statistics[0]?.longest_run || 0}
                              </p>
                              <p className='text-neutral-500'>Chuỗi dài nhất</p>
                            </div>
                            <div className='text-center'>
                              <p className='font-medium text-neutral-900'>
                                {match.match_statistics[0]?.safety_shots || 0}
                              </p>
                              <p className='text-neutral-500'>Bi an toàn</p>
                            </div>
                            <div className='text-center'>
                              <p className='font-medium text-neutral-900'>
                              ...
                              <p className='text-neutral-500'>Lỗi kỹ thuật</p>
                            </div>
                          </div>
                        </div>
                      )}
