        ...
        <div className="max-w-4xl mx-auto">
          <Card>
            <CardContent className="flex items-center justify-center py-12">
              ...
              <span className="ml-3 text-neutral-600">Đang tải thông báo...</span>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-heading font-bold text-neutral-900">Thông báo</h1>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="text-body-small text-neutral-600">Lọc:</span>
          ...
          {filteredNotifications.length === 0 ? (
            ...
            filteredNotifications.map((notification) => (
              <div key={notification.id} className="relative">
                ...
                <input
                  type="checkbox"
                  className="absolute top-4 left-4 z-10 rounded border-neutral-300"
