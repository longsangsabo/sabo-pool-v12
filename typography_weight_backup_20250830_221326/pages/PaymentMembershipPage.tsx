  ...
  <div className='container py-8'>
    <Card>
      <CardHeader className='pb-4'>
        <CardTitle className='text-heading font-bold'>Nâng Cấp Tài Khoản</CardTitle>
      </CardHeader>
      <CardContent className='space-y-4'>
        ...
        {selectedPlan && (
          <div className='border rounded-md p-4'>
            <h3 className='text-body-large font-semibold'>{selectedPlan.name}</h3>
            <p className='text-neutral-500'>{selectedPlan.description}</p>
