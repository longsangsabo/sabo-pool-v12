          ...
          <div className='grid gap-4'>
            <div className='border rounded-lg p-4'>
              <div className='flex justify-between items-center mb-2'>
                ...
                <span className='text-title font-bold'>Miễn phí</span>
              </div>
              <ul className='text-body-small-muted space-y-1'>
            ...
            <div className='border-2 border-primary rounded-lg p-4 relative'>
              <div className='absolute -top-2 left-4 bg-primary text-primary-foreground px-2 py-1 text-caption rounded'>
                Phổ biến
              </div>
              <div className='flex justify-between items-center mb-2'>
                <h3 className='font-semibold'>Gói Pro</h3>
                <span className='text-title font-bold'>99.000đ/tháng</span>
              </div>
              <ul className='text-body-small-muted space-y-1'>
            ...
            <div className='border rounded-lg p-4'>
              <div className='flex justify-between items-center mb-2'>
                ...
                <span className='text-title font-bold'>199.000đ/tháng</span>
              </div>
              <ul className='text-body-small-muted space-y-1'>
