    ...
    return (
      <div className='min-h-screen bg-neutral-50 flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-neutral-600'>Vui lòng đợi trong giây lát...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className='min-h-screen bg-neutral-50 flex items-center justify-center'>
        <div className='max-w-md mx-auto text-center px-4'>
          ...
          <h2 className='text-heading font-semibold text-neutral-900 mb-2'>
            Thanh toán thất bại
          </h2>
      ...
      <div className='max-w-md mx-auto text-center px-4'>
        ...
        {paymentInfo && (
          <div className='bg-white rounded-lg shadow-sm border p-4 mb-6 text-left'>
            ...
            <div className='space-y-1 text-body-small text-neutral-600'>
