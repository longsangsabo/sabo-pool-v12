...
const PublicProfilePage = () => {
  ...
  const skillLevels = {
    beginner: { label: 'Người mới', color: 'bg-success-100 text-success-800' },
    intermediate: { label: 'Trung bình', color: 'bg-primary-100 text-primary-800' },
    advanced: { label: 'Khá', color: 'bg-info-100 text-purple-800' },
    ...
    return (
      <div className='min-h-screen flex items-center justify-center'>
        <div className='text-center'>
          ...
          <p className='text-neutral-600'>Đang tải hồ sơ...</p>
        </div>
      </div>
    );
  }
  ...
  if (!profile) {
    return (
      <div className='min-h-screen flex items-center justify-center'>
        <div className='text-center'>
          <h1 className='text-heading font-bold text-neutral-900 mb-2'>
            ...
            <div className='flex flex-col items-center space-y-4'>
              ...
              <div className='text-center'>
                ...
                {profile.member_since && (
                  <p className='text-body-small text-neutral-500 mt-2 flex items-center justify-center'>
                ...
                {(profile.city || profile.district) && (
                  <p className='text-body-small text-neutral-600 mt-1 flex items-center justify-center'>
