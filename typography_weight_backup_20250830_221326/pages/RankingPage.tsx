          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                <div>
                  <label className='text-body-small font-medium text-neutral-700 mb-2 block'>
                    Mùa giải
                  </label>
                    ...
                    >
                      ...
                      <div className='flex items-center space-x-6'>
                        ...
                        <div className='text-center'>
                          ...
                          <div className='text-caption text-neutral-500'>Điểm</div>
                        </div>
                        <div className='text-center'>
                          <div className='font-medium'>
                            {user.matches_played}
                          </div>
                          <div className='text-caption text-neutral-500'>Trận</div>
                        </div>
                        <div className='text-center'>
