        ...
        <Card className="bg-gradient-to-r from-blue-500 to-purple-600 text-white">
          <CardContent className="p-4">
            <div className="text-center">
              <div className="text-heading font-bold">{currentPoints.toLocaleString()}</div>
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-body-small text-neutral-600">{milestone.description}</p>
                          </div>
                        </div>
            ...
            <CardContent>
              <div className="space-y-3 text-body-small">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-success-600">+100 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Đăng ký hạng</span>
                  <span className="font-semibold text-success-600">+200 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Giới thiệu bạn bè</span>
                  <span className="font-semibold text-success-600">+150 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Thắng giải đấu đầu tiên</span>
                  <span className="font-semibold text-success-600">+300 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Hoàn thiện profile</span>
                  <span className="font-semibold text-success-600">+75 SPA</span>
                </div>
                <div className="flex justify-between">
                  <span>Nạp tiền lần đầu</span>
                  <span className="font-semibold text-success-600">+500 SPA</span>
                </div>
              </div>
            </CardContent>
          </Card>
