  ...
  return (
    <div className='container mx-auto p-6 space-y-6'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-title text-neutral-600'>
                    ...
                    return (
                      ...
                      >
                        <div className='flex items-center gap-4'>
                          <div className='w-8 h-8 bg-neutral-100 rounded-full flex items-center justify-center font-bold'>
                            {rank}
                          </div>
                ...
                {userStats ? (
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                    <div className='text-center p-4 bg-primary-50 rounded-lg'>
                      ...
                      <div className='text-body-small text-neutral-600'>Điểm ELO</div>
                    </div>
                    <div className='text-center p-4 bg-success-50 rounded-lg'>
                      <div className='text-heading font-bold text-success-600'>
                        {userStats.tournaments_played}
                      </div>
                      <div className='text-body-small text-neutral-600'>Giải đấu</div>
                    </div>
                    <div className='text-center p-4 bg-info-50 rounded-lg'>
                      ...
                      <div className='text-body-small text-neutral-600'>Hạng hiện tại</div>
                    </div>
                    <div className='text-center p-4 bg-warning-50 rounded-lg'>
                      ...
                      <div className='text-body-small text-neutral-600'>Vị trí</div>
                    </div>
                  </div>
                ) : (
                  <div className='text-center py-8 text-neutral-500'>
            ...
            <CardContent>
              <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  ...
                  <div className='text-body-small text-neutral-600'>Người tham gia</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading font-bold'>
                    {seasonInfo?.total_matches || 0}
                  </div>
                  <div className='text-body-small text-neutral-600'>Trận đấu</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading font-bold'>{prizes.length}</div>
                  <div className='text-body-small text-neutral-600'>Hạng giải thưởng</div>
                </div>
                <div className='text-center p-4 bg-neutral-50 rounded-lg'>
                  <div className='text-heading font-bold'>
                    {prizes
                  ...
                  <div className='text-body-small text-neutral-600'>Tổng giải thưởng</div>
                </div>
              </div>
            </CardContent>
          </Card>
