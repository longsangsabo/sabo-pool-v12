            ...
            <div className='flex items-center space-x-4'>
              <Link to='/simple-club'>
                <Button
                  variant='ghost'
                  size='sm'
                  className='text-yellow-400 hover:bg-success-700 min-h-[44px]'
                >
                  <ArrowLeft className='h-4 w-4 mr-2' />
                  Về trang chủ
                </Button>
              </Link>
              <h1 className='text-heading font-bold text-yellow-400'>
                🎱 Giới thiệu CLB
              </h1>
            </div>
          </div>
          ...
          <div className='max-w-4xl mx-auto space-y-8'>
              ...
              <CardContent className='text-center'>
                <div className='grid md:grid-cols-4 gap-6 mt-8'>
                  <div className='text-center'>
                    ...
                    <p className='text-heading font-bold text-white'>5000+</p>
                    <p className='text-green-200'>Khách hàng</p>
                  </div>
                  <div className='text-center'>
                    <Clock className='h-8 w-8 text-yellow-400 mx-auto mb-2' />
                    <p className='text-heading font-bold text-white'>10+</p>
                    <p className='text-green-200'>Năm kinh nghiệm</p>
                  </div>
                  <div className='text-center'>
                    <Award className='h-8 w-8 text-yellow-400 mx-auto mb-2' />
                    <p className='text-heading font-bold text-white'>12</p>
                    <p className='text-green-200'>Bàn billiards cao cấp</p>
                  </div>
                  <div className='text-center'>
                    <Star className='h-8 w-8 text-yellow-400 mx-auto mb-2' />
                    <p className='text-heading font-bold text-white'>4.8/5</p>
            ...
            <Card className='bg-green-800 border-green-700'>
              ...
              <CardContent>
                <div className='grid md:grid-cols-3 gap-6'>
                  <div className='text-center p-4 bg-success-700 rounded-lg'>
            ...
            <div className='text-center py-8'>
              ...
              <Link to='/simple-booking'>
                <Button
                  size='lg'
                  className='bg-yellow-400 text-green-900 hover:bg-warning-500 font-bold px-8 py-4 text-body-large min-h-[44px]'
                >
                  🎯 Đặt bàn ngay
                </Button>
              </Link>
