        ...
        <header className='bg-green-800 border-b border-green-700'>
          <div className='container mx-auto px-4 py-4'>
            <div className='flex items-center space-x-4'>
              ...
              <h1 className='text-heading font-bold text-yellow-400'>📞 Liên hệ</h1>
            </div>
          </div>
        </header>
              ...
              <Card className='bg-green-800 border-green-700'>
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <Button
                      type='submit'
                      className='w-full bg-yellow-400 text-green-900 hover:bg-warning-500 font-bold py-4 text-title min-h-[50px]'
                      disabled={loading}
                    >
                      {loading ? (
                        <>
