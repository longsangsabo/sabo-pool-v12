  ...
  return (
    <div className='container mx-auto px-4 py-8'>
            ...
            <CardContent>
              <div className='space-y-3'>
                {category.pages.map((page, pageIndex) => (
                  ...
                  >
                    <div className='font-medium text-neutral-900'>{page.name}</div>
      ...
      <div className='mt-12 p-6 bg-primary-50 rounded-lg'>
        <h2 className='text-heading font-bold text-blue-900 mb-4'>
        ...
        <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
          <div className='text-center'>
            ...
            <div className='text-body-small text-neutral-600'>Tổng số trang</div>
          </div>
          <div className='text-center'>
            <div className='text-3xl font-bold text-primary-600'>
              {pageCategories.length}
            </div>
            <div className='text-body-small text-neutral-600'>Danh mục</div>
          </div>
          <div className='text-center'>
            <div className='text-3xl font-bold text-info-600'>✅</div>
            <div className='text-body-small text-neutral-600'>Routing hoàn tất</div>
          </div>
          <div className='text-center'>
            <div className='text-3xl font-bold text-warning-600'>🎯</div>
            <div className='text-body-small text-neutral-600'>Navigation cập nhật</div>
          </div>
        </div>
      </div>
    </div>
