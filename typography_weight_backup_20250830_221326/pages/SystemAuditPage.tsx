            ...
            <CardContent>
              <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                <div className='text-center'>
                  ...
                  <p className='text-body-small text-neutral-600'>Overall Health</p>
                </div>
                <div className='text-center'>
                  <div className='text-heading font-bold text-success-600'>
                    {systemStatus.passedTests}
                  </div>
                  <p className='text-body-small text-neutral-600'>Tests Passed</p>
                </div>
                <div className='text-center'>
                  <div className='text-heading font-bold text-error-600'>
                    {systemStatus.errors.length}
                  </div>
                  <p className='text-body-small text-neutral-600'>Critical Issues</p>
                </div>
                <div className='text-center'>
                  <div className='text-heading font-bold text-warning-600'>
                    {systemStatus.warnings.length}
                  </div>
                  <p className='text-body-small text-neutral-600'>Warnings</p>
                </div>
              </div>
