  ...
  const features = [
    {
      ...
      color: "text-warning-600 bg-warning-50 dark:bg-yellow-900/20 dark:text-yellow-400"
    },
    {
      icon: Moon, 
      title: "Dark Mode",
      description: "Easy on the eyes with billiards-themed background",
      color: "text-primary-600 bg-primary-50 dark:bg-blue-900/20 dark:text-blue-400"
    },
    {
      icon: Monitor,
      title: "Desktop Optimized", 
      description: "Professional layout with sidebar theme controls",
      color: "text-success-600 bg-success-50 dark:bg-green-900/20 dark:text-green-400"
    },
    {
      icon: Smartphone,
      title: "Mobile First",
      description: "Touch-friendly controls and responsive design", 
      color: "text-info-600 bg-info-50 dark:bg-purple-900/20 dark:text-purple-400"
    },
    {
      icon: Zap,
      title: "Instant Switching",
      description: "Seamless transitions between themes",
      color: "text-warning-600 bg-warning-50 dark:bg-orange-900/20 dark:text-orange-400"
    },
    {
      icon: Settings,
      title: "Auto Detection",
      description: "Respects system preferences with manual override",
      color: "text-neutral-600 bg-neutral-50 dark:bg-neutral-800 dark:text-gray-400"
    }
  ];
            ...
            return (
              <StandardCard key={feature.title} variant="default">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-body-small-muted">{feature.description}</p>
                </div>
              </StandardCard>
            );
          })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {improvements.map((category) => (
              <div key={category.category} className="space-y-3">
                <h3 className="font-semibold text-body-large flex items-center gap-2">
                  {category.category}
                </h3>
