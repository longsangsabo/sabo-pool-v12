          ...
          <Card>
            ...
            <CardContent className='space-y-3'>
              <div className='flex justify-between'>
                <span className='text-neutral-600'>Loại giải:</span>
                <span className='font-medium'>
                  {tournament.tournament_type}
                </span>
              </div>
              <div className='flex justify-between'>
                <span className='text-neutral-600'>Tổng chỗ:</span>
                <span className='font-medium'>
                  {tournament.max_participants}
                </span>
              </div>
              <div className='flex justify-between'>
                <span className='text-neutral-600'>Đã đăng ký:</span>
            ...
            <CardContent>
              <div className='space-y-3'>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Live Updates</span>
                  <div className='flex items-center gap-2'>
                    <div className='w-2 h-2 bg-success-500 rounded-full animate-pulse'></div>
                    <span className='text-body-small font-medium text-success-600'>
                      Active
                    </span>
                  </div>
                </div>
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Auto Sync</span>
                  <div className='flex items-center gap-2'>
                    <div className='w-2 h-2 bg-success-500 rounded-full animate-pulse'></div>
                    <span className='text-body-small font-medium text-success-600'>
                      Running
                ...
                <div className='flex items-center justify-between'>
                  <span className='text-body-small text-neutral-600'>Database</span>
                  <div className='flex items-center gap-2'>
                    <div className='w-2 h-2 bg-success-500 rounded-full animate-pulse'></div>
                    <span className='text-body-small font-medium text-success-600'>
                      Connected
