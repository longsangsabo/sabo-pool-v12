          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small-muted'>Tổng giải đấu</p>
                  <p className='text-heading font-bold'>{tournaments.length}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small-muted'>Đang thi đấu</p>
                  <p className='text-heading font-bold'>
          ...
          <Card>
            <CardContent className='pt-6'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  <p className='text-body-small-muted'>Đã kết thúc</p>
                  <p className='text-heading font-bold'>
