    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4 p-6">
          ...
          <h2 className="text-title font-bold text-foreground">Chưa đăng nhập</h2>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="text-center space-y-2">
            <motion.h1
              ...
              className="text-heading font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent flex items-center justify-center gap-2"
            >
              🏆 THÁCH ĐẤU 🎯
            </motion.h1>
            <motion.div
              ...
              className="flex items-center justify-center gap-2 text-body-small"
            >
              <motion.div
      ...
      <div className="sticky bottom-0 bg-black/40 backdrop-blur-lg border-t border-gray-600/20 p-4">
        <div className="flex justify-around text-center">
          <motion.div whileHover={{ scale: 1.1 }}>
            ...
            <p className="text-caption-muted">Tổng kèo</p>
          </motion.div>
          <motion.div whileHover={{ scale: 1.1 }}>
            ...
            <p className="text-caption-muted">Đang live</p>
          </motion.div>
          <motion.div whileHover={{ scale: 1.1 }}>
            ...
            <p className="text-caption-muted">Đã xong</p>
          </motion.div>
        </div>
      </div>
