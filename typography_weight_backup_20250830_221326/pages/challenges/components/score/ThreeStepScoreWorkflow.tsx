        ...
        <div className='space-y-4'>
          ...
          <Card>
            <CardContent className='pt-4'>
              ...
              <p className='text-body-small-muted mt-2'>
          ...
          <div className='grid grid-cols-2 gap-4'>
            ...
            >
              <CardHeader className='pb-3'>
                <div className='flex items-center gap-3'>
                  <Avatar className='w-12 h-12 border-2 border-background shadow-sm'>
                    ...
                    />
                    <AvatarFallback className='text-body-large font-semibold bg-gradient-to-br from-blue-500 to-purple-600 text-white'>
                  ...
                  <div className='flex-1 min-w-0'>
                    <p className='font-semibold text-body-small truncate'>
                      {workflowState.canClubConfirm && challengerProfile
              ...
              <CardContent className='pt-0'>
                ...
                <Input
                  ...
                  className='text-center font-bold text-title h-12 border-2 focus:border-primary'
                />
              </CardContent>
            </Card>
            ...
            >
                ...
                <div className='flex items-center gap-3'>
                  <Avatar className='w-12 h-12 border-2 border-background shadow-sm'>
                    <AvatarImage
                      ...
                      className='object-cover'
                    />
                    <AvatarFallback className='text-body-large font-semibold bg-gradient-to-br from-green-500 to-teal-600 text-white'>
              ...
              <CardContent className='pt-0'>
                <Label htmlFor='opponent-score' className='text-caption font-medium'>
                  Tỷ số
                </Label>
                <Input
                  id='opponent-score'
                ...
                <CardContent className='space-y-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Textarea
                      ...
                      maxLength={100}
                      className='text-body-small h-16'
                    />
                  </div>
