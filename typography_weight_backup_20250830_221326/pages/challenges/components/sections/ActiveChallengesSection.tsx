...
interface ActiveChallengesSectionProps {
  ...
  onStatsUpdate: () => void;
  highlightedChallengeId?: string | undefined;
}
    ...
    return (
      <Card>
        <CardContent className='text-center py-12'>
          ...
          <h3 className='font-semibold text-body-large mb-2'>Không có trận đấu nào</h3>
          ...
          >
            ...
            >
              ...
              <CardContent className='space-y-4'>
                ...
                {challenge.score_confirmation_status === 'score_entered' && (
                  <div className='p-3 bg-warning-50 border border-orange-200 rounded-lg'>
                    <p className='text-body-small text-orange-800 font-medium'>
