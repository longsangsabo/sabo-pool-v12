        ...
        <div className="flex items-center justify-between p-4 bg-muted/30 dark:bg-muted/20 rounded-lg border border-border/50 dark:border-border/30">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-body-small-muted dark:text-muted-foreground/80">
                {tab.description}
              </p>
            </div>
          </div>
    ...
    return (
      <Card className="border-border/50 dark:border-border/30">
        <CardContent className="p-8 text-center">
          ...
          <h3 className="text-body-large font-semibold mb-2">Chưa có thông tin club</h3>
      ...
      <Card className="border-border/50 dark:border-border/30">
        <CardContent className="p-8 text-center">
          <div className="animate-pulse">
            <Users className="w-12 h-12 mx-auto mb-4 text-muted-foreground" />
            <h3 className="text-body-large font-semibold mb-2">Đang tải...</h3>
