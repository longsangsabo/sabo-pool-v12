    ...
    switch (result) {
      ...
      case 'Thua':
        return theme === 'dark' 
          ...
          : 'from-red-200 to-rose-200 text-error-700';
      case 'Hòa':
        return theme === 'dark' 
          ? 'from-yellow-500/30 to-amber-500/20 text-yellow-300' 
          : 'from-yellow-200 to-amber-200 text-warning-700';
      default:
        return theme === 'dark' 
          ? 'from-gray-500/30 to-slate-500/20 text-gray-300' 
          : 'from-gray-200 to-slate-200 text-neutral-700';
    }
  };
  ...
  return (
    ...
    >
      <CardHeader className='pb-3'>
        <CardTitle
          className={`text-body font-semibold flex items-center gap-2 ${
      ...
      <CardContent className='px-5 pb-5 space-y-2'>
        {loading ? (
          ...
          <div className={`text-center py-6 ${
            ...
            <p className="text-body-small">Chưa có trận đấu nào gần đây</p>
          </div>
        ) : (
          recentMatches.map((match, index) => (
            ...
            >
              ...
              <div className='text-caption font-medium opacity-90'>
                {match.time}
              </div>
            </div>
          ))
