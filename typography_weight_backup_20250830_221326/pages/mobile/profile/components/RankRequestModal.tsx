        ...
        <div className='space-y-4'>
          <div className='flex gap-2'>
            <button
              ...
              className={`flex-1 py-2 text-body-small font-medium rounded-md border transition ${
                changeType === 'up'
                  ? theme === 'dark'
          ...
          <div>
            <label className='text-caption font-medium mb-1 block'>Chọn CLB</label>
            <select
          ...
          <div>
            <label className='text-caption font-medium mb-1 block'>Lý do</label>
            <textarea
              rows={3}
