      ...
      <Card className={
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-body-small-muted">Số dư SPA hiện tại</div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <Card className={
          ...
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-caption-muted">Tổng thu</div>
        ...
        <Card className={
          ...
          <CardContent className="p-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-caption-muted">Tổng chi</div>
                <div className={`text-body-large font-bold ${
                    ...
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        {transaction.reference_id && (
                          <div className="text-caption-muted mb-1">
