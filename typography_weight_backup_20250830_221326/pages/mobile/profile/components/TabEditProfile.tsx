    ...
    <div className='p-4 space-y-4'>
      <div className='grid gap-4'>
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Tên hiển thị</label>
          <input
        ...
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Số điện thoại</label>
          <input
            className={`w-full px-3 py-2 text-body-small rounded-md border outline-none transition ${
              theme === 'dark'
                ? 'bg-slate-800/70 border-slate-600/60 text-slate-100 focus:border-amber-400'
        ...
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Tỉnh / Thành phố</label>
          <input
            className={`w-full px-3 py-2 text-body-small rounded-md border outline-none transition ${
              theme === 'dark'
                ? 'bg-slate-800/70 border-slate-600/60 text-slate-100 focus:border-amber-400'
        ...
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Quận / Huyện</label>
          <input
            className={`w-full px-3 py-2 text-body-small rounded-md border outline-none transition ${
              theme === 'dark'
                ? 'bg-slate-800/70 border-slate-600/60 text-slate-100 focus:border-amber-400'
        ...
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Trình độ</label>
          <select
            className={`w-full px-3 py-2 text-body-small rounded-md border outline-none transition ${
              theme === 'dark'
                ? 'bg-slate-800/70 border-slate-600/60 text-slate-100 focus:border-amber-400'
        ...
        <div className='space-y-1'>
          <label className='text-caption font-medium'>Giới thiệu</label>
          <textarea
            rows={3}
