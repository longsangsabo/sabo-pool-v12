      ...
      <CardHeader>
        <div className='flex items-center justify-between'>
          <CardTitle className='flex items-center gap-2'>
            <ArrowDown className='h-5 w-5 text-warning-600' />
            Loser's Branch A
        ...
        <div className='grid gap-6'>
          ...
          <div>
            <div className='flex items-center gap-2 mb-3'>
              <Badge
                variant='outline'
                className='border-orange-300 text-warning-700'
              >
          ...
          {/* Branch A Summary */}
          <div className='mt-4 p-3 bg-warning-100 dark:bg-orange-900/30 rounded-lg border border-orange-200'>
