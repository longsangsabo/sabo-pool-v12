      ...
      <CardContent className='p-4'>
        ...
        <div className='flex items-center justify-between mb-3'>
          <div className='flex items-center gap-2'>
            {getMatchIcon()}
            <span className={cn('text-body-small font-medium', styles.accent)}>
        ...
        {isCompleted ? (
          <div className='space-y-3'>
            ...
            {/* VS Divider */}
            <div className='text-center text-gray-400 text-body-small font-medium my-2'>
              VS
            </div>
          ...
          <div className='space-y-3'>
            ...
            <div className='text-center'>
              <span className='text-caption-muted bg-muted px-2 py-1 rounded'>
                VS
              </span>
            </div>
        ...
        <div className='mt-3 pt-2 border-t border-muted'>
          <div className='flex justify-between items-center text-caption-muted'>
